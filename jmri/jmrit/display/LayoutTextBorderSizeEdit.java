...
/**
 * Displays and allows user to modify border size of
 * positionable labels
 *
...
//								implements MouseListener 
{
	...
	public LayoutTextBorderSizeEdit() {
		super();
	}
...
//		addItem(yTextField, 1, 2);
	...
	.getLogger(LayoutTextBorderSizeEdit.class.getName());
}
