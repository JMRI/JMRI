...
public class LayoutSensorTextEdit extends JmriJFrame 
{
	...
	LayoutSensorIcon pl; 	// layout positional label tracked by this frame
	...
	public void initComponents(LayoutSensorIcon l, String name) throws Exception {
		pl = l;
	...
	.getLogger(LayoutSensorTextEdit.class.getName());
}
