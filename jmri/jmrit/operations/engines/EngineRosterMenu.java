...
public class EngineRosterMenu extends JMenu {
    ...
    public EngineRosterMenu(String pMenuName, int pMenuType, Component pWho) {
        ...
        ResourceBundle rb = ResourceBundle.getBundle("jmri.jmrit.operations.engines.JmritOperationsEnginesBundle");
	...
	// initialize logging
    static org.apache.log4j.Category log = org.apache.log4j.Category.getInstance(EngineRosterMenu.class.getName());
