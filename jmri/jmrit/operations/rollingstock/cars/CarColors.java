...
public class CarColors {
	...
	public static synchronized CarColors instance() {
		...
		if (Control.showInstance && log.isDebugEnabled()) log.debug("CarColors returns instance "+_instance);
		return _instance;
	}
    ...
    static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(CarColors.class.getName());
