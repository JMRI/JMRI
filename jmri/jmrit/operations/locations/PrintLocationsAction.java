    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
        	String s = rb.getString("Location") + "\t\t\t "
					...
					+ "\t" + rb.getString("Cars") + "\t" + rb.getString("Pickup")
        	...
        	for (int i=0; i<locations.size(); i++){
        		...
        		for (int j=name.length(); j < LocationsEditFrame.MAX_NAME_LENGTH; j++) {
         		...
         		s = name + " \t  " + Integer.toString(location.getLength()) + "\t"
								...
								+ Integer.toString(location.getPickupCars()) + "\t"
								+ Integer.toString(location.getDropCars())+ newLine;
        		writer.write(s, 0, s.length());
        		
        		List yards = location.getSecondaryLocationsByNameList(SecondaryLocation.YARD);
        		if (yards.size()>0){
        			s = "    " + rb.getString("YardName")	+ newLine;
        			writer.write(s, 0, s.length());
         			for (int k=0; k<yards.size(); k++){
        				SecondaryLocation yard = location.getSecondaryLocationById((String)yards.get(k));
        				name = yard.getName();
                		...
                		s = "\t" + name + " "
								...
								+ Integer.toString(yard.getPickupCars()) + "\t"
        		...
        		List sidings = location.getSecondaryLocationsByNameList(SecondaryLocation.SIDING);
        		if (sidings.size()>0){
        			s = "    " + rb.getString("SidingName")	+ newLine;
        			writer.write(s, 0, s.length());
         			for (int k=0; k<sidings.size(); k++){
        				SecondaryLocation siding = location.getSecondaryLocationById((String)sidings.get(k));
        				name = siding.getName();
						...
						s = "\t" + name + " "
								...
								+ Integer.toString(siding.getPickupCars()) + "\t"
        		...
        		List interchanges = location.getSecondaryLocationsByNameList(SecondaryLocation.INTERCHANGE);
        		if (interchanges.size()>0){
        			s = "    " + rb.getString("InterchangeName")	+ newLine;
        			writer.write(s, 0, s.length());
         			for (int k=0; k<interchanges.size(); k++){
        				SecondaryLocation interchange = location.getSecondaryLocationById((String)interchanges.get(k));
                		...
                		s = "\t" + name + " "
								...
								+ Integer.toString(interchange.getPickupCars())	+ "\t"
        		...
        		List stagings = location.getSecondaryLocationsByNameList(SecondaryLocation.STAGING);
        		if (stagings.size()>0){
        			s = "    " + rb.getString("StagingName")	+ newLine;
        			writer.write(s, 0, s.length());
         			for (int k=0; k<stagings.size(); k++){
        				SecondaryLocation staging = location.getSecondaryLocationById((String)stagings.get(k));
                		...
                		s = "\t" + name + " "
								...
								+ Integer.toString(staging.getPickupCars())	+ "\t"
