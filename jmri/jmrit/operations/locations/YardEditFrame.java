...
//		setJMenuBar(menuBar);
		addHelpMenu("package.jmri.jmrit.operations.YardEditFrame", true);
...
//			SecondaryLocation y = _location.getSecondaryLocationByName(yardNameTextField.getText());
	...
	private boolean checkName(){
		if (yardNameTextField.getText().length() > 25){
			log.error("Yard name must be less than 26 charaters");
			JOptionPane.showMessageDialog(this,
					"Yard name must be less than 26 charaters", "Can not add location!",
