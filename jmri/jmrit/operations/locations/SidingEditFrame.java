...
//		setJMenuBar(menuBar);
		addHelpMenu("package.jmri.jmrit.operations.SidingEditFrame", true);
...
//			SecondaryLocation y = _location.getSecondaryLocationByName(sidingNameTextField.getText());
	...
	private boolean checkName(){
		if (sidingNameTextField.getText().length() > 25){
			log.error("Siding name must be less than 26 charaters");
			JOptionPane.showMessageDialog(this,
					"Siding name must be less than 26 charaters", "Can not add location!",
