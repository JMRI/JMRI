 ...
 * consistently.  When done across various versions of schema,
 * this checks ability to read older files in newer versions; completeness
 * of reading code; etc.
 * <p>
 * Functional checks, that e.g. check the details of a specific
 * type are being read properly, should go into another type-specific
 * test class.
 * <p>
 * The functionality comes from the common base class, this is just
 * here to insert the test suite into the JUnit hierarchy at the right place.
 * 
