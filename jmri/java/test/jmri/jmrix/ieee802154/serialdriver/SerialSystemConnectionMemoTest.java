 ...
 *
 * Description:	    tests for the jmri.jmrix.ieee802154.serialdriver.SerialSystemConnectionMemo class
 * @author			Paul Bender
 * @version         $Revision$
 */
public class SerialSystemConnectionMemoTest extends TestCase {
    ...
    static Logger log = Logger.getLogger(SerialSystemConnectionMemoTest.class.getName());
