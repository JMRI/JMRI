 ...
 *
 * Description:	    tests for the jmri.jmrix.roco.z21.z21XNetStreamPortController class
 * @author			Paul Bender
...
public class z21XNetStreamPortControllerTest extends TestCase {
    ...
    static Logger log = Logger.getLogger(z21XNetStreamPortControllerTest.class.getName());
