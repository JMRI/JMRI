...
/**
 * Wraps an Exception and allows extra contextual information to be added, such as what was happening at the time of the
 * Exception, and a hint as to what the user might do to correct the problem. Also implements a number of methods to
...
public class ExceptionContext {
	...
	/**
	 * Returns a user friendly summary of the Exception. Empty parts are not included. (Maybe later?)
	 */
