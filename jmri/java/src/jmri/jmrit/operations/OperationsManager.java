...
public final class OperationsManager {
	 ...
	 * 
	 * Replaces the existing operations ShutDownTask with the new task. Use a null value to prevent an operations
	 * ShutDownTask from being run when JMRI shuts down. Use {@link #getDefaultShutDownTask() } to use the default
	...
	/**
	 * Get a copy of the default operations {@link jmri.ShutDownTask}. The default ShutDownTask saves the operations
	 * state at shutdown without prompting.
	 * 
