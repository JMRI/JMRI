...
/**
 * Frame for user edit of a train's script options. Allows the user to execute scripts when a train is built, moved or
 * terminated.
 * 
...
public class TrainScriptFrame extends OperationsFrame {
	...
	static Logger log = LoggerFactory.getLogger(TrainScriptFrame.class.getName());
}
