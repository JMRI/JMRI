...
public class LocoDataModel extends javax.swing.table.AbstractTableModel implements TamsListener  {
    ...
    public String getColumnName(int col) {
        switch (col) {
        case ADDRCOLUMN: return rb.getString("ColAddress");
        case SPDCOLUMN: return rb.getString("ColSteps");
        case FMTCOLUMN: return rb.getString("ColFormat");
        case NAMECOLUMN: return rb.getString("ColName");
        case DELCOLUMN: return rb.getString("ColDelete");
	...
	public Object getValueAt(int row, int col) {
        if(locolist.size()==0) return null;
