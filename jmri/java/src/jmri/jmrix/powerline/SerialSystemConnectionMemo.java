...
public class SerialSystemConnectionMemo extends jmri.jmrix.SystemConnectionMemo {
     ...
     */
    public SerialTrafficController getTrafficController() { return SerialTrafficController; }
    private SerialTrafficController SerialTrafficController;
    public void setTrafficController(SerialTrafficController tc) { SerialTrafficController = tc; }
        
    /**
     * Provide access to a SerialAddress for this
     * particular connection
     */
    public SerialAddress getSerialAddress() { return SerialAddress; }
    private SerialAddress SerialAddress;
    public void setSerialAddress(SerialAddress sa) { SerialAddress = sa; }
    ...
    public SerialTurnoutManager  getTurnoutManager() { return turnoutManager; }
    public SerialLightManager  getLightManager() { return lightManager; }
    public SerialSensorManager  getSensorManager() { return sensorManager; }
