 ...
 *<P>
 * RailCom objects are obtained from an RailComManager, which in turn is generally located
 ...
 * <p>
 * Although the RailCom object does extend the NamedBean, it doesn't specifically use the 
 * system or user names as each RailCom device should in itself be unique.
 * <P>
