...
class USBDriver :
    def __init__(self):
        self.componentNextThrottleFrame = "x"  # Component for throttle frames browsing
        self.valueNextThrottleFrame = 1
        self.componentPreviousThrottleFrame = "x"
        self.valuePreviousThrottleFrame = -1
        
        self.componentNextRunningThrottleFrame = ""  # Component for running throttle frames browsing
        self.valueNextRunningThrottleFrame = 0.5
        ...
        self.componentNextRosterBrowse = "y"  # Component for roster browsing
        self.valueNextRoster = 1
        self.componentPreviousRosterBrowse = "y"
        ...
        self.componentDirectionForward = "" # Analog axis component for curent throttle direction
        self.valueDirectionForward = 1
        
        self.componentDirectionBackward = ""
