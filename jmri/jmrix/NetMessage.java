 ...
 *<P>Both a set of indexed contents, an opcode, and a length
 * field are available.  Different implementations will map the
 * opcode and length into the contents in different ways.
...
public abstract class NetMessage implements Serializable {
	...
	public void setOpCode(int i) { mOpCode=i;}
	...
	public int getNumDataElements() {return mNDataBytes;}
	 ...
	 * Note that parity is really a stand-in for whatever error checking, etc
	 * needs to be done
	 */
