...
public class AcelaSensorManager extends jmri.AbstractSensorManager
    ...
    public void reply(AcelaReply r) {
        ...
        if (!currentstate) {
            ...
            if (replysize == 0) {
                ...
                log.warn("We got an empty reply" + replysize);
            } else {
                if (replysize == 1) {
                    ...
                    for (int i=0; i< replysize; i++) {
                        ...
                        switch (replynodetype) {
                            ...
                            default: {
                                nodetype = AcelaNode.UN;
                            }
                        }
               		AcelaNode node0 = new AcelaNode(i+1, nodetype);
                        log.info("Created a new Acela Node: " + replynodetype);
                    }
    ...
    static org.apache.log4j.Category log = org.apache.log4j.Category.getInstance(AcelaSensorManager.class.getName());
}
