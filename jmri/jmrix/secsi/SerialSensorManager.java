...
public class SerialSensorManager extends jmri.managers.AbstractSensorManager
     ...
     * <P>
     * The first node address uses sensors from 1 to SENSORSPERNODE-1,
     * the second from SENSORSPERNODE+1 to SENSORSPERNODE+(SENSORSPERNODE-1), etc.
     * <P>
    ...
    public void registerSensorsForNode(SerialNode node) {
        ...
        while (iter.hasNext()) {
            ...
            if (sName==null) {
                ...
                if ( (sName.charAt(0) == 'V') && (sName.charAt(1) == 'S') ) {
                    // This is a Sensor
