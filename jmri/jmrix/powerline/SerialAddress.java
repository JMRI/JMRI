...
public class SerialAddress {
    ...
    public static SerialNode getNodeFromSystemName(String systemName) {
        ...
        if ( (systemName.charAt(0) != 'P') || ( (systemName.charAt(1) != 'L') &&
    ...
    public static boolean validSystemNameFormat(String systemName,char type) {
        // validate the system Name leader characters
        if ( (systemName.charAt(0) != 'P') || (systemName.charAt(1) != type) ) {
            // here if an illegal format 
        ...
        if (noB) {
            ...
            // This is a PLnnnBxxxx address - validate the node address field
            if (s.length()==0) {
