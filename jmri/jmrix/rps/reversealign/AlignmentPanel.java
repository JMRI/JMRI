 ...
 *<P>
 * Note that algorithms have a bias to find transmitters with positive
 * Z coordinates.  Since we're inverting the computation between receivers
 * and transmitters, we also
...
public class AlignmentPanel extends javax.swing.JPanel 
    ...
    void dummy1() {
        lines[0].xl.setText("19"); lines[0].yl.setText("83.5"); lines[0].zl.setText("12.1");
        lines[0].s1 = 1100.0;
        
        lines[1].xl.setText("1.3"); lines[1].yl.setText("25"); lines[1].zl.setText("14.2");
        lines[1].s1 = 4304.0;
        
        lines[2].xl.setText("35.9"); lines[2].yl.setText("1.5"); lines[2].zl.setText("13.4");
        lines[2].s1 = 5634.0;
        
        lines[3].xl.setText("57.1"); lines[3].yl.setText("21.5"); lines[3].zl.setText("13.8");
        lines[3].s1 = 4782.0;
        
    }
    
    void dummy2() {
        lines[0].xl.setText("14.2"); lines[0].yl.setText("21.4"); lines[0].zl.setText("2");
        lines[0].s1l.setText(""+1274.1);
        lines[0].s2l.setText(""+3699.3);
        lines[0].s3l.setText(""+4764.2);
        lines[0].s4l.setText(""+4363.3);
        
        lines[1].xl.setText("58.5"); lines[1].yl.setText("14"); lines[1].zl.setText("2");
        lines[1].s1l.setText(""+4389.4);
        lines[1].s2l.setText(""+1328.3);
        lines[1].s3l.setText(""+2326.8);
        lines[1].s4l.setText(""+3340.8);
        
        lines[2].xl.setText("50.1"); lines[2].yl.setText("3.8"); lines[2].zl.setText("2");
        lines[2].s1l.setText(""+4005.7);
        lines[2].s2l.setText(""+1104);
        lines[2].s3l.setText(""+3166);
        lines[2].s4l.setText(""+4148.3);
        
        lines[3].xl.setText("70.3"); lines[3].yl.setText("47.4"); lines[3].zl.setText("2");
    ...
    void dummy3() {
        ...
        i = 0;
        lines[i].xl.setText("70.1"); lines[i].yl.setText("21.2"); lines[i].zl.setText("2");
        ...
        i = 1;
        lines[i].xl.setText("25.6"); lines[i].yl.setText("14.1"); lines[i].zl.setText("2");
        ...
        i = 2;
        lines[i].xl.setText("32.2"); lines[i].yl.setText("4.2"); lines[i].zl.setText("2");
        ...
        i = 3;
        lines[i].xl.setText("14.2"); lines[i].yl.setText("47.4"); lines[i].zl.setText("2");
        ...
        i = 4;
        lines[i].xl.setText("70.1"); lines[i].yl.setText("21.2"); lines[i].zl.setText("7.5");
        ...
        i = 5;
        lines[i].xl.setText("25.6"); lines[i].yl.setText("14.1"); lines[i].zl.setText("7.5");
        ...
        i = 6;
        lines[i].xl.setText("32.2"); lines[i].yl.setText("4.2"); lines[i].zl.setText("7.5");
        ...
        i = 7;
        lines[i].xl.setText("14.2"); lines[i].yl.setText("47.4"); lines[i].zl.setText("7.5");
    ...
    class Line extends JPanel {
        ...
        double getTime(int i) {
            switch(i) {
               case 0: return Float.valueOf(s1l.getText()).intValue();
               case 1: return Float.valueOf(s2l.getText()).intValue();
               case 2: return Float.valueOf(s3l.getText()).intValue();
               case 3: return Float.valueOf(s4l.getText()).intValue();
               default: return -1;
            }
        }
        ...
        void update(Reading r) {
            if (Math.abs(r.getValue(0))>MAXTIME
                ...
                || Math.abs(r.getValue(3))>MAXTIME ) return;
