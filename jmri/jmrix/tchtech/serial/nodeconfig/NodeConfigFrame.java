...
import jmri.jmrix.tchtech.serial.SerialSensorManager;
...
public class NodeConfigFrame extends jmri.util.JmriJFrame {
    ...
    ResourceBundle rb = ResourceBundle.getBundle("jmri.jmrix.tchtech.serial.nodeconfig.NodeConfigBundle");
    ...
    protected int nodeType = SerialNode.MICRO; // Node type
    protected int bitsPerCard = 16;         // number of bits per card(24)
    //protected int receiveDelay = 0;         // transmission delay
	protected int pulseWidth = 500;	    // for turnout control (milliseconds)
...
// here add code for other node types, if required
        ...
        cardTypeColumn.setResizable(false);//false
        ...
        searchlightConfigTable.setPreferredScrollableViewportSize(new java.awt.Dimension(215,75));
...
// here add code for other types of nodes
    ...
    public class SearchlightConfigModel extends AbstractTableModel
    {
        ...
        public int getRowCount () {return 4;}//6
        public Object getValueAt (int r,int c) {
            if (c==0) {
                switch (r) {
                    case 0:
