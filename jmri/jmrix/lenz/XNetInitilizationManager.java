        ...
        if (CSSoftwareVersion<0)
            {
                ...
                jmri.InstanceManager.setProgrammerManager(new jmri.jmrix.lenz.XNetProgrammerManager( new jmri.jmrix.lenz.XNetProgrammer(systemMemo.getXNetTrafficController()),systemMemo));
