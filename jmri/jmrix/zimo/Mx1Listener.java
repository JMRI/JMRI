...
/**
 * Mx1Listener provides the call-back interface for notification when a
 * new MX-1 message arrives from the layout.
 *<P>
 * Note that the Mx1Listener implementation cannot assume that messages will
...
public interface Mx1Listener extends java.util.EventListener{
	...
	/**
	 * Member function that will be invoked by a Mx1Interface implementation
	 * to forward a MX-1 message from the layout.
	 *
	 * @param msg  The received MX-1 message.  Note that this same object
