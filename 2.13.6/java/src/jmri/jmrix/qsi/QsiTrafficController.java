...
// The methods to implement the QsiInterface
	...
	QsiListener lastSender = null;
        ...
        public int getQsiState() { return qsiState; }
        public void setQsiState(int s) {
          ...
          if (log.isDebugEnabled()) log.debug("Setting qsiState " + s);
        }
        public boolean isNormalMode() {return qsiState == NORMAL; }
        public boolean isSIIBootMode() {return qsiState == SIIBOOTMODE; }
	...
	protected void notifyReply(QsiReply r) {
        ...
        public void sendQsiMessage(QsiMessage m, QsiListener reply) {
          if (log.isDebugEnabled()) log.debug("sendQsiMessage message: ["+m+"]");
	 ...
	 * @return The registered QsiTrafficController instance for general use,
