...
public class InitialAlgorithm implements Calculator {
    ...
    public Measurement convert(Reading r, Measurement last) {
        ...
        if (this.x > 9.E99) this.x = 0;
        if (this.y > 9.E99) this.y = 0;
        if (this.z > 9.E99) this.z = 0;
...
boolean gps()						{// GPS Position Solver
  ...
  if (ngps == 3)				{//  Solve with absolute ranges
    ...
    log.debug("e1 = "+e1);
    if (e1 > 1e-4)  x1 = y1 = z1 = r01 = 9.9999999e99;//	  solution 1 NG
    ...
    log.debug("e2 = "+e2);
    if (e2 > 1e-4)  x2 = y2 = z2 = r02 = 9.9999999e99; //	  solution 2 NG
  }
  ...
  if (e1 <= e2)					{//       (also global inputs)
    x0 = x1;  y0 = y1;  z0 = z1;  r0 = r01	;}//Solution (global variables)
  else						{//   GPS Position =
    x0 = x2;  y0 = y2;  z0 = z2;  r0 = r02	;}//    x0, y0, z0,
