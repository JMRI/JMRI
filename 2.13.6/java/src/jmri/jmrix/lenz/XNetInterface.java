 ...
 *<P>
 * The jmri.jrmix.lenz.XNetTrafficControler provides the first implementation
 * of this interface.
 *<P>
 ...
 * to put it in the jmri.InterfaceManager.  And Java interfaces can't have 
 * static members, so we can't provide an implementation() member.  For 
 * now, we use a static implementation member in the XNetTrafficController 
 * implementation to locate _any_ implementation; this clearly needs to be 
 * improved.
 *<P>
...
public interface XNetInterface {
	...
	/**
         * Mask value to request notification of communications related
         * messages generated by the computer interface
         */
