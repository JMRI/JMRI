...
##### openlcb.jar
- 0.7.19 from https://oss.sonatype.org/service/local/repositories/releases/content/org/openlcb/openlcb/0.7.19/openlcb-0.7.19.jar or the maven central repository.
