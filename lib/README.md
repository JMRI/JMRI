...
##### openlcb.jar
- 0.7.24 from https://oss.sonatype.org/service/local/repositories/releases/content/org/openlcb/openlcb/0.7.24/openlcb-0.7.24.jar or the maven central repository.
