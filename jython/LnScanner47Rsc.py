...
apNameVersion = "LocoNet Scanner - v4.7"
...
doAvgPlot = True #plot averages for number of accummulated periods
doSecsPlot = True #plot each seconds total bytes received
