...
JMRI Project. See PreferencesExamples.py for usage examples.
...
def getPreferences(node, shared = True):
    ...
    Project for the given node. If shared is True, return
    preferences that are common to all computers using this
    Project, otherwise return preferences specific to this computer.
