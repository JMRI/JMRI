...
print "Loading USBDriver : Gamepad"

class USBDriver :
    def __init__(self):
        self.componentNextThrottleFrame = "5"  # Component for throttle frames browsing
        self.valueNextThrottleFrame = 1
        self.componentPreviousThrottleFrame = "7"
        self.valuePreviousThrottleFrame = 1
        
        self.componentNextRunningThrottleFrame = "4"  # Component for running throttle frames browsing
        self.valueNextRunningThrottleFrame = 1
        self.componentPreviousRunningThrottleFrame = "6"
        ...
        self.componentRosterSelect = "0"  # Component to select a roster
        self.valueRosterSelect = 1
        
        # From there available only when a throttle is active in current window        
        self.componentThrottleRelease = "0"  # Component to release current throttle
        ...
        self.componentStopSpeed = "14" # Preset speed button stop, double tap will Estop
        self.valueStopSpeed = 1
    
        self.componentSlowSpeed = "13" # Preset speed button slow
        self.valueSlowSpeed = 1 
    
        self.componentCruiseSpeed = "15" # Preset speed button cruise, double tap will max speed
        self.valueCruiseSpeed = 1
    
        self.componentMaxSpeed = "12" # Preset speed button max
        self.valueMaxSpeed = 1

        self.componentF0 = "10" # Function button
        self.valueF0 = 1
        self.valueF0Off = 0  # off event for non lockable functions

        self.componentF1 = "11" # Function button
        self.valueF1 = 1 
        self.valueF1Off = 0

        self.componentF2 = "8" # Function button
        self.valueF2 = 1
        self.valueF2Off = 0

        self.componentF3 = "9" # Function button
        self.valueF3 = 1
        self.valueF3Off = 0
