...
class Update_Signal_Logic():
    ...
    def set_layout_editor(self):
        ...
        for layout_editor in EditorManager.getList():
    ...
    def update_auto_signal_mast_logic2(self):
        ...
        if self.loglevel > 3:  print "******************************************"
        if self.loglevel > 3:  print "********* update_auto_signal_mast_logic2 *"
        if self.loglevel > 3:  print "******************************************"
        ...
        for e in validPaths.entrySet():
            ...
            if self.loglevel > 3:  print "validDestMast", validDestMast
    ...
    def setupLayoutEditorTurnoutDetails(self, lblks, sml, SourceMast, destination, destLayoutBlock, editor) :
        if self.loglevel > 3:  print "**********************************"
        if self.loglevel > 3:  print "****** Setting Turnout Details ***", SourceMast.getUserName(), destination.getUserName(), destLayoutBlock.getUserName()
        if self.loglevel > 3:  print "**********************************"
        if self.loglevel > 3:  print ""

        if SourceMast.getUserName() != "Board2toPT11" or  destination.getUserName() !=  "PT41toGoods":
            if self.loglevel > 3:  print "Not required mast set"
            return
        ...
        for i in range(lblks.size()):
            ...
            if i > 0 :
                ...
                if i == lblks.size() - 1 :
                    ...
                    if self.loglevel > 3:  print "destLayoutBlock", destLayoutBlock
