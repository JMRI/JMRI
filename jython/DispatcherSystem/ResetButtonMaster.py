class ResetButtonMaster(jmri.jmrit.automat.AbstractAutomaton):
    ...
    def handle(self):
        ...
        if self.sensor_active_sensors_requiring_use_of_station_buttons != None:
    ...
    def get_sensors_requiring_use_of_station_buttons(self):
        self.sensors_requiring_use_of_station_buttons = \
            [sensors.getSensor(sensorName) for sensorName in ["setDispatchSensor", "setRouteSensor", "setStoppingDistanceSensor" ]]
