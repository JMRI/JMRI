...
//   Version 1.1
//  This is preconfigured for an Arduino Uno, Pro Mini, or Nano, pins 2-19, no inversion, no offset
...
//
#define Data_Pin_Max    20  // Max sensor pin NUMBER (plus one) Mega=70,UNO,Pro Mini,Nano=20
