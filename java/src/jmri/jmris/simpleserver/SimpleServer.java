...
public class SimpleServer extends JmriServer {
    ...
    public SimpleServer(int port) {
        super(port);
        InstanceManager.setDefault(SimpleServer.class,SimpleServer.this);
    ...
    public void handleClient(DataInputStream inStream, DataOutputStream outStream) throws IOException {
        ...
        try (Scanner inputScanner = new Scanner(new InputStreamReader(inStream, StandardCharsets.UTF_8))) {
            // Listen for commands from the client until the connection closes
            String cmd;
