 ...
 *
 * Convention pattern is to provide a subclass of this name in each package,
 * working off the local resource bundle name.
 *
...
public class Bundle extends jmri.Bundle {
    ...
    protected static Bundle b = new Bundle("jmri.jmris.JmriServerBundle"); // NOI18N

    /**
     * Provides access to a string for a given key from the package resource
     * bundle or parent. <p> Note that this is intentionally package-local
     * access.
     */
