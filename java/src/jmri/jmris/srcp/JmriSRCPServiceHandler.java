...
public class JmriSRCPServiceHandler extends jmri.jmris.ServiceHandler {
     ...
     public String getClientVersion() { return _client_version; }
     public void setClientVersion(String ver) { _client_version=ver; }
     ...
     public void setRunMode() { runmode = true; }
     ...
     public void setCommandMode(boolean mode){commandMode=mode;}
