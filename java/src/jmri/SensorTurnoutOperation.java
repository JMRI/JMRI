...
public class SensorTurnoutOperation extends CommonTurnoutOperation {
    ...
    final int feedbackModes = AbstractTurnout.ONESENSOR | AbstractTurnout.TWOSENSOR | AbstractTurnout.EXACT | AbstractTurnout.INDIRECT | AbstractTurnout.LNALTERNATE ;
