 ...
 */
    public void sendList(){
        ...
        for (String sysName : sysNameList){
            ...
            list.append("]\\[" + sysName);
            list.append("}|{");
            if (t.getUserName() != null) list.append(t.getUserName());
 ...
 */
    ...
    public void register(){
        for (String sysName : sysNameList){
            ...
            if (t != null){
                t.addPropertyChangeListener(this);
                if (log.isDebugEnabled()) log.debug("Add listener to Turnout: "+t.getSystemName());
            }
    ...
    public void deregister(){
        ...
        for (String sysName : sysNameList){
            ...
            if (t != null){
                ...
                if (log.isDebugEnabled()) log.debug("Remove listener from Turnout: "+t.getSystemName());
            }
