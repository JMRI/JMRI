...
public class AddEntryExitPairPanel extends jmri.util.swing.JmriPanel {
    ...
    JCheckBox quiteFail = new JCheckBox(Bundle.getMessage("QuietFail"));  // NOI18N
    ...
    protected void optionWindow(ActionEvent e) {
        if (optionsFrame == null) {
            ...
            p5.add(quiteFail);
            quiteFail.setSelected(nxPairs.isQuietFail());
            optionsPane.add(p5);
    ...
    void optionSaveButton() {
        ...
        nxPairs.setQuietFail(quiteFail.isSelected());
