...
public class CTCSerialData {
    ...
    public OtherData getOtherData() { return _mOtherData; }
    public int getUniqueNumber() { return _mOtherData.getNextUniqueNumber(); }
    public CodeButtonHandlerData getCodeButtonHandlerDataViaUniqueID(int uniqueID) {
        for (CodeButtonHandlerData codeButtonHandlerData : _mCodeButtonHandlerDataArrayList) {
            if (codeButtonHandlerData._mUniqueID == uniqueID) return codeButtonHandlerData;
        }
        return null;    // In case it's not found.
    }
    public String getMyShortStringNoCommaViaUniqueID(int uniqueID ) {
        for (CodeButtonHandlerData codeButtonHandlerData : _mCodeButtonHandlerDataArrayList) {
            if (codeButtonHandlerData._mUniqueID == uniqueID) return codeButtonHandlerData.myShortStringNoComma();
        }
    ...
    public int getIndexOfUniqueID(int uniqueID) {
        for (int index = 0; index < _mCodeButtonHandlerDataArrayList.size(); index++) {
            if (_mCodeButtonHandlerDataArrayList.get(index)._mUniqueID == uniqueID) return index;    // That's it.
        }
        return -1;  // not found.
    }
    public void setOtherData(OtherData otherData) { _mOtherData = otherData; }
    public ArrayList <CodeButtonHandlerData> getCodeButtonHandlerDataArrayList() { return _mCodeButtonHandlerDataArrayList; }
    public void addCodeButtonHandlerData(CodeButtonHandlerData codeButtonHandlerData) { _mCodeButtonHandlerDataArrayList.add(codeButtonHandlerData); }
    public void removeCodeButtonHandlerData(int index) { _mCodeButtonHandlerDataArrayList.remove(index); }
    public CodeButtonHandlerData getCodeButtonHandlerData(int index) { return _mCodeButtonHandlerDataArrayList.get(index); }
    public int getCodeButtonHandlerDataSize() { return _mCodeButtonHandlerDataArrayList.size(); }
...
//  textual representation of the UniqueID that we should look up and fix with.
    ...
    private String commonCode1(String stringToFix, int uniqueIDBeingModified, String replacementString) {
        ...
        for (int ssvArrayIndex = 0; ssvArrayIndex < ssvArrayList.size(); ssvArrayIndex++) {
            ...
            if ((returnString = lazy1(uniqueIDBeingModified, replacementString, trafficLockingEntry._mUniqueID1)) != null) { loopAnyModified = true; trafficLockingEntry._mUniqueID1 = returnString; }
            if ((returnString = lazy1(uniqueIDBeingModified, replacementString, trafficLockingEntry._mUniqueID2)) != null) { loopAnyModified = true; trafficLockingEntry._mUniqueID2 = returnString; }
            if ((returnString = lazy1(uniqueIDBeingModified, replacementString, trafficLockingEntry._mUniqueID3)) != null) { loopAnyModified = true; trafficLockingEntry._mUniqueID3 = returnString; }
            if ((returnString = lazy1(uniqueIDBeingModified, replacementString, trafficLockingEntry._mUniqueID4)) != null) { loopAnyModified = true; trafficLockingEntry._mUniqueID4 = returnString; }
            if ((returnString = lazy1(uniqueIDBeingModified, replacementString, trafficLockingEntry._mUniqueID5)) != null) { loopAnyModified = true; trafficLockingEntry._mUniqueID5 = returnString; }
...
//  If none are found, return -1 (which we'll then increment by 2 to 1, which is a good "add" default starting point):
    public int findHighestSwitchNumberUsedSoFar() {
        ...
        for (CodeButtonHandlerData codeButtonHandlerData : _mCodeButtonHandlerDataArrayList) {
            if (codeButtonHandlerData._mSwitchNumber > highestSwitchNumber) highestSwitchNumber = codeButtonHandlerData._mSwitchNumber;
        }
...
//  If none are found, return 0 (which we'll then increment by 1 to 1, which is a good "add" default starting point):
    public int findHighestColumnNumberUsedSoFar() {
        ...
        for (CodeButtonHandlerData codeButtonHandlerData : _mCodeButtonHandlerDataArrayList) {
            if (codeButtonHandlerData._mGUIColumnNumber > highestColumnNumber) highestColumnNumber = codeButtonHandlerData._mGUIColumnNumber;
        }
