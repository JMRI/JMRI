...
public class DlgFindAndReplace extends javax.swing.JDialog {
     ...
     */
    private static final String FORM_PROPERTIES = "DlgFindAndReplace";
    ...
    public DlgFindAndReplace(java.awt.Frame parent, boolean modal, AwtWindowProperties awtWindowProperties, CTCSerialData ctcSerialData) {
        ...
        _mSelectDeselectAll.setText(SELECT_ALL);
    ...
    private void updateSelectionCount() {
        ...
        _mCountSelected.setText("Count selected: " + Integer.toString(selectionCount));
...
//  DOES NOT SEE ANY OF THE DATA!  Therefore, I have to load the data via the model instead of directly:
    ...
    private void _mSelectDeselectAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event__mSelectDeselectAllActionPerformed
        if (_mSelectDeselectAll.getText().equals(SELECT_ALL)) {
            if (_mResults.getRowCount() > 0) {
                _mResults.setRowSelectionInterval(0, _mResults.getRowCount() - 1);
            }
            _mSelectDeselectAll.setText(DESELECT_ALL);
        } else { 
