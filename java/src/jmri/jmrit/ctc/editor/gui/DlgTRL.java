...
public class DlgTRL extends javax.swing.JDialog {
    ...
    public DlgTRL(  java.awt.Frame parent, boolean modal,
        ...
        updateRuleCounts();
        this.setTitle("Edit traffic locking " + codeButtonHandlerData.myShortStringNoComma());
    }
    ...
    private void updateRuleCounts() {
        _mLeftNumberOfRules.setText("Rules: " + Integer.toString(ProjectsCommonSubs.getArrayListFromSSV(_mCodeButtonHandlerData._mTRL_LeftTrafficLockingRulesSSVList).size()));
        _mRightNumberOfRules.setText("Rules: " + Integer.toString(ProjectsCommonSubs.getArrayListFromSSV(_mCodeButtonHandlerData._mTRL_RightTrafficLockingRulesSSVList).size()));
