...
public class DlgCO extends javax.swing.JDialog {
     ...
     */
    private static final String FORM_PROPERTIES = "DlgCO";
    private static final String PREFIX = "_mCO_";
    ...
    private void initOrig() {
        ...
        _mCO_SignalTypeOrig = _mCodeButtonHandlerData._mCO_SignalType;
    }
...
//  DOES NOT SEE ANY OF THE DATA!  Therefore, I have to load the data via the model instead of directly:
        ...
        CommonSubs.numberButtonGroup(_mCO_SignalType);
        CommonSubs.setButtonSelected(_mCO_SignalType, _mCodeButtonHandlerData._mCO_SignalType.getInt());
        initOrig();
...
//  Checks:        
    ...
    private void initComponents() {
        ...
        _mCO_SignalType = new javax.swing.ButtonGroup();
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(_mSignalMast)
                                        .addComponent(_mSignalHead)))
    ...
    private void _mSaveAndCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event__mSaveAndCloseActionPerformed
        ...
        _mCodeButtonHandlerData._mCO_SignalType = CodeButtonHandlerData.SIGNAL_TYPE.getSignalType(_mCO_SignalType);
    ...
    private void _mAddNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event__mAddNewActionPerformed
        ...
        _mGroupingListAddReplace.setText("Add this to the end of Grouping list above");
    ...
    private void _mEditBelowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event__mEditBelowActionPerformed
        ...
        _mGroupingListAddReplace.setText("Update selected item in the Grouping list above");
        _mGroupingListAddReplace.setEnabled(true);
    ...
    private void _mGroupingListAddReplaceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event__mGroupingListAddReplaceActionPerformed
        if (ProjectsCommonSubs.isNullOrEmptyString(_mExternalSignal.getText())) {
            JOptionPane.showMessageDialog(this, "Signal MUST have a value", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (signalHeadSelected) {
            if (ProjectsCommonSubs.isNullOrEmptyString(_mCalledOnExternalSensor.getText())) {
                JOptionPane.showMessageDialog(this, "Called on sensor MUST have a value", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
        } else {
            if (ProjectsCommonSubs.isNullOrEmptyString(_mExternalBlock.getText())) {
                JOptionPane.showMessageDialog(this, "Block MUST have a value", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
    ...
    private javax.swing.JRadioButton _mSignalHead;
    private javax.swing.JRadioButton _mSignalMast;
