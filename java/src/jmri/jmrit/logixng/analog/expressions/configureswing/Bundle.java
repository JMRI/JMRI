package jmri.jmrit.logixng.analog.expressions.configureswing;
 ...
 * @since 3.3.1
 */
public class Bundle extends jmri.jmrit.logixng.digital.actions.Bundle {

    @CheckForNull
    private static final String name = "jmri.jmrit.logixng.analog.expressions.configureswing.AnalogExpressionSwingBundle";
