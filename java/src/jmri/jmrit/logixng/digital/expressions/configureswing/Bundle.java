 ...
 * @since 3.3.1
 */
public class Bundle extends jmri.jmrit.logixng.digital.expressions.Bundle {

    @CheckForNull
    private static final String name = "jmri.jmrit.logixng.digital.expressions.configureswing.DigitalExpressionSwingBundle";
