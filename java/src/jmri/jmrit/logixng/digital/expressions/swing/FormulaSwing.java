...
import jmri.jmrit.logixng.digital.expressions.Formula;

/**
 * Configures an Formula object with a Swing JPanel.
 */
public class FormulaSwing extends AbstractExpressionSwing {
    ...
    public MaleSocket createNewObject(@Nonnull String systemName, @CheckForNull String userName) {
        Formula expression = new Formula(systemName, userName);
