...
public class LogixNG_DigitalBooleanActionInstanceInitializer extends AbstractInstanceInitializer {
    ...
    public Set<Class<?>> getInitalizes() {
        ...
        set.addAll(Arrays.asList(DigitalBooleanActionManager.class
        ));
        return set;
    }
