 ...
 * @since 3.3.1
 */
public class Bundle extends jmri.jmrit.logixng.implementation.Bundle {

    @CheckForNull
    private static final String name = "jmri.jmrit.logixng.implementation.swing.ImplementationSwingBundle";
