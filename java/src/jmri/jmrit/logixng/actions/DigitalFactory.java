    ...
    public Set<Map.Entry<Category, Class<? extends DigitalActionBean>>> getActionClasses() {
        Set<Map.Entry<Category, Class<? extends DigitalActionBean>>> digitalActionClasses =
                Set.of(
                        ...
                        new AbstractMap.SimpleEntry<>(Category.OTHER, Break.class),
                        new AbstractMap.SimpleEntry<>(Category.OTHER, Continue.class),
                        ...
                        new AbstractMap.SimpleEntry<>(Category.OTHER, Error.class),
                        new AbstractMap.SimpleEntry<>(Category.COMMON, ExecuteDelayed.class),
                        new AbstractMap.SimpleEntry<>(Category.OTHER, Exit.class),
                        new AbstractMap.SimpleEntry<>(Category.COMMON, For.class),
                        new AbstractMap.SimpleEntry<>(Category.COMMON, ForEach.class),
                        ...
                        new AbstractMap.SimpleEntry<>(Category.OTHER, Return.class),
