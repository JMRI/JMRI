 ...
 */
public class Return extends AbstractDigitalAction {

    public Return(String sys, String user) {
        super(sys, user);
    }
    ...
    public Base getDeepCopy(Map<String, String> systemNames, Map<String, String> userNames) throws JmriException {
        ...
        Return copy = new Return(sysName, userName);
    ...
    public String getShortDescription(Locale locale) {
        return Bundle.getMessage(locale, "Return_Short");
    }
