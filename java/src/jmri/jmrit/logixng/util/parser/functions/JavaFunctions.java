...
public class JavaFunctions implements FunctionFactory {
    ...
    public Set<Function> getFunctions() {
        ...
        functionClasses.add(new NewFunction());
    ...
    public static class NewFunction implements Function {

        @Override
        public String getModule() {
            return new JavaFunctions().getModule();
        }

        @Override
        public String getConstantDescriptions() {
            return new JavaFunctions().getConstantDescription();
        }
        ...
        public String getDescription() {
            return Bundle.getMessage("Java.new_Descr");
        }
