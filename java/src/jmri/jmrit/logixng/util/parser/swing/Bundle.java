 ...
 * @since 3.3.1
 */
public class Bundle extends jmri.jmrit.logixng.util.parser.Bundle {

    @CheckForNull
    private static final String name = "jmri.jmrit.logixng.util.parser.swing.ParserSwingBundle";
