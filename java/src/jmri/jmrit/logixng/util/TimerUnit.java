...
public enum TimerUnit {
    ...
    Minutes(1000 * 60, Bundle.getMessage("TimerUnit_UnitMinutes"), Bundle.getMessage("TimerUnit_TimeSeconds")),
    Hours(1000 * 60 * 60, Bundle.getMessage("TimerUnit_UnitHours"), Bundle.getMessage("TimerUnit_TimeSeconds"));
