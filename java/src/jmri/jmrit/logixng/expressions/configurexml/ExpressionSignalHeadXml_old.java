 ...
 */
public class ExpressionSignalHeadXml_old extends jmri.managers.configurexml.AbstractNamedBeanManagerConfigXML {

    public ExpressionSignalHeadXml_old() {
    }
...
*/
    ...
    private final static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ExpressionSignalHeadXml_old.class);
}
