...
public class StringFormulaXml extends jmri.managers.configurexml.AbstractNamedBeanManagerConfigXML {
    ...
    public Element store(Object o) {
        ...
        Element element = new Element("StringFormula");
    ...
    public boolean load(Element shared, Element perNode) throws JmriConfigureXmlException {     // Test class that inherits this class throws exception
        List<StringFormula.SocketData> expressionSystemNames = new ArrayList<>();
        ...
        for (Element socketElement : actionElement.getChildren()) {
            ...
            expressionSystemNames.add(new StringFormula.SocketData(socketName, systemName, manager));
        }
