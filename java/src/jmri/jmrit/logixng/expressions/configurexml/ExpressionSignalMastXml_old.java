 ...
 */
public class ExpressionSignalMastXml_old extends jmri.managers.configurexml.AbstractNamedBeanManagerConfigXML {

    public ExpressionSignalMastXml_old() {
    }
    ...
    public Element store(Object o) {
        ExpressionSignalMast_old p = (ExpressionSignalMast_old) o;
...
//        if (p.getLightName() == null) throw new RuntimeException("aaaaa");
    ...
    public boolean load(Element shared, Element perNode) {
        ...
        ExpressionSignalMast_old h = new ExpressionSignalMast_old(sys, uname);
        ...
        if (queryType != null) {
            h.setQueryType(ExpressionSignalMast_old.QueryType.valueOf(queryType.getTextTrim()));
        }
