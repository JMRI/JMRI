...
public class LastResultOfDigitalExpressionSwing extends AbstractDigitalExpressionSwing {
    ...
    protected void createPanel(@CheckForNull Base object, @Nonnull JPanel buttonPanel) {
        ...
        for (MaleDigitalExpressionSocket bean : InstanceManager.getDefault(DigitalExpressionManager.class).getNamedBeanSet()) {
            if (bean.getUserName() != null) {
                ...
                if (expression != null) {
                    NamedBeanHandle<MaleDigitalExpressionSocket> handle =
                            expression.getSelectNamedBean().getNamedBean();
    ...
    public void updateObject(@Nonnull Base object) {
        ...
        if (expr.isEmpty()) expression.getSelectNamedBean().removeNamedBean();
        else expression.getSelectNamedBean().setNamedBean(expr);
    }
...
//    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(LastResultOfDigitalExpressionSwing.class);
