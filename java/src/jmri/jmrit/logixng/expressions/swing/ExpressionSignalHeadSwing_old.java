 ...
 */
public class ExpressionSignalHeadSwing_old extends AbstractDigitalExpressionSwing {
    ...
    private final static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ExpressionSignalHeadSwing_old.class);
