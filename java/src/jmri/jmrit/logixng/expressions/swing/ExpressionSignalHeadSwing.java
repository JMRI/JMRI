...
public class ExpressionSignalHeadSwing extends AbstractDigitalExpressionSwing {
    ...
    protected void createPanel(@CheckForNull Base object, @Nonnull JPanel buttonPanel) {
        ...
        if (expression != null) {
            ...
            if ((expression.getQueryType() == ExpressionSignalHead.QueryType.Appearance)
                    || (expression.getQueryType() == ExpressionSignalHead.QueryType.NotAppearance)) {
                setEnableQueryComboBox(true);
            } else {
                setEnableQueryComboBox(false);
            }
            ...
            if ((_tabbedPaneSignalHead.getSelectedComponent() == _panelSignalHeadDirect)
                    && (expression.getSignalHead() != null)) {
                sh = expression.getSignalHead().getBean();
            } else if (expression.getExampleSignalHead() != null) {
                sh = expression.getExampleSignalHead().getBean();
            }
