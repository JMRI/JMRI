 ...
 * @since 3.3.1
 */
public class Bundle extends jmri.jmrit.logixng.expressions.Bundle {

    @CheckForNull
    private static final String name = "jmri.jmrit.logixng.digital.expressions.swing.DigitalExpressionSwingBundle";
