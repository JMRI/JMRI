    ...
    public boolean evaluate() throws JmriException {
        ...
        for (ExpressionEntry e : _expressionEntries) {
            if (e._socket.isConnected() && e._socket.evaluate()) {
                if (_type == Type.EvaluateNeeded) return true;
                result = true;
            }
        }
        return result;
