...
public class VSDecoder implements PropertyChangeListener {
	 ...
	 * @param name
	 *            (String) Sound Profile name for this VSDecoder
	 */
	@Deprecated
	public VSDecoder(String id, String name) {
	 ...
	 * 
	 * @param id
	 *            (String) System name for this VSDecoder
	 * @param name
	 *            (String) Profile name
	 * @param path
	 ...
	 * 
	 * set the x/y/z position in the soundspace of this VSDecoder Translates the given position to a position relative
	 * to the listener for the component VSDSounds.
	 * 
	 * The idea is that the user-preference Listener Position (relative to the USER's chosen origin) is always the
	 * OpenAL Context's origin.
	 * 
	 * @param p
	 ...
	 * 
	 * @param t
	 *            (Train) the Train to interrogate
	 ...
	 * 
	 * @param name
	 *            (String) System name of the requested VSDSound
	 ...
	 * 
	 * @param d
	 *            (boolean) True to set this as the default, False if not.
	 */
	 ...
	 * 
	 * Get an XML representation of this VSDecoder Includes a subtree of Elements for all of the associated SoundEvents,
	 * Triggers, VSDSounds, etc.
	 * 
	 ...
	 * 
	 * @param vf
	 *            (VSDFile) : VSD File to pull the XML from
	 * @param pn
