...
//            List<LayoutTrackExpectedState<LayoutTurnout>> turnoutListTemp = turnoutUtil(s, seqNum, nextSection, at, le, false, false, prevSection);
//            for (LayoutTrackExpectedState<LayoutTurnout> x : turnoutListTemp){
//               if (!turnoutList.contains(x))
//                  turnoutList.add(x);
//            }
//        }
//        return turnoutList;
