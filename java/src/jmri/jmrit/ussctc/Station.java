...
/**
 * A Station represents the bits in the code message and holds references to the 
 * hardware at both ends that is controlled by them
 * <ul>
...
public class Station {
    ...
    /** 
     * @param next Section subclass that makes up part of this Station
