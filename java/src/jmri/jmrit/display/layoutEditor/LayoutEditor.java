...
//      toolBarSideFloatButton = new JRadioButtonMenuItem(Bundle.getMessage("ToolBarSideFloat"));
        toolBarSideFloatButton = new JRadioButtonMenuItem("Float");  //TODO - Bundle
    ...
    private void setToolBarWide(boolean newToolBarIsWide) {
        //null if edit toolbar not setup yet…
        if ((editToolBarContainer != null) && (toolBarIsWide != newToolBarIsWide)) {
    ...
    public void vetoableChange(java.beans.PropertyChangeEvent evt) throws java.beans.PropertyVetoException {
        ...
        if ("CanDelete".equals(evt.getPropertyName())) {    //IN18N
            ...
            if (nb instanceof SignalHead) {
                ...
                if (p != null) {
                    message.append("<li>");
                    message.append(Bundle.getMessage("VetoSignalHeadAssignedToPoint"));    //Need to expand to get the names of
                    //blocks
                    message.append("</li>");
                }
                ...
                if (lx != null) {
                    message.append("<li>");
                    message.append(Bundle.getMessage("VetoSignalHeadAssignedToLevelXing"));    //Need to expand to get the names of
                    //blocks
                    message.append("</li>");
                }
