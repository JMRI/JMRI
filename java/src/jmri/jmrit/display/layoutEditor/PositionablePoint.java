...
public class PositionablePoint extends LayoutTrack {
                ...
                jmi = popup.add(new AbstractAction(Bundle.getMessage("MergeAdjacentTracks")) {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if ((connect1 != null) && (connect2 != null)) {
                            ...
                            LayoutEditor.HitPointTypes newType2 = LayoutEditor.HitPointTypes.TRACK;
                            ...
                            if (newConnect2 == null) {
                                ...
                                if (newConnect2 instanceof PositionablePoint) {
                                    ...
                                    layoutEditor.setLink(newConnect2, newType2, connect1, LayoutEditor.HitPointTypes.TRACK);
                                }
    ...
    public ArrayList<String> getSegmentReferences(TrackSegment ts) {
        ...
        LayoutEditor.HitPointTypes type1 = ts.getType1();
        LayoutTrack conn1 = ts.getConnect1();
        items.addAll(ts.getPointReferences(type1, conn1));

        LayoutEditor.HitPointTypes type2 = ts.getType2();
    ...
    protected LayoutEditor.HitPointTypes findHitPointType(Point2D hitPoint, boolean useRectangles, boolean requireUnconnected) {
        ...
        if (!requireUnconnected || (getConnect1() == null)
            ...
            if (distance < minDistance) {
                ...
                minPoint = p;
                result = LayoutEditor.HitPointTypes.POS_POINT;
            }
        }
    ...
    public Point2D getCoordsForConnectionType(LayoutEditor.HitPointTypes connectionType) {
        ...
        if (connectionType != LayoutEditor.HitPointTypes.POS_POINT) {
    ...
    protected void highlightUnconnected(Graphics2D g2, LayoutEditor.HitPointTypes specificType) {
        if ((specificType == LayoutEditor.HitPointTypes.NONE) || (specificType == LayoutEditor.HitPointTypes.POS_POINT)) {
            if ((getConnect1() == null)
                    || ((getType() == ANCHOR) && (getConnect2() == null))) {
        ...
        if (getType() == ANCHOR) {
            ...
            if ((ts1 != null) && (ts2 != null)) {
                ...
                if ((blk1 != null) && (blk2 != null) && (blk1 != blk2)) {
                    ...
                    // save Connections
                    lc.setConnections(ts1, ts2, LayoutEditor.HitPointTypes.TRACK, this);
                    results.add(lc);
                }
            }
        } else if (getType() == EDGE_CONNECTOR) {
    ...
    public List<LayoutEditor.HitPointTypes> checkForFreeConnections() {
        ...
        if ((getConnect1() == null)
                || ((getType() == ANCHOR) && (getConnect2() == null))) {
            result.add(LayoutEditor.HitPointTypes.POS_POINT);
        }
        return result;
    }
