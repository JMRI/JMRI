                ...
                if (ltx instanceof LayoutSlip) {
                    ...
                    if (((TrackSegment) ls.getConnectA()).getLayoutBlock() == currLayoutBlock) {
                        if (((TrackSegment) ls.getConnectC()).getLayoutBlock() == nextLayoutBlock
                                || ((TrackSegment) ls.getConnectC()).getLayoutBlock() == prevLayoutBlock) {
                            companion.add(Integer.valueOf(LayoutSlip.STATE_AC));
                        } else if (((TrackSegment) ls.getConnectD()).getLayoutBlock() == nextLayoutBlock
                                || ((TrackSegment) ls.getConnectD()).getLayoutBlock() == prevLayoutBlock) {
                            companion.add(Integer.valueOf(LayoutSlip.STATE_AD));
                        } else if (((TrackSegment) ls.getConnectC()).getLayoutBlock() == currLayoutBlock) {
                            companion.add(Integer.valueOf(LayoutSlip.STATE_AC));
                        } else if (((TrackSegment) ls.getConnectD()).getLayoutBlock() == currLayoutBlock) {
                            companion.add(Integer.valueOf(LayoutSlip.STATE_AD));
                        } else {
                            if (!suppress) {
                    ...
                    } else if (((TrackSegment) ls.getConnectB()).getLayoutBlock() == currLayoutBlock) {
                        if (tTyp == LayoutSlip.DOUBLE_SLIP) {
                            ...
                            } else if (((TrackSegment) ls.getConnectC()).getLayoutBlock() == nextLayoutBlock
                                    || ((TrackSegment) ls.getConnectC()).getLayoutBlock() == prevLayoutBlock) {
                        ...
                        if (tTyp == LayoutSlip.DOUBLE_SLIP) {
                            if (((TrackSegment) ls.getConnectA()).getLayoutBlock() == nextLayoutBlock
                                    || ((TrackSegment) ls.getConnectA()).getLayoutBlock() == prevLayoutBlock) {
                                companion.add(Integer.valueOf(LayoutSlip.STATE_AC));
                            } else if (((TrackSegment) ls.getConnectB()).getLayoutBlock() == nextLayoutBlock
                                    || ((TrackSegment) ls.getConnectB()).getLayoutBlock() == prevLayoutBlock) {
                                companion.add(Integer.valueOf(LayoutSlip.STATE_BC));
                            } else if (((TrackSegment) ls.getConnectA()).getLayoutBlock() == currLayoutBlock) {
                                companion.add(Integer.valueOf(LayoutSlip.STATE_AC));
                            } else if (((TrackSegment) ls.getConnectB()).getLayoutBlock() == currLayoutBlock) {
                                companion.add(Integer.valueOf(LayoutSlip.STATE_BC));
                            } else {
                    ...
                    switch (tTyp) {
                        ...
                        case LayoutTurnout.WYE_TURNOUT:
                            if (((TrackSegment) ltx.getConnectA()).getLayoutBlock() == currLayoutBlock) {
                                if ((((TrackSegment) ltx.getConnectC()).getLayoutBlock() == nextLayoutBlock)
                                        || (((TrackSegment) ltx.getConnectC()).getLayoutBlock() == prevLayoutBlock)) {
                                    companion.add(Integer.valueOf(Turnout.THROWN));
                                } else if ((((TrackSegment) ltx.getConnectB()).getLayoutBlock() == nextLayoutBlock)
                                        || (((TrackSegment) ltx.getConnectB()).getLayoutBlock() == prevLayoutBlock)) {
                                    companion.add(Integer.valueOf(Turnout.CLOSED));
                                } else if (((TrackSegment) ltx.getConnectB()).getLayoutBlock() == currLayoutBlock) {
                                    companion.add(Integer.valueOf(Turnout.CLOSED));
                                } else if (((TrackSegment) ltx.getConnectC()).getLayoutBlock() == currLayoutBlock) {
                                    companion.add(Integer.valueOf(Turnout.THROWN));
                                } else {
                                    if (!suppress) {
                                ...
                                if (!suppress) {
                                    log.error("lb " + currLayoutBlock + " nlb " + nextLayoutBlock + " connect B " + ((TrackSegment) ltx.getConnectB()).getLayoutBlock() + " connect C " + ((TrackSegment) ltx.getConnectC()).getLayoutBlock());
                                }
                                companion.add(Integer.valueOf(Turnout.CLOSED));
                            }
                            break;
                        ...
                        case LayoutTurnout.DOUBLE_XOVER:
                            if (ltx.getLayoutBlock() == currLayoutBlock) {
                                if ((tTyp != LayoutTurnout.LH_XOVER) && ((ltx.getLayoutBlockC() == nextLayoutBlock)
                                        || (ltx.getLayoutBlockC() == prevLayoutBlock))) {
                                    companion.add(Integer.valueOf(Turnout.THROWN));
                                } else if ((ltx.getLayoutBlockB() == nextLayoutBlock)
                                        || (ltx.getLayoutBlockB() == prevLayoutBlock)) {
                                    companion.add(Integer.valueOf(Turnout.CLOSED));
                                } else if (ltx.getLayoutBlockB() == currLayoutBlock) {
                                    companion.add(Integer.valueOf(Turnout.CLOSED));
                                } else if ((tTyp != LayoutTurnout.LH_XOVER)
                                        && (ltx.getLayoutBlockC() == currLayoutBlock)) {
                                    companion.add(Integer.valueOf(Turnout.THROWN));
                                } else {
                                    if (!suppress) {
                                ...
                                if ((ltx.getLayoutBlock() == nextLayoutBlock) || (ltx.getLayoutBlock() == prevLayoutBlock)) {
                                    companion.add(Integer.valueOf(Turnout.CLOSED));
                                } else if ((tTyp != LayoutTurnout.RH_XOVER) && ((ltx.getLayoutBlockD() == nextLayoutBlock)
                                        || (ltx.getLayoutBlockD() == prevLayoutBlock) || (ltx.getLayoutBlockD() == currLayoutBlock))) {
                                    companion.add(Integer.valueOf(Turnout.THROWN));
                                } else {
                                    if (!suppress) {
                            ...
                            } else if (ltx.getLayoutBlockC() == currLayoutBlock) {
                                if ((tTyp != LayoutTurnout.LH_XOVER) && ((ltx.getLayoutBlock() == nextLayoutBlock)
                                        || (ltx.getLayoutBlock() == prevLayoutBlock))) {
                                    companion.add(Integer.valueOf(Turnout.THROWN));
                                } else if ((ltx.getLayoutBlockD() == nextLayoutBlock)
                                        || (ltx.getLayoutBlockD() == prevLayoutBlock) || (ltx.getLayoutBlockD() == currLayoutBlock)) {
                                    companion.add(Integer.valueOf(Turnout.CLOSED));
                                } else if ((tTyp != LayoutTurnout.LH_XOVER) && (ltx.getLayoutBlockD() == currLayoutBlock)) {
                                    companion.add(Integer.valueOf(Turnout.THROWN));
                                } else {
                                    if (!suppress) {
                            ...
                            } else if (ltx.getLayoutBlockD() == currLayoutBlock) {
                                if ((ltx.getLayoutBlockC() == nextLayoutBlock) || (ltx.getLayoutBlockC() == prevLayoutBlock)) {
                                    companion.add(Integer.valueOf(Turnout.CLOSED));
                                } else if ((tTyp != LayoutTurnout.RH_XOVER) && ((ltx.getLayoutBlockB() == nextLayoutBlock)
                                        || (ltx.getLayoutBlockB() == prevLayoutBlock))) {
                                    companion.add(Integer.valueOf(Turnout.THROWN));
                                } else {
                                    if (!suppress) {
