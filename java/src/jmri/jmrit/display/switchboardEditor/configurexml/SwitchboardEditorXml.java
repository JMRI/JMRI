...
public class SwitchboardEditorXml extends AbstractXmlAdapter {
     ...
     * {@link SwitchboardEditor$BeanSwitchXml}
     *
    ...
    public static class BeanSwitchXml extends AbstractXmlAdapter {
        ...
        /**
         * Default implementation for storing the contents of a BeanSwitch. Used
         * the display Switchboard switches in JMRI web server.
         *
         ...
         * pairs. Not currently used as BeanSwitches are autogenerated by
         * settings
         *
