 ...
 * only text or icon. So instead we inherit from JPanel and explicitly add the
 * code for Positionable.
 * <P>
 * This also has LocoNet-specific code, so perhaps should be in the
 * jmrix.loconet package. See also
 * {@link jmri.jmrit.display.configurexml.SecurityElementIconXml} if you move
 * this.
 *
...
public class SecurityElementIcon extends PositionableJPanel
    ...
    public boolean showPopUp(JPopupMenu popup) {
        ...
        String attach = "?";
        if (element.attachAleg == SecurityElement.A) {
            attach = "A";
        }
        if (element.attachAleg == SecurityElement.B) {
            attach = "B";
        }
        if (element.attachAleg == SecurityElement.C) {
            attach = "C";
        }
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                newVal
                        = javax.swing.JOptionPane.showInputDialog(null,
                                ...
                                javax.swing.JOptionPane.OK_CANCEL_OPTION);
                if (newVal.equals("A")) {
                    element.attachAleg = SecurityElement.A;
                } else if (newVal.equals("B")) {
                    element.attachAleg = SecurityElement.B;
                } else if (newVal.equals("C")) {
                    element.attachAleg = SecurityElement.C;
                } else {
                    log.warn("value needs to be A, B or C: " + newVal);
                }
            }
        }
        );

        if (element.attachBleg == SecurityElement.A) {
            attach = "A";
        }
        if (element.attachBleg == SecurityElement.B) {
            attach = "B";
        }
        if (element.attachBleg == SecurityElement.C) {
            attach = "C";
        }
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                newVal
                        = javax.swing.JOptionPane.showInputDialog(null,
                                ...
                                javax.swing.JOptionPane.OK_CANCEL_OPTION);
                if (newVal.equals("A")) {
                    element.attachBleg = SecurityElement.A;
                } else if (newVal.equals("B")) {
                    element.attachBleg = SecurityElement.B;
                } else if (newVal.equals("C")) {
                    element.attachBleg = SecurityElement.C;
                } else {
                    log.warn("value needs to be A, B or C: " + newVal);
                }
            }
        ...
        if (element.attachCleg == SecurityElement.A) {
            attach = "A";
        }
        if (element.attachCleg == SecurityElement.B) {
            attach = "B";
        }
        if (element.attachCleg == SecurityElement.C) {
            attach = "C";
        }
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                newVal
                        = javax.swing.JOptionPane.showInputDialog(null,
                                ...
                                javax.swing.JOptionPane.OK_CANCEL_OPTION);
                if (newVal.equals("A")) {
                    element.attachCleg = SecurityElement.A;
                } else if (newVal.equals("B")) {
                    element.attachCleg = SecurityElement.B;
                } else if (newVal.equals("C")) {
                    element.attachCleg = SecurityElement.C;
                } else {
                    log.warn("value needs to be A, B or C: " + newVal);
                }
            }
