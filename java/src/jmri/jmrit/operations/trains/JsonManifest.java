 ...
 *
 * This manifest is intended to be read by machines for building manifests in other, human-readable outputs. This
 * manifest is retained at build time so that manifests can be endlessly recreated in other formats, even if the
 * operations database state has changed. It is expected that the parsers for this manifest will be capable of querying
 * operations for more specific information while transforming this manifest into other formats.
 *
 * @author rhwood
 * @author Daniel Boudreau 1/26/2015 Load all cars including utility cars into the JSON file, and tidied up the code
 *         a bit.
 * 
 */
