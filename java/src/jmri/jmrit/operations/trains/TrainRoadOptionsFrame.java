...
public class TrainRoadOptionsFrame extends OperationsFrame implements java.beans.PropertyChangeListener {
	...
	public void radioButtonActionPerformed(java.awt.event.ActionEvent ae) {
		...
		if (_train != null){
			if (ae.getSource() == roadNameAll){
				_train.setRoadOption(Train.ALLLOADS);
				updateRoadNames();
			}
			if (ae.getSource() == roadNameInclude){
				_train.setRoadOption(Train.INCLUDELOADS);
				updateRoadNames();
			}
			if (ae.getSource() == roadNameExclude){
				_train.setRoadOption(Train.EXCLUDELOADS);
				updateRoadNames();
			}
		}
	}
	...
	private void updateRoadNames(){
		...
		if(_train != null){
			// set radio button
			roadNameAll.setSelected(_train.getRoadOption().equals(Train.ALLLOADS));
