...
public class TrainsByCarTypeFrame extends OperationsFrame implements java.beans.PropertyChangeListener {
	...
	/**
	 * Update the car types that trains and tracks service. Note that the checkbox name is the id of the train or track.
	 */
	private void save() {
	...
	static Logger log = LoggerFactory.getLogger(TrainsByCarTypeFrame.class.getName());
}
