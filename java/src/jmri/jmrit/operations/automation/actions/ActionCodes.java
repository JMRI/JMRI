...
public class ActionCodes {
    ...
    public static final int WAIT_FOR_TRAIN = 0x0700 + ENABLE_TRAINS + ENABLE_ROUTES + ENABLE_OK_MESSAGE + ENABLE_FAIL_MESSAGE;
    public static final int RESET_TRAIN = 0x0800 + ENABLE_TRAINS + ENABLE_OK_MESSAGE + ENABLE_FAIL_MESSAGE;
