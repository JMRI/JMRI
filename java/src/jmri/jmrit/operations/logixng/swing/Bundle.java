 ...
 * @since 3.3.1
 */
public class Bundle extends jmri.jmrit.operations.logixng.Bundle {

    @CheckForNull
    private static final String name = "jmri.jmrit.operations.logixng.swing.JmritOperationsLogixNGSwingBundle"; // NOI18N
