 ...
 */
public final class DefaultBlockManagerPreferences extends PreferencesBean implements BlockManagerPreferences {
    ...
    public DefaultBlockManagerPreferences() {
    ...
    @Override
    public boolean compareValuesDifferent(BlockManagerPreferences prefs) {
        ...
        return getShowSystemNameInException() != prefs.getShowSystemNameInException();
    }

    @Override
    public void apply(BlockManagerPreferences prefs) {
