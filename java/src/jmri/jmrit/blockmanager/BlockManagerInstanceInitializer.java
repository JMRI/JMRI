...
public class BlockManagerInstanceInitializer extends AbstractInstanceInitializer {
    ...
    public <T> Object getDefault(Class<T> type) {
        ...
        if (type == BlockManagerPreferences.class) {
            return new DefaultBlockManagerPreferences();
        }
