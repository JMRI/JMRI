...
/**
 * Provide a graphical representation of the NMRA Standard mapping between cab functions
 ...
 *   <dd>"Fd controls output n" (where d is a function number in the range 0-28 and n is an output number in the range 0-maxOut)</dd>
 ...
 *   <dd>"Fd controls output n(alt)" (allows an alternate definition for the same variable, such as used by Tsunami decoders)</dd>
