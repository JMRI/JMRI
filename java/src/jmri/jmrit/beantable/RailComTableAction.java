...
public class RailComTableAction extends AbstractTableAction {
    ...
    public RailComTableAction(String actionName) {
        ...
        log.info(InstanceManager.getDefault(RailComManager.class));
    ...
    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(RailComTableAction.class.getName());
}
