...
public final class ImageIndexEditor extends JmriJFrame {
    ...
    private JPanel makeCatalogPanel() {
        _catalog = CatalogPanel.makeCatalog("defaultCatalog", "selectNode", true); // make sure both these properties keys exist
    ...
    private JPanel makeIndexPanel() {
        _index = CatalogPanel.makeCatalog("ImageIndex", "selectIndexNode", true); // make sure both these properties keys exist
