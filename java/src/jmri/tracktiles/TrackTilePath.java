...
public class TrackTilePath {
    ...
    /**
     * Create a crossing path with length and angle (for crossings with explicit length).
     * 
     ...
     * @param id        Optional ID
     */
    public static TrackTilePath createAngleOnlyPath(@Nonnull String direction, String state, 
     ...
     * @param id        Optional ID
     */
    public static TrackTilePath createCrossingPath(@Nonnull String direction, String state,
     ...
     * 
     * @return true if this path has only an angle value (arc) without radius or length
     */
     ...
     * 
     * @return true if this path has both length and angle (crossing with explicit length)
     */
