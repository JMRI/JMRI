 ...
 * <P>
 * "Triple Output RGB" to differentiate from the existing RYG triple output head;
 * The class name fits in with the quad output name which is the equivalent
 * discrete lamp head.
 * <P>
 * The three Turnout objects are provided during construction,
 * and each drives a specific color (RED, GREEN and BLUE).
 * Normally, "THROWN" is on, and "CLOSED" is off.
 * <P>
 * Red = Red
 * Green = Green
 * Yellow = Red and Green
 * Lunar = Red, Green and Blue
 * <P>
...
public class TripleOutputSignalHead extends DoubleTurnoutSignalHead {
    ...
    public NamedBeanHandle<Turnout> getBlue() {return mBlue;}
	public void setBlue(NamedBeanHandle<Turnout> t) {mBlue=t;}
