...
public interface AnalogIO extends NamedBean {
    ...
    /**
     * Is the value an absolute value or a relative value? In both cases,
     * AnalogIO.getMin() and AnalogIO.getMax() tells the limits of the value.
     */
     ...
     * @throws jmri.JmriException       general error when setting the value
     *                                      fails
     ...
     * 
     * @return the size of the smallest changable value between
     ...
     * 
     * @return {@link AnalogIO.AbsoluteOrRelative#ABSOLUTE} if the values are
     *         absolute or {@link AnalogIO.AbsoluteOrRelative#RELATIVE} if the
     *         values are relative the last known value
     */
