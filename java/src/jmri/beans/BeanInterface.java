 ...
 * interface before attempting to get or set properties of those objects. Classes
 * implementing this interface can bypass the need to introspect the class to
 * manipulate a property, and can also implement properties that the Beans class
 * will be able to manipulate that do not conform to JavaBeans coding standards.
 * 
...
public interface BeanInterface {
     ...
     * <p>
     * <b>NOTE</b> Implementing methods <i>must not call</i> <code>Bean.getProperty()</code>,
     * as doing so will cause a stack overflow. Implementing methods may call
     ...
     * <p>
     * <b>NOTE</b> Implementing method <i>must not call</i> <code>Bean.hasProperty()</code>,
     * as doing so will cause a stack overflow. Implementing methods may call
     ...
     * <p>
     * <b>NOTE</b> Implementing method <i>must not call</i> <code>Bean.getPropertyNames()</code>,
     * as doing so will cause a stack overflow. Implementing methods may call
