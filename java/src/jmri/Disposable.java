 ...
 * <p>
 * There are no assurances this method will not be called multiple times.
 *
...
public interface Disposable {
     ...
     * called multiple times against a single instance of this Disposable.
     * It is the responsibility of this Disposable to protect itself and the
