...
/**
 * This is the common interface for Light and VariableLight. It's here because
 * some methods are moved from Light to the new interface VariableLight, but
 * cannot be removed immediately but needs to be deprecated first in Light.
 * <p>
 * DO NOT USE THIS INTERFACE DIRECTLY!!! IT WILL BE REMOVED LATER!!!
 * <p>
 * Use the interface Light or the interface VariableLight instead.
 * <p>
 * 
 * 
 * 
 ...
 */
public interface CommonLight extends DigitalIO {
