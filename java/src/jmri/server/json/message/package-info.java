 ...
 * <dt>type</dt><dd>One of {@value jmri.server.json.message.JsonMessage.TYPE.INFO},
 * {@value jmri.server.json.message.JsonMessage.TYPE.SUCCESS},
 * {@value jmri.server.json.message.JsonMessage.TYPE.WARNING}, or
 * {@value jmri.server.json.message.JsonMessage.TYPE.ERROR}</dd>
