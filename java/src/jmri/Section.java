...
public class Section extends AbstractNamedBean {
    ...
    private int getDirectionStandardTurnout(LayoutTurnout t, ConnectivityUtil cUtil) {
        ...
        if ((exBlock != null) || ((aBlock == bBlock) && (aBlock == cBlock))) {
            ...
            Block tBlock = null;
            TrackNode tn = new TrackNode(t, LayoutEditor.HitPointTypes.TURNOUT_A, (TrackSegment) t.getConnectA(),
            ...
            if (tBlock == null) {
                ...
                tn = new TrackNode(t, LayoutEditor.HitPointTypes.TURNOUT_A, (TrackSegment) t.getConnectA(),
            ...
            if (dir == EntryPoint.UNKNOWN) {
                ...
                tBlock = null;
                tn = new TrackNode(t, LayoutEditor.HitPointTypes.TURNOUT_B, (TrackSegment) t.getConnectB(),
                        false, Turnout.CLOSED);
                while ((tBlock == null) && (tn != null && (!tn.reachedEndOfTrack()))) {
                    tn = cUtil.getNextNode(tn, 0);
                    tBlock = cUtil.getExitBlockForTrackNode(tn, exBlock);
    ...
    private int getDirectionXoverTurnout(LayoutTurnout t, ConnectivityUtil cUtil) {
        ...
        if ((containsBlock(dBlock.getBlock())) || (containsBlock(cBlock.getBlock()))) {
            ...
            if (exBlock != null) {
                ...
                int dir = EntryPoint.UNKNOWN;
                Block tBlock = null;
                TrackNode tn = new TrackNode(t, LayoutEditor.HitPointTypes.TURNOUT_D, (TrackSegment) t.getConnectD(),
                        false, Turnout.CLOSED);
                while ((tBlock == null) && (tn != null) && (!tn.reachedEndOfTrack())) {
                    tn = cUtil.getNextNode(tn, 0);
                    tBlock = cUtil.getExitBlockForTrackNode(tn, exBlock.getBlock());
                ...
                if (tBlock != null) {
                    ...
                    tn = new TrackNode(t, LayoutEditor.HitPointTypes.TURNOUT_C, (TrackSegment) t.getConnectC(),
                            false, Turnout.CLOSED);
                    while ((tBlock == null) && (tn != null) && (!tn.reachedEndOfTrack())) {
                        tn = cUtil.getNextNode(tn, 0);
                        tBlock = cUtil.getExitBlockForTrackNode(tn, exBlock.getBlock());
    ...
    private int getDirectionSlip(LayoutTurnout t, ConnectivityUtil cUtil) {
        ...
        if ((containsBlock(aBlock.getBlock())) || (containsBlock(cBlock.getBlock()))) {
            ...
            if (exBlock != null) {
                ...
                int dir = EntryPoint.UNKNOWN;
                Block tBlock = null;
                TrackNode tn = new TrackNode(t, LayoutEditor.HitPointTypes.SLIP_A, (TrackSegment) t.getConnectA(),
                ...
                if (tBlock != null) {
                    ...
                    tn = new TrackNode(t, LayoutEditor.HitPointTypes.SLIP_C, (TrackSegment) t.getConnectC(),
                            false, LayoutTurnout.STATE_AC);
                    while ((tBlock == null) && (tn != null) && (!tn.reachedEndOfTrack())) {
                        tn = cUtil.getNextNode(tn, 0);
                        tBlock = cUtil.getExitBlockForTrackNode(tn, exBlock.getBlock());
        ...
        if ((containsBlock(dBlock.getBlock())) || (containsBlock(bBlock.getBlock()))) {
            ...
            if (exBlock != null) {
                ...
                int dir = EntryPoint.UNKNOWN;
                Block tBlock = null;
                TrackNode tn = new TrackNode(t, LayoutEditor.HitPointTypes.SLIP_D, (TrackSegment) t.getConnectD(),
                ...
                if (cUtil.isInternalLevelXingAC(x, cBlock)) {
                    ...
                    if (((x.getSignalAName() != null) && (!x.getSignalAName().equals("")))
                        ...
                        if ((x.getSignalAName() != null) && (!x.getSignalAName().equals(""))) {
                            ...
                            TrackNode tn = new TrackNode(x, LayoutEditor.HitPointTypes.LEVEL_XING_A,
                                    (TrackSegment) x.getConnectA(), false, 0);
                            TrackNode altNode = new TrackNode(x, LayoutEditor.HitPointTypes.LEVEL_XING_C,
                        ...
                        if ((x.getSignalCName() != null) && (!x.getSignalCName().equals(""))) {
                            ...
                            TrackNode tn = new TrackNode(x, LayoutEditor.HitPointTypes.LEVEL_XING_C,
                                    (TrackSegment) x.getConnectC(), false, 0);
                            TrackNode altNode = new TrackNode(x, LayoutEditor.HitPointTypes.LEVEL_XING_A,
                                    (TrackSegment) x.getConnectA(), false, 0);
                            SignalHead sh = InstanceManager.getDefault(jmri.SignalHeadManager.class).getSignalHead(
                                    x.getSignalCName());
                            if (!setDirectionSensorByConnectivity(tn, altNode, sh, cBlock, cUtil)) {
                ...
                if (cUtil.isInternalLevelXingBD(x, cBlock)) {
                    ...
                    if (((x.getSignalBName() != null) && (!x.getSignalBName().equals("")))
                        ...
                        if ((x.getSignalBName() != null) && (!x.getSignalBName().equals(""))) {
                            ...
                            TrackNode tn = new TrackNode(x, LayoutEditor.HitPointTypes.LEVEL_XING_B,
                                    (TrackSegment) x.getConnectB(), false, 0);
                            TrackNode altNode = new TrackNode(x, LayoutEditor.HitPointTypes.LEVEL_XING_D,
                        ...
                        if ((x.getSignalDName() != null) && (!x.getSignalDName().equals(""))) {
                            // there is a signal at C in the level crossing
                            TrackNode tn = new TrackNode(x, LayoutEditor.HitPointTypes.LEVEL_XING_D,
                                    (TrackSegment) x.getConnectD(), false, 0);
                            TrackNode altNode = new TrackNode(x, LayoutEditor.HitPointTypes.LEVEL_XING_B,
                                    (TrackSegment) x.getConnectB(), false, 0);
                            SignalHead sh = InstanceManager.getDefault(jmri.SignalHeadManager.class).getSignalHead(
                                    x.getSignalDName());
                            if (!setDirectionSensorByConnectivity(tn, altNode, sh, cBlock, cUtil)) {
