                ...
                for (JmriJFrame frame : frames) { //add all non-blank titles to list
                    if (frame.getAllowInFrameServlet()) {
                        ...
                        if (!frameTitle.equals("") && !disallowedFrames.contains(frameTitle)) {
                            ...
                            if (useAttributes) {
                                n.setAttribute("name", frameTitle.replaceAll(" ", "%20").replaceAll("#", "%23").replaceAll("&", "%26"));
                                n.setAttribute("userName", frameTitle);
                            } else {
                                n.addContent(new Element("type").addContent("frame"));
                                //get rid of spaces in name
                                n.addContent(new Element("name").addContent(frameTitle.replaceAll(" ", "%20").replaceAll("#", "%23").replaceAll("&", "%26")));
                ...
                for (JmriJFrame frame : frames) {
                    if (frame.getAllowInFrameServlet()) {
                        ...
                        if (!title.equals("") && !disallowedFrames.contains(title)) {
                            ...
                            if (useAttributes) {
                            	n.setAttribute("name", "ControlPanel/" + title.replaceAll(" ", "%20").replaceAll("#", "%23").replaceAll("&", "%26"));
                            	n.setAttribute("userName", title);
                            	n.setAttribute("type", "Control Panel");
                            } else {
                                n.addContent(new Element("type").addContent("panel"));
                                n.addContent(new Element("name").addContent("ControlPanel/" + title.replaceAll(" ", "%20").replaceAll("#", "%23").replaceAll("&", "%26")));
                ...
                for (JmriJFrame frame : frames) {
                    if (frame.getAllowInFrameServlet() && !(LayoutEditor.class.isInstance(frame))) {  //skip LayoutEditor panels, as they will be added next
                        ...
                        if (!title.equals("") && !disallowedFrames.contains(title)) {
                            Element n = new Element((useAttributes) ? "panel" : "item");
                            if (useAttributes) {
                            	n.setAttribute("name", "Panel/" + title.replaceAll(" ", "%20").replaceAll("#", "%23").replaceAll("&", "%26"));
                            	n.setAttribute("userName", title);
                            	n.setAttribute("type", "Panel");
                            } else {
                                n.addContent(new Element("type").addContent("panel"));
                                n.addContent(new Element("name").addContent("Panel/" + title.replaceAll(" ", "%20").replaceAll("#", "%23").replaceAll("&", "%26")));
                                n.addContent(new Element("userName").addContent(title));
                            }
                            e.addContent(n);
                        }
                ...
                for (JmriJFrame frame : frames) {
                    if (frame.getAllowInFrameServlet()) {
                        ...
                        if (!title.equals("") && !disallowedFrames.contains(title)) {
                            Element n = new Element((useAttributes) ? "panel" : "item");
                            if (useAttributes) {
                            	n.setAttribute("name", "Layout/" + title.replaceAll(" ", "%20").replaceAll("#", "%23").replaceAll("&", "%26"));
                            	n.setAttribute("userName", title);
                            	n.setAttribute("type", "Layout");
                            } else {
                                n.addContent(new Element("type").addContent("panel"));
                                n.addContent(new Element("name").addContent("Layout/" + title.replaceAll(" ", "%20").replaceAll("#", "%23").replaceAll("&", "%26")));
                                n.addContent(new Element("userName").addContent(title));
                            }
                            e.addContent(n);
                        }
