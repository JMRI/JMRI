...
public interface Throttle extends PropertyChangeProvider {
     ...
     */
    static String getFunctionString(int functionNum){
     ...
     */
    static String getFunctionMomentaryString(int momentFunctionNum){
     ...
     */
    @Nonnull
    abstract boolean[] getFunctionsMomentary();
     ...
     */
    abstract void setFunction(int functionNum, boolean newState);
     ...
     */
    abstract void setFunctionMomentary(int momFuncNum, boolean state);
     ...
     */
    abstract boolean getFunctionMomentary(int fN);
