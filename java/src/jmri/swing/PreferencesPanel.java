...
/**
 * An interface to define methods that the Preferences Window can and should expect Preferences panels to implement.
 * 
 * This class allows the Preferences Window become less formally aware of all possible preferences settings in JMRI, and
 * to instead interrogate a PreferencesPanel for most of the information that the Preferences window requires to add the
 * PreferencesPanel to the window.
 * 
 * @author Randall Wood (C) 2012
 */
public interface PreferencesPanel {
	 ...
	 * 
	 * Multiple PreferencePanels can be displayed as tabs in a single item. Preferences items are listed in the menu on
	 * the left of the preferences window.
	 * 
	 ...
	 * 
	 * This label is only displayed if the preferences panel is in a tabbed set of preferences. This label can contain
	 * multiple lines.
	 * 
	 * @return label text
	 */
	...
	/**
	 * Indicates that this PrefernecesPanel should be stored across application starts by the PreferencesManager
	 * 
	 ...
	 * 
	 * This method is called for every instance of a PreferencesPanel that is loaded by {@link apps.gui3.TabbedPreferences} if {@link #isPersistant()} is false.
	 */
