...
public interface Conditional extends NamedBean {
    ...
    enum Action {
        ...
        GET_TRAIN_LOCATION(ACTION_GET_TRAIN_LOCATION, ItemType.WARRANT, rbx.getString("ActionSetTrainLocation")), // NOI18N
        GET_BLOCK_WARRANT(ACTION_GET_BLOCK_WARRANT, ItemType.OBLOCK, rbx.getString("ActionGetBlockWarrant")), // NOI18N
        GET_BLOCK_TRAIN_NAME(ACTION_GET_BLOCK_TRAIN_NAME, ItemType.OBLOCK, rbx.getString("ActionGetBlockTrainName")), // NOI18N
    ...
    static final int ACTION_GET_TRAIN_LOCATION = 38;
    ...
    static final int ACTION_GET_BLOCK_WARRANT = 54;
    static final int ACTION_GET_BLOCK_TRAIN_NAME = 55;
