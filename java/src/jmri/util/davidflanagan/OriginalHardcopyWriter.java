 ...
 */
public class OriginalHardcopyWriter extends Writer {
    ...
    public OriginalHardcopyWriter(Frame frame, String jobname, int fontsize, double leftmargin, double rightmargin,
            double topmargin, double bottommargin, boolean isPreview) throws OriginalHardcopyWriter.PrintCanceledException {
        originalHardcopyWriter(frame, jobname, fontsize, leftmargin, rightmargin, topmargin, bottommargin, isPreview);
    }
    ...
    public OriginalHardcopyWriter(Frame frame, String jobname, int fontsize, double leftmargin, double rightmargin,
            ...
            throws OriginalHardcopyWriter.PrintCanceledException {
    ...
    private void originalHardcopyWriter(Frame frame, String jobname, int fontsize, double leftmargin, double rightmargin,
            double topmargin, double bottommargin, boolean isPreview) throws OriginalHardcopyWriter.PrintCanceledException {
