...
public class PerformFileModel extends AbstractStartupModel {
    ...
    public void performAction() throws JmriException {
        ...
        if (cm != null) {
            InstanceManager.getDefault(jmri.configurexml.DirtyManager.class).setLoading(true);
            cm.load(file);
            InstanceManager.getDefault(jmri.configurexml.DirtyManager.class).setLoading(false);
        }
    }
}
