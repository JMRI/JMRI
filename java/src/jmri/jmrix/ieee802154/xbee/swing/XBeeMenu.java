...
public class XBeeMenu extends JMenu {
    ...
    public XBeeMenu(jmri.jmrix.ieee802154.xbee.XBeeConnectionMemo memo) {
        ...
        add(new jmri.jmrix.ieee802154.xbee.swing.nodeconfig.XBeeNodeConfigAction(rb.getString("jmri.jmrix.ieee802154.xbee.swing.nodeconfig.NodeConfigAction"), memo));
