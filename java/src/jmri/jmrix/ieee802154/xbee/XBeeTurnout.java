...
public class XBeeTurnout extends AbstractTurnout{
    ...
    /**
     * Create a Turnout object, with system and user names and
    ...
    private void init(String id) {
        // store address
        systemName=id;
        String prefix=((XBeeConnectionMemo)(tc.getAdapterMemo())).getTurnoutManager().getSystemPrefix();
    ...
    static Logger log = LoggerFactory.getLogger(XBeeTurnout.class.getName());
}
