...
public class IEEE802154Reply extends jmri.jmrix.AbstractMRReply {
    ...
    public byte[] getDestinationAddress() {
        ...
        switch(destinationMode){
              case 0x00: return null;  // no destination address.
              case 0x01: return null;  // this value is reserved.
              case 0x10: length += 2; // 16 bit address
                         break;
              case 0x11: length += 8; // 64 bit address
                         break;
        }
    ...
    public byte[] getSourceAddr() {
        ...
        // source address offset.
        switch(destinationMode){
              case 0x00: break;  // no destination address.
              case 0x01: break;  // this value is reserved.
              case 0x10: offset += 2; // 16 bit address
                         break;
    ...
    public byte[] getPayload() {
        ...
        switch(sourceMode){
              case 0x00: break; // no source address.
              case 0x01: break; // this value is reserved.
              case 0x10: offset += 2; // 16 bit address
                         break;
              case 0x11: offset += 8; // 64 bit address
    ...
    * 
    */
   public int getFrameControl(){ return ( getElement(1) <<8 ) + getElement(2); }
   ...
   public boolean isIntraPanFrame(){ return((getFrameControl() & 0x0020 )!=0);}

   /*
    * @return the sequence number of the reply.  This is the 4th byte 
    * after the start byte.
    */
   public byte getSequenceByte(){ return (byte) getElement(3); }
