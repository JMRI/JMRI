...
public class BoardListPanel extends jmri.jmrix.dcc4pc.swing.Dcc4PcPanel implements PropertyChangeListener, Dcc4PcPanelInterface{
    ...
    public class ReaderBoardModel extends AbstractTableModel implements PropertyChangeListener
    {
        ...
        public String getColumnName(int col) {
            if (col==INPUTS_COLUMN) return rb.getString("ColumnInput");
            if (col==ADDRESS_COLUMN) return rb.getString("ColumnAddress");
            if (col==ENCODING_COLUMN) return rb.getString("ColumnEncoding");
            if (col==VERSION_COLUMN) return rb.getString("ColumnVersion");
            if (col==DESCRIPTION_COLUMN) return rb.getString("ColumnDescription");
