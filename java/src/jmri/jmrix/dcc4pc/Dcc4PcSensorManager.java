 ...
 * <P>
 * System names are "DPnn:yy", where nnn is the board id and yy is the 
 * port on that board.
 *
        ...
        if (activeBoards.size()>0) {
            ...
            if (pollThread==null) {
                pollThread = new Thread(new Runnable()
                        { public void run() { pollManager(); }},"DCC4PC Sensor Poll");
                pollThread.start();
            }
        } else {
   ...
   //This needs to be handled better possibly
    ...
    int getInputState(int value, int input){
        ...
        switch (input) {
            ...
            case 9:
            case 13:
            case 1: lastbit = 1; break;
            case 6:
            case 10:
            case 14:
            case 2: lastbit = 3; break;
            case 7:
            case 11:
            case 15:
            case 3: lastbit = 5; break;
            case 8:
            case 12:
            case 16:
            case 4: lastbit = 7; break;
            default:break;
        }
        int tempValue = value <<(31-lastbit);
        switch(tempValue >>>(31 - lastbit+(lastbit-1))){
            case 0: return Sensor.INACTIVE;
            case 1: return Sensor.ACTIVE;
            case 2: return Dcc4PcSensor.ORIENTA; //Occupied RailCom Orientation A
            case 3: return Dcc4PcSensor.ORIENTB; //Occupied RailCom Orientation B
            default: return Sensor.UNKNOWN;
        }
    }
    ...
    public static String decodeInputState(int state){
        String rtr = "";
        switch (state){
            case Sensor.INACTIVE: rtr = "UnOccupied"; break;
            case Sensor.ACTIVE: rtr = "Occupied No RailCom Data"; break;
            case Dcc4PcSensor.ORIENTA: rtr = "Occupied RailCom Orientation A"; break;
            case Dcc4PcSensor.ORIENTB: rtr = "Occupied RailCom Orientation B"; break;
            default: rtr = "Unknown";
        }
        return rtr;
    }
    ...
    int decodeDuplicatePacket(int value, int seq, Dcc4PcReporter rc){
        ...
        switch(seq) {
            ...
            case 1: lastbit=3; break;
            case 2: lastbit=5; break;
            case 3: lastbit=7; break;
            default:break;
        }
        int tempValue = value <<(31-lastbit);
    ...
    //        log.debug("Now to handle the duplicate packet data");
            ...
            if(log.isDebugEnabled()) log.debug("We have " + railComDupPacket + " size byte(s) to read on data");
            ...
            int i=0;
                ...
                return;
                    ...
                    switch (dcc_addr_type){
                        case LONG_ADDRESS: addt="Long"; break;
                        case SHORT_ADDRESS: addt="Short"; break;
                        default : addt="No Address"; break;
                    }
