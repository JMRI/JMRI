...
public class DuplexGroupTabbedPanel extends LnPanel {
    ...
    @Override public void initContext(Object context) {
    ...
    @Override public String getHelpTarget() { return "package.jmri.jmrix.loconet.duplexgroup.DuplexGroupTabbedPanel"; }
