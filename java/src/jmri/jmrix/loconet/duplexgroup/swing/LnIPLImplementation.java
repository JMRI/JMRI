 ...
 * of LocoNet messages associated with IPL.  IPL is a mechanism which allows
...
public class LnIPLImplementation extends javax.swing.JComponent implements jmri.jmrix.loconet.LocoNetListener {
    ...
    /**
     * Creates a LocoNet packet which queries IPL devices by specific host manufacturer,
     * specific host device type, specific slave manufacturer and specific slave device
     * type.  The invoking method is responsible for sending the message to LocoNet.
     * <p>
     * Note: Different devices respond differently depending on whether host and/or
     * slave manufacturer and/or device type information are provided.
     * <p>
     * @param hostMfr defines the host manufacturer number
     * @param hostDevice defines the host device type number
     * @param slaveMfr defines the slave manufacturer number
     ...
     * sending the message to LocoNet.
     * <p>
     * Note that UT4 and UT4R devices may not respond to this query.  UT4D devices
     * may respond to this query.
     * <p>
     * @return a LocoNetMessage containing the packet required to query (some) UT4
     * devices for IPL identification information
     */
    ...
    /**
     * Creates a LocoNet packet which queries PR3 devices for IPL
     * identification information.  The invoking method is responsible for
     * sending the message to LocoNet.
     ...
     * <p>
     * @param m
     * @return true if m contains IPL Identity Report with RF24 as slave, else false
     */
      ...
      * <p>
      * @param m
      * @return String containing the interpreted IPL Host Manufacturer and Device
      */
      ...
      * <p>
      * @param m
      * @return String containing the interpreted IPL Slave Manufacturer and Device
      */
     ...
     /**
      * Returns the IPL host manufacturer number from an IPL Identity report message.
      * <p>
     ...
     /**
      * Returns the slave manufacturer number from an IPL Identity report message.
      * <p>
      * The invoking method should ensure that message m is is an IPL Identity
      * message before invoking this method.
      * <p>
     ...
     /**
      * Returns the host firmware revision number from an IPL Identity report message.
      * <p>
      * The invoking method should ensure that message m is is an IPL Identity
      * message before invoking this method..
      * <p>
      ...
      * <p>
      * @param m
      * @return String containing the IPL host firmware revision in the format x.y
      */
     ...
     /**
      * Returns the Slave firmware revision number from an IPL Identity report message.
      * <p>
      * The invoking method should ensure that message m is is an IPL Identity
      * message before invoking this method..
      * <p>
      ...
      * <p>
      * @param m
      * @return String containing the IPL slave firmware revision in the format x.y
      */
     ...
     * <p>
     ...
     /**
      * Interprets IPL Identity Host Manufacturer and Host Device number as a string.
      * <p>
      * NOTE: Some IPL-capable devices cannot be completely determined based solely
      * on Host Manufacturer number and Host Device number.
      * <P>
      * NOTE: Some members of a device family do not support IPL.  An interpreted IPL
      * Host Manufacturer number and Host Device number might imply that all members do
      * support IPL.  As an example, UT4 and UT4R devices do not appear to support IPL,
      * while UT4D appears to support IPL.  This method will return "Digitrax UT4(x)"
     ...
     * @param hostDevice
     ...
     /**
      * Interprets IPL Identity Slave Manufacturer and Slave Device number as a string.
      * <p>
      * NOTE: Some IPL-capable devices may not be completely determined based solely
      * on Slave Manufacturer number and Slave Device number.
      * <p>
      * @param slaveMfr
      * @param slaveDevice
     ...
     * Ignores all other LocoNet messages.
     * <p>
