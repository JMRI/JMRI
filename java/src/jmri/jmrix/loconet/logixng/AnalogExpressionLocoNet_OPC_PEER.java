 ...
 */
public class AnalogExpressionLocoNet_OPC_PEER extends AbstractAnalogExpression
        implements PropertyChangeListener, VetoableChangeListener {

    private NamedBeanHandle<Memory> _memoryHandle;
    private boolean _listenersAreRegistered = false;
    
    public AnalogExpressionLocoNet_OPC_PEER(String sys, String user)
    ...
    private final static Logger log = LoggerFactory.getLogger(AnalogExpressionLocoNet_OPC_PEER.class);
