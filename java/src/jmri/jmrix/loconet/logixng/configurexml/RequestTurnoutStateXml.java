 ...
 */
public class RequestTurnoutStateXml extends jmri.managers.configurexml.AbstractNamedBeanManagerConfigXML {

    public RequestTurnoutStateXml() {
    }
    ...
    public Element store(Object o) {
        RequestTurnoutState p = (RequestTurnoutState) o;

        Element element = new Element("ActionLoconetRequestTurnoutState");
    ...
    public boolean load(Element shared, Element perNode) throws JmriConfigureXmlException {     // Test class that inherits this class throws exception
        ...
        RequestTurnoutState h = new RequestTurnoutState(sys, uname, null);
...
//    private final static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(RequestTurnoutStateXml.class);
}
