 ...
 */
public class PR4SystemConnectionMemo extends LocoNetSystemConnectionMemo {

    public PR4SystemConnectionMemo(LnTrafficController lt,
            SlotManager sm) {
        super(lt, sm);
    }

    public PR4SystemConnectionMemo() {
        super();
    }
    ...
    final static int PR4STANDALONEPROGRAMMERMODE = 0x00;
    final static int MS100MODE = 0x01;

    int mode = PR4STANDALONEPROGRAMMERMODE;
    private ShutDownTask restoreToLocoNetInterfaceModeTask;

    /**
     * Configure the subset of LocoNet managers valid for the PR4 in PR2 mode.
     */
    public void configureManagersPR2() {
        mode = PR4STANDALONEPROGRAMMERMODE;
        ...
        // Establish a ShutDownTask so that the PR4 should be be returned to
        ...
        if (restoreToLocoNetInterfaceModeTask == null) {
            restoreToLocoNetInterfaceModeTask = new QuietShutDownTask("Restore PR4 to LocoNet Interface Mode") {    // NOI18N
                @Override
                public boolean execute() {

                    if (mode == PR4STANDALONEPROGRAMMERMODE) {
                        ...
                        if (tc != null) {
                            ...
                            log.info("Configuring PR4 for 'LocoNet Interface' mode"); // NOI18N
                        }
                    }
                    return true;
                }
            ...
            if (InstanceManager.getNullableDefault(jmri.ShutDownManager.class) != null) {
                ...
                log.warn("The PR4 will not be automatically returned to 'LocoNet interface' mode upon quit!"); // NOI18N
            }
        }
    }
    ...
    /**
     * Configure the LocoNet managers valid for the PR4 in MS100 mode, same as super, flag the interface type.
     */
    ...
    @Override
    public void dispose() {
        InstanceManager.deregister(this, PR4SystemConnectionMemo.class);
        if(tm!=null){
           tm.dispose();
        }
        super.dispose();
