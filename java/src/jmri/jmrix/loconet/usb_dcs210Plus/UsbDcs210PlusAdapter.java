...
public class UsbDcs210PlusAdapter extends LocoBufferAdapter {
     ...
     * not considered a user-settable option.  Sets the DCS210Plus USB interface for the appropriate
    ...
    protected void setSerialPort(SerialPort activeSerialPort) throws UnsupportedCommOperationException {
        ...
        log.info("USB DCS210Plus adapter{}{} RTSCTS_OUT=" + SerialPort.FLOWCONTROL_RTSCTS_OUT + " RTSCTS_IN=" + SerialPort.FLOWCONTROL_RTSCTS_IN, activeSerialPort.getFlowControlMode() == SerialPort.FLOWCONTROL_RTSCTS_OUT ? " set hardware flow control, mode=" : " set no flow control, mode=", activeSerialPort.getFlowControlMode());
    }
