...
//        log.debug("Simulator reading message");
    ...
    private SerialReply generateReply(SerialMessage msg) {
        ...
        log.debug("Message address={} b1= {} b2={} b3={} b4={}", nodeaddr, b1, command, b3, b4);
        switch (command) {
            ...
            case 15 :
                ...
                reply.setElement(2, nodeaddr | 0x80);
                log.debug ("Confirm signal mast {} set", b4);
                reply.setElement(3, b4); // echo bank (bit 1234): 1-3 = signals
                reply = setParity(reply,0);
                break;
            ...
            case 115 :
                ...
                reply.setElement(0, nodeaddr | 0x80);
                reply.setElement(2, nodeaddr | 0x80);
                reply.setElement(3, b4 | 0x80); // echo bank (bit 1234): 1-3 = signals, 4-5 = sensors
                reply = setParity(reply,0);
                break;
            ...
            default:
                if (msg.getElement(3) == 101) { // this is the rename command, with element 2 = new node number
                    ...
                    log.debug("rename command not supported, old address: {}, new address: {}, b4: {}", nodeaddr, command, b4);
                    break;
                } else if (nodeaddr == 0) { // 0 = error
