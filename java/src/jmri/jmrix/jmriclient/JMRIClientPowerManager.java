...
public class JMRIClientPowerManager implements PowerManager, JMRIClientListener {
    ...
    public String getUserName() { return this.memo.getUserName(); }
	...
	private void checkTC() throws JmriException {
		if (tc == null) throw new JmriException("attempt to use JMRIClientPowerManager after dispose");
	}
