...
import jmri.jmrix.bachrus.KPFConnectionTypeList;
 ...
 * <p>
 * This connects a KPF-Zeller speedo reader interface via a serial com port.
...
public class SerialDriverAdapter extends SpeedoPortController {
    ...
    public SerialDriverAdapter() {
        ...
        setManufacturer(KPFConnectionTypeList.KPFZELLER);
    ...
    public String openPort(String portName, String appName) {
        ...
        try {
            ...
            try {
                activeSerialPort = portID.open(getSystemConnectionMemo(), 2000);  // name of program, msec to wait
