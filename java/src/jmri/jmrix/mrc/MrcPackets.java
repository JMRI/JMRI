                ...
                case ACCESSORYPACKETCMD:
                    ...
                    switch (m.getAccState()) {
                        case jmri.Turnout.CLOSED:
                            txt.append(MrcPacketBundle.getMessage("MrcPacketsAccyClosed")); //IN18N
                            break;
                        case jmri.Turnout.THROWN:
                            txt.append(MrcPacketBundle.getMessage("MrcPacketsAccyThrown")); //IN18N
                            break;
                        default:
                            txt.append(MrcPacketBundle.getMessage("MrcPacketsAccyUnk")); //IN18N
                    }
                    break;
                default:
