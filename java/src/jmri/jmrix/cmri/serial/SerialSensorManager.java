...
public class SerialSensorManager extends jmri.managers.AbstractSensorManager
    ...
    public Sensor createNewSensor(String systemName, String userName) {
        ...
        String sName = SerialTrafficController.normalizeSystemName(systemName);
        if (sName.equals("")) {
        ...
        // check bit number
        int bit = SerialTrafficController.getBitFromSystemName(sName);
        ...
        SerialNode node = (SerialNode) SerialTrafficController.getNodeFromSystemName(sName,_memo.getTrafficController());
        if (node == null) {
        ...
        while (iter.hasNext()) {
            ...
            if (sName == null) {
                ...
                if ((sName.charAt(0) == 'C') && (sName.charAt(1) == 'S')) {
                    ...
                    tNode = SerialTrafficController.getNodeFromSystemName(sName,_memo.getTrafficController());
                    if (tNode == node) {
                        // This sensor is for this new Serial Node - register it
                        node.registerSensor(getBySystemName(sName),
                                (SerialTrafficController.getBitFromSystemName(sName) - 1));
                    }
                }
            }
        }
    ...
    public String createSystemName(String curAddress, String prefix) throws JmriException {
        ...
        if (curAddress.contains(":")) {
            ...
            tmpSName = SerialTrafficController.makeSystemName("S", nAddress, bitNum);
