...
public class SerialTurnoutManager extends AbstractTurnoutManager {
    ...
    public Turnout createNewTurnout(String systemName, String userName) {
        ...
        String sName = "";
        sName = SerialTrafficController.normalizeSystemName(systemName);
        if (sName.equals("")) {
        ...
        String altName = SerialTrafficController.convertSystemNameToAlternate(sName);
        ...
        int nAddress = -1;
        nAddress = SerialTrafficController.getNodeAddressFromSystemName(sName);
        if (nAddress == -1) {
            return (null);
        }
        int bitNum = SerialTrafficController.getBitFromSystemName(sName);
        if (bitNum == 0) {
            return (null);
        }
        String conflict = "";
        ...
        if (!SerialTrafficController.validSystemNameConfig(sName, 'T',_memo.getTrafficController())) {
    ...
    public String createSystemName(String curAddress, String prefix) throws JmriException {
        ...
        if (curAddress.contains(":")) {
            ...
            tmpSName = SerialTrafficController.makeSystemName("T", nAddress, bitNum);
            ...
            bitNum = SerialTrafficController.getBitFromSystemName(tmpSName);
            nAddress = SerialTrafficController.getNodeAddressFromSystemName(tmpSName);
        } else {
            try {
