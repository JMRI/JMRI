...
public class SerialFilterFrame extends jmri.util.JmriJFrame {
    ...
    JButton nodeMonitorAll = new JButton(rb.getString("AllButtonText") );
    JButton nodeMonitorNone = new JButton(rb.getString("NoneButtonText") );
...
//        setBackground(Color.LIGHT_GRAY);
        ...
        nodeMonitorAll.setToolTipText(rb.getString("AllButtonTip") );
	nodeMonitorAll.addActionListener(new java.awt.event.ActionListener()
        ...
        nodeMonitorNone.setToolTipText(rb.getString("NoneButtonTip") );
	nodeMonitorNone.addActionListener(new java.awt.event.ActionListener()
        ...
        packetMonitorAll.setToolTipText(rb.getString("AllButtonTip") );
	packetMonitorAll.addActionListener(new java.awt.event.ActionListener()
        ...
        packetMonitorNone.setToolTipText(rb.getString("NoneButtonTip") );
    ...
    */
    public void nodeMonitorAllButtonActionPerformed()
    {
        for(int i=0; i<monitorNode.size(); i++)
          nodeTable.setValueAt(true,i,NodeTableModel.ENABLED_COLUMN);             
    }

    public void nodeMonitorNoneButtonActionPerformed()
    {
        for(int i=0; i<monitorNode.size(); i++)
          nodeTable.setValueAt(false,i,NodeTableModel.ENABLED_COLUMN);            
    }
    ...
    public void haltpollButtonActionPerformed(ActionEvent e) {
         ...
         if (stc.getPollNetwork())
            {
             haltPollButton.setText(rb.getString("HaltPollingText"));
            }
         else
            {
             haltPollButton.setText(rb.getString("StartPollingText"));
            }
    }
    ...
    static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(SerialFilterFrame.class.getName());
