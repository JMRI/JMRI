 ...
 * This class was derived from the NodeConfig class.
 *
...
//    	super();
    ...
    /**
     * Method to load all of the configured node information from the serial node
     * class.  This method is called by Edit and Delete node.
     */
...
//            statusText1.setVisible(true);
    ...
    {
        public String getColumnName(int c) {return osnodeConfigColumnNames[c];}
        public Class<?> getColumnClass(int c) {return String.class;}
        public int getColumnCount () {return 2;}
