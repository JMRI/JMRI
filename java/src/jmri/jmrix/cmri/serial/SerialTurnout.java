...
public class SerialTurnout extends AbstractTurnout {
    ...
    public SerialTurnout(String systemName, String userName,CMRISystemConnectionMemo memo) {
        ...
        tBit = SerialTrafficController.getBitFromSystemName(systemName);
    }
    ...
    protected void sendMessage(boolean closed) {
        ...
        if (!mPulseTimerOn) {
            if (tNode == null) {
                tNode = (SerialNode) SerialTrafficController.getNodeFromSystemName(tSystemName,_memo.getTrafficController());
                if (tNode == null) {
