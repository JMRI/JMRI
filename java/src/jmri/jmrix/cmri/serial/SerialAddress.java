 ...
 * <P>
 * Two address formats are supported: Ctnnnxxx where: t is the type code, 'T'
 ...
 * CS1003 (node address 1, bit 3), CL11234 (node address 11, bit234) CtnnnBxxxx
...
public class SerialAddress {
    ...
    public static AbstractNode getNodeFromSystemName(String systemName) {
        ...
        if (ua == -1) // error messages have already been issued by getNodeAddressFromSystemName
        {
            return null;
        }
