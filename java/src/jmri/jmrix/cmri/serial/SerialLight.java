...
public class SerialLight extends AbstractLight {
    ...
    private void initializeLight(String systemName) {
        ...
        mBit = SerialTrafficController.getBitFromSystemName(systemName);
        // Set initial state
        setState(OFF);
    }
    ...
    protected void doNewState(int oldState, int newState) {
        SerialNode mNode = (SerialNode) SerialTrafficController.getNodeFromSystemName(getSystemName(),_memo.getTrafficController());
        if (mNode != null) {
            if (newState == ON) {
