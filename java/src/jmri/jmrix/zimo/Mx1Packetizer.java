...
// data members to hold the streams
                ...
                while (true) {
                    try {
                        ...
                        while ( firstByte !=SOH && secondByte != SOH)  {
                           if (debug) log.debug("Skipping: "+Integer.toHexString(firstByte) + " " + Integer.toHexString(secondByte)); //IN18N
                        ...
                        while(true){
                            ...
                            message.add(b);
                            if (debug) log.debug("char is: "+Integer.toHexString(b)); //IN18N
                        }
    ...
    /**
     * Class to handle the re-transmission of messages that have not had a Level 1
    ...
    static class MessageQueued {
        ...
        Mx1Message getMessage() { return msg; }
        Mx1Listener getListener() { return reply; }
