package jmri.jmrix.pi.simulator.configurexml;

import jmri.jmrix.configurexml.AbstractConnectionConfigXml;
import jmri.jmrix.pi.RaspberryPiAdapter;
import jmri.jmrix.pi.simulator.RaspberryPiSimulatorConnectionConfig;
 ...
 * RaspberryPiSimulatorConnectionConfig object, but it's actually persisting the
 * RaspberryPiAdapter.
 * <p>
...
public class RaspberryPiSimulatorConnectionConfigXml extends AbstractConnectionConfigXml {
    ...
    protected void getInstance(Object object) {
        ...
        adapter = ((RaspberryPiSimulatorConnectionConfig) object).getAdapter();
    }

    @Override
    protected void register() {
        this.register(new RaspberryPiSimulatorConnectionConfig(adapter));
    }
    ...
    private static final Logger log = LoggerFactory.getLogger(RaspberryPiSimulatorConnectionConfigXml.class);
