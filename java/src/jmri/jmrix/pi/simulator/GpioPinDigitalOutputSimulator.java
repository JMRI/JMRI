 ...
 */
public class GpioPinDigitalOutputSimulator implements GpioPinDigitalOutput {
...
//    private final PinPullResistance ppr;
    ...
    public GpioPinDigitalOutputSimulator(Pin pin, String string) {
//        this.pin = pin;
        this.name = string;
//        this.ppr = ppr;
    }
    ...
    @Override
    public void high() {
        pinState = PinState.getState(true);
    }

    @Override
    public void low() {
        pinState = PinState.getState(false);
    }
    ...
    @Override
    public void toggle() {
        pinState = PinState.getState(!isHigh());
    }
    ...
    @Override
    public Future<?> blink(long delay, long duration, PinState pulseState) {
        throw new UnsupportedOperationException("Not supported");
    }

    @Override
    public Future<?> blink(long delay, long duration, PinState pulseState, TimeUnit unit) {
        throw new UnsupportedOperationException("Not supported");
    }

    @Override
    public Future<?> blink(long delay, long duration, TimeUnit unit) {
        throw new UnsupportedOperationException("Not supported");
    }

    @Override
    public Future<?> blink(long duration, PinState pulseState) {
        throw new UnsupportedOperationException("Not supported");
    }

    @Override
    public Future<?> blink(long duration) {
        throw new UnsupportedOperationException("Not supported");
    }

    @Override
    public Future<?> blink(long duration, PinState pulseState, TimeUnit unit) {
        throw new UnsupportedOperationException("Not supported");
    }

    @Override
    public Future<?> blink(long duration, TimeUnit unit) {
        throw new UnsupportedOperationException("Not supported");
    }
    ...
    @Override
    public Future<?> pulse(long duration, PinState pulseState,
                            Callable<Void> callback, TimeUnit unit) {
        throw new UnsupportedOperationException("Not supported");
    }

    @Override
    public Future<?> pulse(long duration, PinState pulseState, TimeUnit unit) {
        throw new UnsupportedOperationException("Not supported");
    }
    ...
    @Override
    public Future<?> pulse(long duration, TimeUnit unit) {
        throw new UnsupportedOperationException("Not supported");
    }
