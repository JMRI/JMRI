...
/**
 * Formatter for XPressNet messages that set speed and direction in 14 speed step mode.
 *
 * @see XNetMessage
...
public class XNet14SpeedStepModeSpeedAndDirectionFormatter implements XPressNetMessageFormatter {
    ...
    public String formatMessage(Message m) {
        ...
        return "Mobile Decoder Operations Request: " + Bundle.getMessage(X_NET_MESSAGE_SET_SPEED,
                ...
                + " " + (m.getElement(4) & 0x0f)
                + " " + direction
                + " " + Bundle.getMessage(SPEED_STEP_MODE_X, 14) + ".";
    }
