...
/** formatter for function group 8 operations request messages
 *
 * @author Paul Bender Copyright (C) 2024
 */
public class XNetFunctionGroup8OperateRequestMessageFormatter implements XPressNetMessageFormatter {
    ...
    public boolean handlesMessage(Message m) {
        return m instanceof XNetMessage &&
                ...
                m.getElement(1) == XNetConstants.LOCO_SET_FUNC_GROUP8;
    }
    ...
    public String formatMessage(Message m) {
        ...
        return "Mobile Decoder Operations Request: " + buildSetFunctionGroup8MonitorString((XNetMessage ) m);
    }

       private String buildSetFunctionGroup8MonitorString(XNetMessage m) {
        String text = Bundle.getMessage(X_NET_MESSAGE_SET_FUNCTION_GROUP_X, 8)
