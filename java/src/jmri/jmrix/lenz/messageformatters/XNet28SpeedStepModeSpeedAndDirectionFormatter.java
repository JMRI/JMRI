...
/**
 * Formatter for XPressNet messages that set speed and direction in 28 speed step mode.
 *
 * @see XNetMessage
...
public class XNet28SpeedStepModeSpeedAndDirectionFormatter implements XPressNetMessageFormatter {
    ...
    public boolean handlesMessage(Message m) {
        return m instanceof XNetMessage &&
                ((XNetMessage) m).getElement(0) == XNetConstants.LOCO_OPER_REQ &&
                        ((XNetMessage) m).getElement(1) == XNetConstants.LOCO_SPEED_28;
    }
    ...
    public String formatMessage(Message m) {
        ...
        return "Mobile Decoder Operations Request: " + Bundle.getMessage(X_NET_MESSAGE_SET_SPEED,
                ...
                + " " + speed +direction
                + " " + Bundle.getMessage(SPEED_STEP_MODE_X, 28) + ".";
    }
