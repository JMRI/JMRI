...
/**
 * Panel displaying (and logging) XpressNet messages
 * derived from XNetMonFrame.
 * @author			Bob Jacobsen   Copyright (C) 2002
 * @author          Paul Bender Copyright (C) 2004-2014
 * @author          Giorgio Terdina Copyright (C) 2007
 * @version         $Revision$
 */
public class XNetMonPane extends jmri.jmrix.
  AbstractMonPane implements XNetListener
{
  ...
  {				// receive a XpressNet message and log it
