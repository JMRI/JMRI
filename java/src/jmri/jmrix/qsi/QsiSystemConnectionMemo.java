...
public class QsiSystemConnectionMemo extends jmri.jmrix.SystemConnectionMemo {
     ...
     */
    public QsiTrafficController getQsiTrafficController() { return st; }
    public void setQsiTrafficController(QsiTrafficController st) { this.st = st; }
    ...
    /**
     * Configure the common managers for Qsi connections.
    ...
    static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(QsiSystemConnectionMemo.class.getName());
}
