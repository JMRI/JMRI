...
/**
 * <P>Interface between z21 messages and an XPressNet stream.</P> 
 * <P>
...
public class z21XPressNetTunnel implements z21Listener,XNetListener,Runnable {
   ...
   /**
    * Member function that will be invoked by a z21Interface implementation
    * to forward a z21 message from the layout.
    * 
    * @param msg  The received z21 message.  Note that this same object
  ...
  /**
   * Member function that will be invoked by a z21Interface implementation
   * to forward a z21 message sent to the layout.
   ...
   */
   ...
   /**
    * Member function invoked by an XNetInterface implementation to notify
    * a sender that an outgoing message timed out and was dropped from the
    * queue.
    */
