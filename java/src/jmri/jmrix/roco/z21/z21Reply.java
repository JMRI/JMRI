...
public class z21Reply extends AbstractMRReply {
    ...
    public int getOpCode() {return _dataChars[2]+(_dataChars[3]<<8);}

    public void setLength(int i) { 
        _dataChars[0]= (char)(i&0x00ff);
        _dataChars[1]= (char)((i&0xff00)>>8);
    }
    public int getLength() {return _dataChars[0]+(_dataChars[1]<<8);}

    protected int skipPrefix(int index){ return 0; }
