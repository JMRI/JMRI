...
/**
 * Extend jmri.AbstractSensor for AnymaDMX_ GPIO pins.
 * <P>
 * @author   Paul Bender Copyright (C) 2003-2017
 * @author George Warner Copyright (C) 2017
 * @since       4.9.6
 */
public class AnymaDMX_Sensor extends AbstractSensor implements GpioPinListenerDigital {
    ...
    public AnymaDMX_Sensor(String systemName, String userName) {
        this(systemName,userName,GpioFactory.getInstance(),PinPullResistance.PULL_DOWN);
    }

    public AnymaDMX_Sensor(String systemName, String userName,PinPullResistance p) {
        this(systemName,userName,GpioFactory.getInstance(),p);
    }

    public AnymaDMX_Sensor(String systemName) {
        this(systemName,GpioFactory.getInstance(),PinPullResistance.PULL_DOWN);
    }

    public AnymaDMX_Sensor(String systemName, PinPullResistance p) {
        this(systemName,GpioFactory.getInstance(),p);
    }

    public AnymaDMX_Sensor(String systemName, String userName,GpioController _gpio) {
        super(systemName, userName);
        // default pull is Pull Down
        init(systemName,_gpio,PinPullResistance.PULL_DOWN);
    }

    public AnymaDMX_Sensor(String systemName, String userName,GpioController _gpio, PinPullResistance p) {
        super(systemName, userName);
        init(systemName,_gpio,p);
    }

    public AnymaDMX_Sensor(String systemName,GpioController _gpio) {
        super(systemName);
        init(systemName,_gpio,PinPullResistance.PULL_DOWN);
    }

    public AnymaDMX_Sensor(String systemName,GpioController _gpio, PinPullResistance p) {
        super(systemName);
        init(systemName,_gpio,p);
    }
    ...
    private final static Logger log = LoggerFactory.getLogger(AnymaDMX_Sensor.class);
