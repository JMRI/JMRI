 ...
 * rolling stock to uniquely identify it.<br>
 * RailCom is a registered trademark of Lenz GmbH.
 * <P>
 * This implementation of RailCom is an extension of @see IdTag 
 * and holds the additional information that can be supplied by the decoder 
 * as defined in RP-9.3.2
 * <P>
...
public interface RailCom extends IdTag{
   ...
   /**
    * Gets the actual speed reported by the RailCom device
    * as a representation 128 speed steps
    * @return -1 if not set.
    */
    ...
    * Location is configured in CV876 (RP.9.3.2)
    * @return -1 if not set.
    */
    ...
    */
    ...
    /**
    * Gets the remaining fuel level as a %
    * Fuel level CV879 (RP.9.3.2)
    * @return -1 if not set.
    */
    ...
    */
    ...
    /**
    * Gets the Last Location that the RailCom device was identified in
    * Location is configured in CV876 (RP.9.3.2)
    * @return -1 if not set.
    */
    ...
    * Route Number is configured in CV874 (RP.9.3.2)
    * @return -1 if not set.
    */
