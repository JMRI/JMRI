 ...
 * common modifier is "dev" which denotes an unofficial build.
 * </ul>
 * Hence you expect to see JMRI versions called things like "4.7.2", "4.6",
 * "4.7.3dev", "4.7.2-pjc", "4.7.2dev-pjc".
 * <p>
 ...
 * </ul>
 * <dt>Unofficial<dd>
 * Unofficial releases are marked by "dev" after the version number, and
 * inclusion of the building user's ID.
 * <ul>
 * <li>If the revision number e.g. 123abc (git hash) is available in
 * release.revision_id, then "4.1.1dev+(user)+(date)+R123abc". Note the "R".
...
public class Version {
     ...
     */
    static final public String NON_OFFICIAL = "dev"; // NOI18N
