...
public class NoFeedbackTurnoutOperation extends CommonTurnoutOperation {
    ...
    final int feedbackModes
            = AbstractTurnout.DIRECT | AbstractTurnout.ONESENSOR | AbstractTurnout.TWOSENSOR | AbstractTurnout.INDIRECT | AbstractTurnout.EXACT | AbstractTurnout.MONITORING | AbstractTurnout.LNALTERNATE ;
