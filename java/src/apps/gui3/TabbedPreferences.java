 ...
 *
 * Preferences panels listed in the PreferencesPanel property of the AppsConfigBundle ResourceBundle
 * will be automatically loaded if they implement the {@link jmri.swing.PreferencesPanel} interface.
 * 
 * Other Preferences Panels will need to be manually added to this file in a manner similar to the
...
public class TabbedPreferences extends AppConfigBase {
	 ...
	 * 
	 * @param object
	 *            The instance of the pane
	 * @param type
	 *            The class of the object
	 * @param strMethod
	 *            the method to be invoked at save.
	 */
	...
	private void removeTab(ActionEvent e, int x) {
		...
		if (i != -1) {
			int n = JOptionPane.showConfirmDialog(null, MessageFormat.format(
					...
					new Object[] { connectionPanel.getTitleAt(i) }), rb
					.getString("MessageDeleteConnection"),
