 ...
 * @version $Revision$
 */
public class CrrSection4B extends CrrSection {

    void defineIO() {
        sig = InstanceManager.signalHeadManagerInstance().getByUserName("Signal 4B");
    ...
    void setOutput() {
        ...
        if (value == GREEN && !tu5 && si36) {
            value = YELLOW;
        } else if (value == GREEN && tu5 && si33) {
            value = YELLOW;
        }
