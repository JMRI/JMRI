...
public class SignalProTest {
    ...
    public void testLaunchLocoNet() throws IOException {
        ...
        try {
            ...
            // launch!
            SignalPro.main(new String[]{"SignalPro"});
            log.debug("started LocoNetSim");

            JUnitUtil.waitFor(()->{return JmriJFrame.getFrame("SignalPro") != null;},"window up");
        
            JUnitUtil.waitFor(()->{return JUnitAppender.checkForMessageStartingWith("SignalPro version") != null;}, "first Info line seen");
    ...
    private final static Logger log = LoggerFactory.getLogger(SignalProTest.class);
