 ...
 * Takes tne names of two properties files.  The first is the master, default
...
class PropertiesMergeTool {
    static public void main(String[] args) {
        ...
        try (var stream2 = new FileInputStream(args[1])) {
                ...
                for(String line; (line = fileReader.readLine()) != null; ) {
                    ...
                    if (line.startsWith("#")) {
                        ...
                        if (bundle2.containsKey(key)) {
                            ...
                            // write untranslated line
                            writeOutLine(line);
                        }
                    } else {
                        // don't understand the line, just write it out
                        // usually lines of spaces
                        writeOutLine(line);
                    }
                }
            }
