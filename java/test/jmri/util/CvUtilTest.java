...
//        System.out.println("getMaskDescription");
        assertEquals("bit 0", CvUtil.getMaskDescription("XXXXXXXV"));
        assertEquals("bit 2", CvUtil.getMaskDescription("XXXXXVXX"));
        assertEquals("bits 0-2,4,6", CvUtil.getMaskDescription("XVXVXVVV"));
        assertEquals("bits 1-2,4-5", CvUtil.getMaskDescription("XXVVXVVX"));
        assertEquals("no bits", CvUtil.getMaskDescription("XXXXXXXX"));
    }

    /**
     * Test of concatTextHtmlAware method, of class CvUtil.
     */
    @Test
    public void testConcatTextHtmlAware() {
//        System.out.println("concatTextHtmlAware");
        ...
        // test null cases
        assertEquals(CvUtil.concatTextHtmlAware(null, null), null);
        assertEquals(CvUtil.concatTextHtmlAware(baseText, null), baseText);
        assertEquals(CvUtil.concatTextHtmlAware(null, extraText), extraText);
        assertEquals(CvUtil.concatTextHtmlAware(baseTextHtml, null), baseTextHtml);
        assertEquals(CvUtil.concatTextHtmlAware(null, extraTextHtml), extraTextHtml);

        // test with no HTML
        result = CvUtil.concatTextHtmlAware(baseText, extraText);
        assertEquals(expResultNoHtml, result);

        // test with baseText HTML
        result = CvUtil.concatTextHtmlAware(baseTextHtml, extraText);
        assertEquals(expResultHtml, result);

        // test with extraText HTML
        result = CvUtil.concatTextHtmlAware(baseText, extraTextHtml);
        assertEquals(expResultHtml, result);

        // test with both HTML
        result = CvUtil.concatTextHtmlAware(baseTextHtml, extraTextHtml);
        assertEquals(expResultHtml, result);

        // test with baseText uppercase HTML
        result = CvUtil.concatTextHtmlAware(baseTextHtmlUpper, extraTextHtml);
        assertEquals(expResultHtml, result);

        // test with extraText uppercase HTML
        result = CvUtil.concatTextHtmlAware(baseTextHtml, extraTextHtmlUpper);
        assertEquals(expResultHtml, result);

        // test with both uppercase HTML
        result = CvUtil.concatTextHtmlAware(baseTextHtmlUpper, extraTextHtmlUpper);
        assertEquals(expResultHtml, result);
    }
