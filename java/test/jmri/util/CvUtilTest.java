...
//        System.out.println("concatTextHtmlAware");
        ...
        // test null cases
        Assert.assertEquals(CvUtil.concatTextHtmlAware(null, null), null);
        Assert.assertEquals(CvUtil.concatTextHtmlAware(baseText, null), baseText);
        Assert.assertEquals(CvUtil.concatTextHtmlAware(null, extraText), extraText);
        Assert.assertEquals(CvUtil.concatTextHtmlAware(baseTextHtml, null), baseTextHtml);
        Assert.assertEquals(CvUtil.concatTextHtmlAware(null, extraTextHtml), extraTextHtml);
