 ...
 *
 * This is a temporary test class to check some folders. It's used until all
 * folders are corrected.
 *
 * @author Daniel Bergqvist (C) 2026
 */
public class NonnullBeforeVoidTempTest {
    ...
    public static Stream<Arguments> data() {
        ...
        File[] directories = {new File("java/src/jmri/jmrit/"), new File("java/test/jmri/jmrit/")};
