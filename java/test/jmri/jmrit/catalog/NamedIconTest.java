...
public class NamedIconTest {
    ...
    public void testCTor() {
        NamedIcon t = new NamedIconSelector("program:resources/logo.gif","logo");
    ...
    public void testBadPrefix() {
        NamedIcon t = new NamedIconSelector("foof:biff.gif","logo");
    ...
    public void testNoFileBehindPrefix() {
        NamedIcon t = new NamedIconSelector("program:resources/foo/foo/foo/foo.gif","logo");
    ...
    public void testNoFileRelative() {
        NamedIcon t = new NamedIconSelector("resources/foo/foo/foo/foo.gif","logo");
    ...
    public void testTransformImage() {
        NamedIcon ni = new NamedIconSelector("program:resources/logo.gif","logo");
    ...
    public void testAnimatedGif() {
        NamedIcon ni = new NamedIconSelector("program:resources/icons/largeschematics/aspects/CSD-1962/003_o40_p.gif", "blink");
        int h = ni.getIconHeight();
        int w = ni.getIconWidth();
        JLabel comp = new JLabel();
    ...
    // private static final Logger log = LoggerFactory.getLogger(NamedIconTest.class);
