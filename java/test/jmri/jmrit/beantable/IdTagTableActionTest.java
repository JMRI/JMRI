...
public class IdTagTableActionTest extends AbstractTableActionBase<IdTag> {
    ...
    public void testAddThroughDialog() {
        ...
        JFrameOperator jfo1 = new JFrameOperator(f1);
        //Enter 1 in the text field labeled "System Name:"
        JLabelOperator jlo = new JLabelOperator(jfo1, Bundle.getMessage("LabelSystemName"));
        (new JTextFieldOperator((JTextField) jlo.getLabelFor())).enterText("1");
        //and press OK
        JemmyUtil.pressButton(jfo1, Bundle.getMessage("ButtonOK"));
