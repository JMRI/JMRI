...
public class BlockTableActionTest extends AbstractTableActionBase<Block> {
    ...
    public void testEditButton() {
        ...
        ((JTextField) jlo.getLabelFor()).setText("1");
        //and press create
        JemmyUtil.pressButton(jfo1, Bundle.getMessage("ButtonCreate"));
        jfo1.requestClose();
        jfo1.waitClosed();
        new EventTool().waitNoEvent(0);
        JTableOperator jto = new JTableOperator(jfo, 0);
        // find the "Edit" button and press it.  This is in the table body.
        jto.clickOnCell(0, jto.findColumn(Bundle.getMessage("ButtonEdit")));
