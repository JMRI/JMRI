...
public class RosterEntryTest {
    ...
    public void testEnsureFilenameExistsNew() {
        ...
        File f = new File(Roster.getRosterFilesLocation() + "test_Roster_Entry_123456789ABC.xml");
        if (f.exists()) {
            f.delete();
        }
    ...
    public void testEnsureFilenameExistsOld() throws IOException {
        ...
        r.setId("test Roster Entry 123456789ABC");
        Assert.assertEquals("initial ID ", "test Roster Entry 123456789ABC", r.getId());
        File f1 = new File(Roster.getRosterFilesLocation() + "test_Roster_Entry_123456789ABC.xml");
        if (!f1.exists()) {
            // create a dummy
        ...
        File f2 = new File(Roster.getRosterFilesLocation() + "test_Roster_Entry_123456789ABC0.xml");
        if (!f2.exists()) {
            // create a dummy
