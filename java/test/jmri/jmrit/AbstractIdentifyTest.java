...
public class AbstractIdentifyTest extends TestCase {
	...
	class AITest extends AbstractIdentify {
		public boolean test1()  { invoked = 1; return retval;}

		public boolean test2(int value) { invoked = 2; ivalue = value; return retval;}

		public boolean test3(int value) { invoked = 3; ivalue = value; return retval;}

		public boolean test4(int value) { invoked = 4; ivalue = value; return retval;}

		public boolean test5(int value) { invoked = 5; ivalue = value; return retval;}

		public boolean test6(int value) { invoked = 6; ivalue = value; return retval;}

		public boolean test7(int value) { invoked = 7; ivalue = value; return retval;}

		public boolean test8(int value) { invoked = 8; ivalue = value; return retval;}
