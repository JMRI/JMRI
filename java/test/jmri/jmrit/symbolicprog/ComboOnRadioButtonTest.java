...
public class ComboOnRadioButtonTest {
    ...
    public void testCTor() {
        ...
        ComboOnRadioButton t = new ComboOnRadioButton(new javax.swing.JComboBox<String>(),variable);
    ...
    private final static Logger log = LoggerFactory.getLogger(ComboOnRadioButtonTest.class.getName());
