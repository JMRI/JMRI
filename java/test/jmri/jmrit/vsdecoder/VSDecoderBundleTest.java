...
/**
 * Tests for the VSDecoderBundle class
 *
 * @author Bob Jacobsen Copyright (C) 2012
 */
public class VSDecoderBundleTest extends TestCase {
    ...
    public VSDecoderBundleTest(String s) {
        super(s);
    }

    // Main entry point
    static public void main(String[] args) {
        String[] testCaseName = {VSDecoderBundleTest.class.getName()};
        junit.textui.TestRunner.main(testCaseName);
    }

    // test suite from all defined tests
    public static Test suite() {
        TestSuite suite = new TestSuite(VSDecoderBundleTest.class);
        return suite;
    }
