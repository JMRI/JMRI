...
public class AutomationItemTest extends OperationsTestCase {
    ...
    public void testDefaults() {
        ...
        Assert.assertEquals("Number of actions", 33, AutomationItem.getActionComboBox().getItemCount());
        Assert.assertEquals("Number of actions", 33, AutomationItem.getActionList().size());
    }
