...
public class AutomationItemTest extends OperationsTestCase {
    ...
    public void testDefaults() {
        ...
        Assert.assertEquals("Number of actions", 36, AutomationItem.getActionComboBox().getItemCount());
        Assert.assertEquals("Number of actions", 36, AutomationItem.getActionList().size());
    }
