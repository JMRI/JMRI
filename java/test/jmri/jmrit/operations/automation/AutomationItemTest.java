...
public class AutomationItemTest extends OperationsTestCase {
    ...
    public void testDefaults() {
        ...
        Assert.assertEquals("Number of actions", 35, AutomationItem.getActionComboBox().getItemCount());
        Assert.assertEquals("Number of actions", 35, AutomationItem.getActionList().size());
    }
