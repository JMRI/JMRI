...
public class EditManifestTextFrameTest extends OperationsTestCase {
    ...
    public void testCloseWindowOnSave() {
        Assume.assumeFalse(GraphicsEnvironment.isHeadless());
        EditManifestTextFrame tf = new EditManifestTextFrame();
        tf.initComponents();
        ...
        JmriJFrame f = JmriJFrame.getFrame(Bundle.getMessage("TitleManifestText"));
        Assert.assertNotNull("exists", f);
        new JButtonOperator(jfo, Bundle.getMessage("ButtonSave")).doClick();
        f = JmriJFrame.getFrame(Bundle.getMessage("TitleManifestText"));
        Assert.assertNotNull("exists", f);
