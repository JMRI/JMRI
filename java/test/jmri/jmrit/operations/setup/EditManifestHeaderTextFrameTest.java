...
public class EditManifestHeaderTextFrameTest extends OperationsTestCase {
    ...
    public void testCloseWindowOnSave() {
        Assume.assumeFalse(GraphicsEnvironment.isHeadless());
        EditManifestHeaderTextFrame tf = new EditManifestHeaderTextFrame();
        tf.initComponents();
        ...
        JmriJFrame f = JmriJFrame.getFrame(Bundle.getMessage("TitleManifestHeaderText"));
        Assert.assertNotNull("exists", f);
        new JButtonOperator(jfo, Bundle.getMessage("ButtonSave")).doClick();
        f = JmriJFrame.getFrame(Bundle.getMessage("TitleManifestHeaderText"));
        Assert.assertNotNull("exists", f);
