...
public class TrackSegmentTest {
    ...
    public void testReplaceTrackConnection() {
        ...
        if ((layoutEditor != null) && (trackSegment != null)) {
            ...
            Assert.assertTrue("trackSegment.replaceTrackConnection(c1, null, NONE) fail", trackSegment.replaceTrackConnection(c1, null, LayoutEditor.HitPointTypes.NONE));
            ...
            Assert.assertTrue("trackSegment.replaceTrackConnection(c1, a3, POS_POINT) fail", trackSegment.replaceTrackConnection(c1, a3, LayoutEditor.HitPointTypes.POS_POINT));
        }
    }
    ...
    public void testSetNewConnect() {
        Assume.assumeFalse(GraphicsEnvironment.isHeadless());
        if ((layoutEditor != null) && (trackSegment != null)) {
            trackSegment.setNewConnect1(null, LayoutEditor.HitPointTypes.NONE);
            Assert.assertEquals("trackSegment.setNewConnect1(null, NONE)", null, trackSegment.getConnect1());
            Assert.assertEquals("trackSegment.setNewConnect1(null, NONE)", LayoutEditor.HitPointTypes.NONE, trackSegment.getType1());

            trackSegment.setNewConnect2(null, LayoutEditor.HitPointTypes.NONE);
            Assert.assertEquals("trackSegment.setNewConnect1(null, NONE)", null, trackSegment.getConnect2());
            Assert.assertEquals("trackSegment.setNewConnect1(null, NONE)", LayoutEditor.HitPointTypes.NONE, trackSegment.getType2());
        }
    }
    ...
    public void test_getConnection() {
        ...
        if ((layoutEditor != null) && (trackSegment != null)) {
            ...
            try {
                Assert.assertNull("trackSegment.getConnection()", trackSegment.getConnection(LayoutEditor.HitPointTypes.NONE));
...
//            Assert.assertNull("trackSegment.setLayoutBlock(null) == null", trackSegment.getLayoutBlock());
    ...
    public void test_findHitPointType() {
        ...
        if ((layoutEditor != null) && (trackSegment != null)) {
            ...
            Assert.assertEquals("trackSegment.findHitPointType()", LayoutEditor.HitPointTypes.TRACK, trackSegment.findHitPointType(ccc, false, false));
            Assert.assertEquals("trackSegment.findHitPointType()", LayoutEditor.HitPointTypes.NONE, trackSegment.findHitPointType(ccc, false, true));
            Assert.assertEquals("trackSegment.findHitPointType()", LayoutEditor.HitPointTypes.TRACK, trackSegment.findHitPointType(ccc, true, false));
            Assert.assertEquals("trackSegment.findHitPointType()", LayoutEditor.HitPointTypes.NONE, trackSegment.findHitPointType(ccc, true, true));

            Point2D ep1 = trackSegment.getConnect1().getCoordsForConnectionType(trackSegment.getType1());
            Assert.assertEquals("trackSegment.findHitPointType()", LayoutEditor.HitPointTypes.TRACK, trackSegment.findHitPointType(ep1, false, false));
            Assert.assertEquals("trackSegment.findHitPointType()", LayoutEditor.HitPointTypes.NONE, trackSegment.findHitPointType(ep1, false, true));
            Assert.assertEquals("trackSegment.findHitPointType()", LayoutEditor.HitPointTypes.TRACK, trackSegment.findHitPointType(ep1, true, false));
            Assert.assertEquals("trackSegment.findHitPointType()", LayoutEditor.HitPointTypes.NONE, trackSegment.findHitPointType(ep1, true, true));

            Point2D ep2 = trackSegment.getConnect2().getCoordsForConnectionType(trackSegment.getType2());
            Assert.assertEquals("trackSegment.findHitPointType()", LayoutEditor.HitPointTypes.TRACK, trackSegment.findHitPointType(ep2, false, false));
            Assert.assertEquals("trackSegment.findHitPointType()", LayoutEditor.HitPointTypes.NONE, trackSegment.findHitPointType(ep2, false, true));
            Assert.assertEquals("trackSegment.findHitPointType()", LayoutEditor.HitPointTypes.TRACK, trackSegment.findHitPointType(ep2, true, false));
            Assert.assertEquals("trackSegment.findHitPointType()", LayoutEditor.HitPointTypes.NONE, trackSegment.findHitPointType(ep2, true, true));

            trackSegment.setCircle(true);
            Point2D cp = trackSegment.getCoordsCenterCircle();
            Assert.assertEquals("trackSegment.findHitPointType()", LayoutEditor.HitPointTypes.TRACK_CIRCLE_CENTRE, trackSegment.findHitPointType(cp, false, false));
            Assert.assertEquals("trackSegment.findHitPointType()", LayoutEditor.HitPointTypes.NONE, trackSegment.findHitPointType(cp, false, true));
            Assert.assertEquals("trackSegment.findHitPointType()", LayoutEditor.HitPointTypes.TRACK_CIRCLE_CENTRE, trackSegment.findHitPointType(cp, true, false));
            Assert.assertEquals("trackSegment.findHitPointType()", LayoutEditor.HitPointTypes.NONE, trackSegment.findHitPointType(cp, true, true));
        }
    }
    ...
    public void setUpEach() throws Exception {
        ...
        if (!GraphicsEnvironment.isHeadless()) {
            if (layoutEditor != null) {
                ...
                trackSegment = new TrackSegment("TS1", p1, LayoutEditor.HitPointTypes.POS_POINT, p2, LayoutEditor.HitPointTypes.POS_POINT, false, true, layoutEditor);
            }
        }
    }
