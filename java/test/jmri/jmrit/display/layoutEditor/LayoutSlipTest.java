...
public class LayoutSlipTest {
    ...
    public void testGetConnectionTypes() throws jmri.JmriException {
        ...
        Assert.assertNull("lts.getConnectionType(SLIP_A) is null", lts.getConnection(LayoutEditor.HitPointTypes.SLIP_A));
        Assert.assertNull("lts.getConnectionType(SLIP_B) is null", lts.getConnection(LayoutEditor.HitPointTypes.SLIP_B));
        Assert.assertNull("lts.getConnectionType(SLIP_C) is null", lts.getConnection(LayoutEditor.HitPointTypes.SLIP_C));
        Assert.assertNull("lts.getConnectionType(SLIP_D) is null", lts.getConnection(LayoutEditor.HitPointTypes.SLIP_D));

        Assert.assertNull("ltd.getConnectionType(SLIP_A) is null", ltd.getConnection(LayoutEditor.HitPointTypes.SLIP_A));
        Assert.assertNull("ltd.getConnectionType(SLIP_B) is null", ltd.getConnection(LayoutEditor.HitPointTypes.SLIP_B));
        Assert.assertNull("ltd.getConnectionType(SLIP_C) is null", ltd.getConnection(LayoutEditor.HitPointTypes.SLIP_C));
        Assert.assertNull("ltd.getConnectionType(SLIP_D) is null", ltd.getConnection(LayoutEditor.HitPointTypes.SLIP_D));
    }
    ...
    public void testSlipState() {
        ...
        lts.toggleState(LayoutEditor.HitPointTypes.SLIP_LEFT);
        ...
        lts.toggleState(LayoutEditor.HitPointTypes.SLIP_RIGHT);
        Assert.assertTrue("Single slip state STATE_AC", lts.getSlipState() == LayoutTurnout.STATE_AC);
        lts.toggleState(LayoutEditor.HitPointTypes.SLIP_LEFT);
        Assert.assertTrue("Single slip state STATE_BD", lts.getSlipState() == LayoutTurnout.STATE_BD);
        lts.toggleState(LayoutEditor.HitPointTypes.SLIP_RIGHT);
        ...
        ltd.toggleState(LayoutEditor.HitPointTypes.SLIP_LEFT);
        ...
        ltd.toggleState(LayoutEditor.HitPointTypes.SLIP_LEFT);
        Assert.assertTrue("Double slip state STATE_AC", ltd.getSlipState() == LayoutTurnout.STATE_AC);
        ltd.toggleState(LayoutEditor.HitPointTypes.SLIP_RIGHT);
    ...
    public void testGetCoordsForConnectionType() {
        ...
        Assert.assertEquals("lts.getCoordsForConnectionType(NONE) is equal to...",
                ...
                lts.getCoordsForConnectionType(LayoutEditor.HitPointTypes.NONE));
        ...
        Assert.assertEquals("lts.getCoordsForConnectionType(SLIP_A) is equal to...",
                ...
                lts.getCoordsForConnectionType(LayoutEditor.HitPointTypes.SLIP_A));

        Assert.assertEquals("lts.getCoordsForConnectionType(SLIP_B) is equal to...",
                new Point2D.Double(30.20101012677667, 100.0),
                lts.getCoordsForConnectionType(LayoutEditor.HitPointTypes.SLIP_B));
        ...
        Assert.assertEquals("lts.getCoordsForConnectionType(SLIP_C) is equal to...",
                ...
                lts.getCoordsForConnectionType(LayoutEditor.HitPointTypes.SLIP_C));

        Assert.assertEquals("lts.getCoordsForConnectionType(SLIP_D) is equal to...",
                new Point2D.Double(69.79898987322333, 100.0),
                lts.getCoordsForConnectionType(LayoutEditor.HitPointTypes.SLIP_D));

        Assert.assertEquals("lts.getCoordsForConnectionType(SLIP_CENTER) is equal to...",
                new Point2D.Double(50.0, 100.0),
                lts.getCoordsForConnectionType(LayoutEditor.HitPointTypes.SLIP_CENTER));
        ...
        Assert.assertEquals("lts.getCoordsForConnectionType(SLIP_LEFT) is equal to...",
                ...
                lts.getCoordsForConnectionType(LayoutEditor.HitPointTypes.SLIP_LEFT));
        ...
        Assert.assertEquals("ltd.getCoordsForConnectionType(SLIP_RIGHT) is equal to...",
                ...
                ltd.getCoordsForConnectionType(LayoutEditor.HitPointTypes.SLIP_RIGHT));

        Assert.assertEquals("ltd.getCoordsForConnectionType(NONE) is equal to...",
                new Point2D.Double(100.0, 50.0),
                ltd.getCoordsForConnectionType(LayoutEditor.HitPointTypes.NONE));
        ...
        Assert.assertEquals("ltd.getCoordsForConnectionType(SLIP_A) is equal to...",
                ...
                ltd.getCoordsForConnectionType(LayoutEditor.HitPointTypes.SLIP_A));

        Assert.assertEquals("ltd.getCoordsForConnectionType(SLIP_B) is equal to...",
                new Point2D.Double(100.0, 69.79898987322332),
                ltd.getCoordsForConnectionType(LayoutEditor.HitPointTypes.SLIP_B));
        ...
        Assert.assertEquals("ltd.getCoordsForConnectionType(SLIP_C) is equal to...",
                ...
                ltd.getCoordsForConnectionType(LayoutEditor.HitPointTypes.SLIP_C));

        Assert.assertEquals("ltd.getCoordsForConnectionType(SLIP_D) is equal to...",
                new Point2D.Double(100.0, 30.201010126776673),
                ltd.getCoordsForConnectionType(LayoutEditor.HitPointTypes.SLIP_D));

        Assert.assertEquals("ltd.getCoordsForConnectionType(SLIP_CENTER) is equal to...",
                new Point2D.Double(100.0, 50.0),
                ltd.getCoordsForConnectionType(LayoutEditor.HitPointTypes.SLIP_CENTER));
        ...
        Assert.assertEquals("ltd.getCoordsForConnectionType(SLIP_LEFT) is equal to...",
                ...
                ltd.getCoordsForConnectionType(LayoutEditor.HitPointTypes.SLIP_LEFT));
    ...
    public void testGetConnectionInvalid() {
        ...
        try {
            ...
            Assert.assertNull("lts.getConnection(invalid type) is null",
                    lts.getConnection(LayoutEditor.HitPointTypes.NONE));
        ...
        try {
            ...
            Assert.assertNull("ltd.getConnection(invalid type) is null",
                    ltd.getConnection(LayoutEditor.HitPointTypes.NONE));
    ...
    public void testGetConnectionValid() {
        ...
        try {
            ...
            Assert.assertNull("lts.getConnection(valid type) is null",
                    lts.getConnection(LayoutEditor.HitPointTypes.SLIP_A));
        } catch (JmriException ex) {
        ...
        try {
            ...
            Assert.assertNull("ltd.getConnection(valid type) is null",
                    ltd.getConnection(LayoutEditor.HitPointTypes.SLIP_B));
        } catch (JmriException ex) {
        ...
        try {
            // test valid connection type (null value)
            Assert.assertNull("lts.getConnection(valid type) is null",
                    lts.getConnection(LayoutEditor.HitPointTypes.SLIP_C));
        } catch (JmriException ex) {
            Assert.fail("Exception thrown on lts.getConnection(valid type)");
        }
        try {
            // test valid connection type (null value)
            Assert.assertNull("ltd.getConnection(valid type) is null",
                    ltd.getConnection(LayoutEditor.HitPointTypes.SLIP_D));
        } catch (JmriException ex) {
            Assert.fail("Exception thrown on ltd.getConnection(valid type)");
        }
    }
    ...
    public void testSetConnection() {
        ...
        try {
            // test Invalid Connection Type
            lts.setConnection(LayoutEditor.HitPointTypes.NONE, null, LayoutEditor.HitPointTypes.NONE);
        ...
        try {
            // test Invalid Connection Type
            ltd.setConnection(LayoutEditor.HitPointTypes.NONE, null, LayoutEditor.HitPointTypes.NONE);
        ...
        try {
            ...
            lts.setConnection(LayoutEditor.HitPointTypes.SLIP_A, null, LayoutEditor.HitPointTypes.POS_POINT);
        ...
        try {
            // test invalid object type
            ltd.setConnection(LayoutEditor.HitPointTypes.SLIP_B, null, LayoutEditor.HitPointTypes.POS_POINT);
        ...
        try {
            // test valid types
            lts.setConnection(LayoutEditor.HitPointTypes.SLIP_C, null, LayoutEditor.HitPointTypes.NONE);
        } catch (JmriException ex) {
            Assert.fail("Exception thrown on lts.setConnection(valid types)");
        }
        try {
            // test valid types
            ltd.setConnection(LayoutEditor.HitPointTypes.SLIP_D, null, LayoutEditor.HitPointTypes.NONE);
        } catch (JmriException ex) {
    ...
    public void testFindHitPointType() {
        ...
        // First, try miss
        LayoutEditor.HitPointTypes hitType = lts.findHitPointType(MathUtil.zeroPoint2D, true, false);
        Assert.assertTrue("lts.findHitPointType equals NONE", hitType == LayoutEditor.HitPointTypes.NONE);

        // now try hit getCoordsLeft -> SLIP_LEFT
        hitType = lts.findHitPointType(lts.getCoordsLeft(), true, false);
        Assert.assertTrue("lts.findHitPointType equals SLIP_LEFT", hitType == LayoutEditor.HitPointTypes.SLIP_LEFT);

        // now try hit getCoordsRight -> SLIP_RIGHT
        hitType = lts.findHitPointType(lts.getCoordsRight(), false, false);
        Assert.assertTrue("lts.findHitPointType equals SLIP_RIGHT", hitType == LayoutEditor.HitPointTypes.SLIP_RIGHT);

        // now try hit getCoordsA -> SLIP_A
        hitType = lts.findHitPointType(lts.getCoordsA(), false, true);
        Assert.assertTrue("lts.findHitPointType equals SLIP_A", hitType == LayoutEditor.HitPointTypes.SLIP_A);

        // now try hit getCoordsB -> SLIP_B
        hitType = lts.findHitPointType(lts.getCoordsB(), false, true);
        Assert.assertTrue("lts.findHitPointType equals SLIP_B", hitType == LayoutEditor.HitPointTypes.SLIP_B);

        // now try hit getCoordsC -> SLIP_C
        hitType = lts.findHitPointType(lts.getCoordsC(), false, true);
        Assert.assertTrue("lts.findHitPointType equals SLIP_C", hitType == LayoutEditor.HitPointTypes.SLIP_C);

        // now try hit getCoordsD -> SLIP_D
        hitType = lts.findHitPointType(lts.getCoordsD(), false, true);
        Assert.assertTrue("lts.findHitPointType equals SLIP_D", hitType == LayoutEditor.HitPointTypes.SLIP_D);
    }
