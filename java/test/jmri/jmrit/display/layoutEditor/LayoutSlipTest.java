...
public class LayoutSlipTest {
    ...
    private LayoutEditor layoutEditor = new LayoutEditor();
    private LayoutSlip lts = new LayoutSlip("single", new Point2D.Double(50.0, 100.0), +45.0, layoutEditor, LayoutTurnout.SINGLE_SLIP);
    private LayoutSlip ltd = new LayoutSlip("double", new Point2D.Double(100.0, 50.0), -45.0, layoutEditor, LayoutTurnout.DOUBLE_SLIP);
