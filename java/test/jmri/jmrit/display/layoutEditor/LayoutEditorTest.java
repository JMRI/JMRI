...
public class LayoutEditorTest extends AbstractEditorTestBase<LayoutEditor> {
    ...
    public void testEnums() {
        Assert.assertTrue("HitPointTypes.NONE.getValue() == 0", LayoutEditor.HitPointType.NONE.getValue() == 0);
        Assert.assertTrue("HitPointTypes.POS_POINT.getValue() == 1", LayoutEditor.HitPointType.POS_POINT.getValue() == 1);
        Assert.assertTrue("HitPointTypes.TURNOUT_A.getValue() == 2", LayoutEditor.HitPointType.TURNOUT_A.getValue() == 2);
        Assert.assertTrue("HitPointTypes.TURNOUT_B.getValue() == 3", LayoutEditor.HitPointType.TURNOUT_B.getValue() == 3);
        Assert.assertTrue("HitPointTypes.TURNOUT_C.getValue() == 4", LayoutEditor.HitPointType.TURNOUT_C.getValue() == 4);
        Assert.assertTrue("HitPointTypes.TURNOUT_D.getValue() == 5", LayoutEditor.HitPointType.TURNOUT_D.getValue() == 5);
        Assert.assertTrue("HitPointTypes.LEVEL_XING_A.getValue() == 6", LayoutEditor.HitPointType.LEVEL_XING_A.getValue() == 6);
        Assert.assertTrue("HitPointTypes.LEVEL_XING_B.getValue() == 7", LayoutEditor.HitPointType.LEVEL_XING_B.getValue() == 7);
        Assert.assertTrue("HitPointTypes.LEVEL_XING_C.getValue() == 8", LayoutEditor.HitPointType.LEVEL_XING_C.getValue() == 8);
        Assert.assertTrue("HitPointTypes.LEVEL_XING_D.getValue() == 9", LayoutEditor.HitPointType.LEVEL_XING_D.getValue() == 9);
        Assert.assertTrue("HitPointTypes.TRACK.getValue() == 10", LayoutEditor.HitPointType.TRACK.getValue() == 10);
        Assert.assertTrue("HitPointTypes.TURNOUT_CENTER.getValue() == 11", LayoutEditor.HitPointType.TURNOUT_CENTER.getValue() == 11);
        Assert.assertTrue("HitPointTypes.LEVEL_XING_CENTER.getValue() == 12", LayoutEditor.HitPointType.LEVEL_XING_CENTER.getValue() == 12);
        Assert.assertTrue("HitPointTypes.TURNTABLE_CENTER.getValue() == 13", LayoutEditor.HitPointType.TURNTABLE_CENTER.getValue() == 13);
        Assert.assertTrue("HitPointTypes.LAYOUT_POS_LABEL.getValue() == 14", LayoutEditor.HitPointType.LAYOUT_POS_LABEL.getValue() == 14);
        Assert.assertTrue("HitPointTypes.LAYOUT_POS_JCOMP.getValue() == 15", LayoutEditor.HitPointType.LAYOUT_POS_JCOMP.getValue() == 15);
        Assert.assertTrue("HitPointTypes.MULTI_SENSOR.getValue() == 16", LayoutEditor.HitPointType.MULTI_SENSOR.getValue() == 16);
        Assert.assertTrue("HitPointTypes.MARKER.getValue() == 17", LayoutEditor.HitPointType.MARKER.getValue() == 17);
        Assert.assertTrue("HitPointTypes.TRACK_CIRCLE_CENTRE.getValue() == 18", LayoutEditor.HitPointType.TRACK_CIRCLE_CENTRE.getValue() == 18);
        Assert.assertTrue("HitPointTypes.UNUSED_19.getValue() == 19", LayoutEditor.HitPointType.UNUSED_19.getValue() == 19);
        Assert.assertTrue("HitPointTypes.SLIP_CENTER.getValue() == 20", LayoutEditor.HitPointType.SLIP_CENTER.getValue() == 20);
        Assert.assertTrue("HitPointTypes.SLIP_A.getValue() == 21", LayoutEditor.HitPointType.SLIP_A.getValue() == 21);
        Assert.assertTrue("HitPointTypes.SLIP_B.getValue() == 22", LayoutEditor.HitPointType.SLIP_B.getValue() == 22);
        Assert.assertTrue("HitPointTypes.SLIP_C.getValue() == 23", LayoutEditor.HitPointType.SLIP_C.getValue() == 23);
        Assert.assertTrue("HitPointTypes.SLIP_D.getValue() == 24", LayoutEditor.HitPointType.SLIP_D.getValue() == 24);
        Assert.assertTrue("HitPointTypes.SLIP_LEFT.getValue() == 25", LayoutEditor.HitPointType.SLIP_LEFT.getValue() == 25);
        Assert.assertTrue("HitPointTypes.SLIP_RIGHT.getValue() == 26", LayoutEditor.HitPointType.SLIP_RIGHT.getValue() == 26);
        Assert.assertTrue("HitPointTypes.UNUSED_27.getValue() == 27", LayoutEditor.HitPointType.UNUSED_27.getValue() == 27);
        Assert.assertTrue("HitPointTypes.UNUSED_28.getValue() == 28", LayoutEditor.HitPointType.UNUSED_28.getValue() == 28);
        Assert.assertTrue("HitPointTypes.UNUSED_29.getValue() == 29", LayoutEditor.HitPointType.UNUSED_29.getValue() == 29);
        Assert.assertTrue("HitPointTypes.BEZIER_CONTROL_POINT_0.getValue() == 30", LayoutEditor.HitPointType.BEZIER_CONTROL_POINT_0.getValue() == 30);
        Assert.assertTrue("HitPointTypes.BEZIER_CONTROL_POINT_1.getValue() == 31", LayoutEditor.HitPointType.BEZIER_CONTROL_POINT_1.getValue() == 31);
        Assert.assertTrue("HitPointTypes.BEZIER_CONTROL_POINT_2.getValue() == 32", LayoutEditor.HitPointType.BEZIER_CONTROL_POINT_2.getValue() == 32);
        Assert.assertTrue("HitPointTypes.BEZIER_CONTROL_POINT_3.getValue() == 33", LayoutEditor.HitPointType.BEZIER_CONTROL_POINT_3.getValue() == 33);
        Assert.assertTrue("HitPointTypes.BEZIER_CONTROL_POINT_4.getValue() == 34", LayoutEditor.HitPointType.BEZIER_CONTROL_POINT_4.getValue() == 34);
        Assert.assertTrue("HitPointTypes.BEZIER_CONTROL_POINT_5.getValue() == 35", LayoutEditor.HitPointType.BEZIER_CONTROL_POINT_5.getValue() == 35);
        Assert.assertTrue("HitPointTypes.BEZIER_CONTROL_POINT_6.getValue() == 36", LayoutEditor.HitPointType.BEZIER_CONTROL_POINT_6.getValue() == 36);
        Assert.assertTrue("HitPointTypes.BEZIER_CONTROL_POINT_7.getValue() == 37", LayoutEditor.HitPointType.BEZIER_CONTROL_POINT_7.getValue() == 37);
        Assert.assertTrue("HitPointTypes.BEZIER_CONTROL_POINT_8.getValue() == 38", LayoutEditor.HitPointType.BEZIER_CONTROL_POINT_8.getValue() == 38);
        Assert.assertTrue("HitPointTypes.SHAPE_CENTER.getValue() == 39", LayoutEditor.HitPointType.SHAPE_CENTER.getValue() == 39);
        Assert.assertTrue("HitPointTypes.SHAPE_POINT_0.getValue() == 40", LayoutEditor.HitPointType.SHAPE_POINT_0.getValue() == 40);
        Assert.assertTrue("HitPointTypes.SHAPE_POINT_1.getValue() == 41", LayoutEditor.HitPointType.SHAPE_POINT_1.getValue() == 41);
        Assert.assertTrue("HitPointTypes.SHAPE_POINT_2.getValue() == 42", LayoutEditor.HitPointType.SHAPE_POINT_2.getValue() == 42);
        Assert.assertTrue("HitPointTypes.SHAPE_POINT_3.getValue() == 43", LayoutEditor.HitPointType.SHAPE_POINT_3.getValue() == 43);
        Assert.assertTrue("HitPointTypes.SHAPE_POINT_4.getValue() == 44", LayoutEditor.HitPointType.SHAPE_POINT_4.getValue() == 44);
        Assert.assertTrue("HitPointTypes.SHAPE_POINT_5.getValue() == 45", LayoutEditor.HitPointType.SHAPE_POINT_5.getValue() == 45);
        Assert.assertTrue("HitPointTypes.SHAPE_POINT_6.getValue() == 46", LayoutEditor.HitPointType.SHAPE_POINT_6.getValue() == 46);
        Assert.assertTrue("HitPointTypes.SHAPE_POINT_7.getValue() == 47", LayoutEditor.HitPointType.SHAPE_POINT_7.getValue() == 47);
        Assert.assertTrue("HitPointTypes.SHAPE_POINT_8.getValue() == 48", LayoutEditor.HitPointType.SHAPE_POINT_8.getValue() == 48);
        Assert.assertTrue("HitPointTypes.SHAPE_POINT_9.getValue() == 49", LayoutEditor.HitPointType.SHAPE_POINT_9.getValue() == 49);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_0.getValue() == 50", LayoutEditor.HitPointType.TURNTABLE_RAY_0.getValue() == 50);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_1.getValue() == 51", LayoutEditor.HitPointType.TURNTABLE_RAY_1.getValue() == 51);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_2.getValue() == 52", LayoutEditor.HitPointType.TURNTABLE_RAY_2.getValue() == 52);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_3.getValue() == 53", LayoutEditor.HitPointType.TURNTABLE_RAY_3.getValue() == 53);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_4.getValue() == 54", LayoutEditor.HitPointType.TURNTABLE_RAY_4.getValue() == 54);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_5.getValue() == 55", LayoutEditor.HitPointType.TURNTABLE_RAY_5.getValue() == 55);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_6.getValue() == 56", LayoutEditor.HitPointType.TURNTABLE_RAY_5.getValue() == 56);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_7.getValue() == 57", LayoutEditor.HitPointType.TURNTABLE_RAY_7.getValue() == 57);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_8.getValue() == 58", LayoutEditor.HitPointType.TURNTABLE_RAY_8.getValue() == 58);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_9.getValue() == 59", LayoutEditor.HitPointType.TURNTABLE_RAY_9.getValue() == 59);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_10.getValue() == 60", LayoutEditor.HitPointType.TURNTABLE_RAY_10.getValue() == 60);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_11.getValue() == 61", LayoutEditor.HitPointType.TURNTABLE_RAY_11.getValue() == 61);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_12.getValue() == 62", LayoutEditor.HitPointType.TURNTABLE_RAY_12.getValue() == 62);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_13.getValue() == 63", LayoutEditor.HitPointType.TURNTABLE_RAY_13.getValue() == 63);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_14.getValue() == 64", LayoutEditor.HitPointType.TURNTABLE_RAY_14.getValue() == 64);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_15.getValue() == 65", LayoutEditor.HitPointType.TURNTABLE_RAY_15.getValue() == 65);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_16.getValue() == 66", LayoutEditor.HitPointType.TURNTABLE_RAY_15.getValue() == 66);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_17.getValue() == 67", LayoutEditor.HitPointType.TURNTABLE_RAY_17.getValue() == 67);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_18.getValue() == 68", LayoutEditor.HitPointType.TURNTABLE_RAY_18.getValue() == 68);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_19.getValue() == 69", LayoutEditor.HitPointType.TURNTABLE_RAY_19.getValue() == 69);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_20.getValue() == 70", LayoutEditor.HitPointType.TURNTABLE_RAY_20.getValue() == 70);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_21.getValue() == 71", LayoutEditor.HitPointType.TURNTABLE_RAY_21.getValue() == 71);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_22.getValue() == 72", LayoutEditor.HitPointType.TURNTABLE_RAY_22.getValue() == 72);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_23.getValue() == 73", LayoutEditor.HitPointType.TURNTABLE_RAY_23.getValue() == 73);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_24.getValue() == 74", LayoutEditor.HitPointType.TURNTABLE_RAY_24.getValue() == 74);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_25.getValue() == 75", LayoutEditor.HitPointType.TURNTABLE_RAY_25.getValue() == 75);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_26.getValue() == 76", LayoutEditor.HitPointType.TURNTABLE_RAY_25.getValue() == 76);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_27.getValue() == 77", LayoutEditor.HitPointType.TURNTABLE_RAY_27.getValue() == 77);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_28.getValue() == 78", LayoutEditor.HitPointType.TURNTABLE_RAY_28.getValue() == 78);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_29.getValue() == 79", LayoutEditor.HitPointType.TURNTABLE_RAY_29.getValue() == 79);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_30.getValue() == 80", LayoutEditor.HitPointType.TURNTABLE_RAY_30.getValue() == 80);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_31.getValue() == 81", LayoutEditor.HitPointType.TURNTABLE_RAY_31.getValue() == 81);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_32.getValue() == 82", LayoutEditor.HitPointType.TURNTABLE_RAY_32.getValue() == 82);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_33.getValue() == 83", LayoutEditor.HitPointType.TURNTABLE_RAY_33.getValue() == 83);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_34.getValue() == 84", LayoutEditor.HitPointType.TURNTABLE_RAY_34.getValue() == 84);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_35.getValue() == 85", LayoutEditor.HitPointType.TURNTABLE_RAY_35.getValue() == 85);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_36.getValue() == 86", LayoutEditor.HitPointType.TURNTABLE_RAY_36.getValue() == 86);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_37.getValue() == 87", LayoutEditor.HitPointType.TURNTABLE_RAY_37.getValue() == 87);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_38.getValue() == 88", LayoutEditor.HitPointType.TURNTABLE_RAY_38.getValue() == 88);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_39.getValue() == 89", LayoutEditor.HitPointType.TURNTABLE_RAY_39.getValue() == 89);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_40.getValue() == 90", LayoutEditor.HitPointType.TURNTABLE_RAY_40.getValue() == 90);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_41.getValue() == 91", LayoutEditor.HitPointType.TURNTABLE_RAY_41.getValue() == 91);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_42.getValue() == 92", LayoutEditor.HitPointType.TURNTABLE_RAY_42.getValue() == 92);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_43.getValue() == 93", LayoutEditor.HitPointType.TURNTABLE_RAY_43.getValue() == 93);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_44.getValue() == 94", LayoutEditor.HitPointType.TURNTABLE_RAY_44.getValue() == 94);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_45.getValue() == 95", LayoutEditor.HitPointType.TURNTABLE_RAY_45.getValue() == 95);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_46.getValue() == 96", LayoutEditor.HitPointType.TURNTABLE_RAY_45.getValue() == 96);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_47.getValue() == 97", LayoutEditor.HitPointType.TURNTABLE_RAY_47.getValue() == 97);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_48.getValue() == 98", LayoutEditor.HitPointType.TURNTABLE_RAY_48.getValue() == 98);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_49.getValue() == 99", LayoutEditor.HitPointType.TURNTABLE_RAY_49.getValue() == 99);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_50.getValue() == 100", LayoutEditor.HitPointType.TURNTABLE_RAY_50.getValue() == 100);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_51.getValue() == 101", LayoutEditor.HitPointType.TURNTABLE_RAY_51.getValue() == 101);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_52.getValue() == 102", LayoutEditor.HitPointType.TURNTABLE_RAY_52.getValue() == 102);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_53.getValue() == 103", LayoutEditor.HitPointType.TURNTABLE_RAY_53.getValue() == 103);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_54.getValue() == 104", LayoutEditor.HitPointType.TURNTABLE_RAY_54.getValue() == 104);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_55.getValue() == 105", LayoutEditor.HitPointType.TURNTABLE_RAY_55.getValue() == 105);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_56.getValue() == 106", LayoutEditor.HitPointType.TURNTABLE_RAY_55.getValue() == 106);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_57.getValue() == 107", LayoutEditor.HitPointType.TURNTABLE_RAY_57.getValue() == 107);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_58.getValue() == 108", LayoutEditor.HitPointType.TURNTABLE_RAY_58.getValue() == 108);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_59.getValue() == 109", LayoutEditor.HitPointType.TURNTABLE_RAY_59.getValue() == 109);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_60.getValue() == 110", LayoutEditor.HitPointType.TURNTABLE_RAY_60.getValue() == 110);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_61.getValue() == 111", LayoutEditor.HitPointType.TURNTABLE_RAY_61.getValue() == 111);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_62.getValue() == 112", LayoutEditor.HitPointType.TURNTABLE_RAY_62.getValue() == 112);
        Assert.assertTrue("HitPointTypes.TURNTABLE_RAY_63.getValue() == 113", LayoutEditor.HitPointType.TURNTABLE_RAY_63.getValue() == 113);
    }
