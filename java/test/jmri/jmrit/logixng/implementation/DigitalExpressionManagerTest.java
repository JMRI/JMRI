...
public class DigitalExpressionManagerTest extends AbstractManagerTestBase {
    ...
    public void testRegisterExpression() {
        ...
        assertEquals( "registerExpression() cannot register a MaleDigitalExpressionSocket. Use the method register() instead.",
    ...
    public void testGetBeanTypeHandled() {
        assertEquals( "Digital expression", _m.getBeanTypeHandled(), "getBeanTypeHandled() returns correct value");
        assertEquals( "Digital expression", _m.getBeanTypeHandled(false), "getBeanTypeHandled() returns correct value");
        assertEquals( "Digital expressions", _m.getBeanTypeHandled(true), "getBeanTypeHandled() returns correct value");
    }

    @Test
    public void testInstance() {
        assertNotNull( DefaultDigitalExpressionManager.instance(), "instance() is not null");
