...
public class DigitalBooleanActionManagerTest extends AbstractManagerTestBase {
    ...
    public void testRegisterAction() {
        ...
        assertEquals( "registerAction() cannot register a MaleDigitalBooleanActionSocket. Use the method register() instead.",
                e.getMessage(), "Error message is correct");
    }

    @Test
    public void testGetBeanTypeHandled() {
        assertEquals( "Digital boolean action", _m.getBeanTypeHandled(), "getBeanTypeHandled() returns correct value");
        assertEquals( "Digital boolean action", _m.getBeanTypeHandled(false), "getBeanTypeHandled() returns correct value");
        assertEquals( "Digital boolean actions", _m.getBeanTypeHandled(true), "getBeanTypeHandled() returns correct value");
    }

    @Test
    public void testInstance() {
        assertNotNull( DefaultDigitalBooleanActionManager.instance(), "instance() is not null");
