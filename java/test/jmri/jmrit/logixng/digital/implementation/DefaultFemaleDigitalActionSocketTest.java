...
public class DefaultFemaleDigitalActionSocketTest extends FemaleSocketTestBase {
    ...
    public void testGetConnectableClasses() {
        ...
        classes.add(jmri.jmrit.logixng.digital.actions.ModuleDigitalAction.class);
        classes.add(jmri.jmrit.logixng.digital.actions.PopStack.class);
        classes.add(jmri.jmrit.logixng.digital.actions.PushStack.class);
