...
public abstract class AbstractDigitalBooleanActionTestBase extends AbstractBaseTestBase {
    ...
    public void testBundle() {
        Assert.assertEquals("strings are equal", "On change", Bundle.getMessage("OnChange_Short"));
//        Assert.assertEquals("strings are equal", "Set memory IM1 to null", Bundle.getMessage("OnChange_Long_Change", "IM1"));
        Assert.assertEquals("strings are equal", "On change", Bundle.getMessage(Locale.CANADA, "OnChange_Short"));
//        Assert.assertEquals("strings are equal", "Set memory IM1 to null", Bundle.getMessage(Locale.CANADA, "OnChange_Long_Change", "IM1"));
