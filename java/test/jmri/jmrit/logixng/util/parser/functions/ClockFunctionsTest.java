...
public class ClockFunctionsTest {
    ...
    public void testSystemClockFunction() throws Exception {
        ...
        Assert.assertTrue(compare(minSinceMidnight, (Integer)systemClockFunction.calculate(getParameterList()), 1));
        Assert.assertTrue(compare(currentTime.getHours(), (Integer)systemClockFunction.calculate(getParameterList(expr_str_HOUR)), 1));
        Assert.assertTrue(compare(currentTime.getMinutes(), (Integer)systemClockFunction.calculate(getParameterList(expr_str_MIN)), 1));
        Assert.assertTrue(compare(currentTime.getSeconds(), (Integer)systemClockFunction.calculate(getParameterList(expr_str_SEC)), 1));
        Assert.assertTrue(compare(minSinceMidnight, (Integer)systemClockFunction.calculate(getParameterList(expr_str_MIN_OF_DAY)), 1));
        Assert.assertTrue(compare(secSinceMidnight, (Integer)systemClockFunction.calculate(getParameterList(expr_str_SEC_OF_DAY)), 20));
    }
    ...
    public void testFastClockFunction() throws Exception {
        ...
        Assert.assertEquals(minSinceMidnight, (int)fastClockFunction.calculate(getParameterList()));
        Assert.assertEquals(11, (int)fastClockFunction.calculate(getParameterList(expr_str_HOUR)));
        Assert.assertEquals(5, (int)fastClockFunction.calculate(getParameterList(expr_str_MIN)));
        Assert.assertEquals(minSinceMidnight, (int)fastClockFunction.calculate(getParameterList(expr_str_MIN_OF_DAY)));
    }
