...
public class TestTrafficController extends TrafficController {
    ...
    // dummies
    public jmri.jmrix.AbstractMRMessage encodeForHardware(CanMessage m) { return null; }
    public CanReply decodeFromHardware(jmri.jmrix.AbstractMRReply r){ return null; }
