...
public class Sprog3PlusSerialDriverAdapterTest {
    ...
    private Sprog3PlusSerialDriverAdapter t;
    ...
    public void testCTor() throws PortInUseException {
        ...
        try (MockedStatic<CommPortIdentifier> mb = Mockito.mockStatic(CommPortIdentifier.class)) {
            ...
            t = new Sprog3PlusSerialDriverAdapter();
            Assert.assertNotNull("exists",t);

            t.openPort("my port", "JMRI app");
            t.configure();
            Assert.assertEquals(t.getSystemConnectionMemo().getSubProtocol(), ConfigurationManager.SubProtocol.NONE);
            Assert.assertEquals(t.getSystemConnectionMemo().getProgModeSwitch(), ConfigurationManager.ProgModeSwitch.SPROG3PLUS);
        }
