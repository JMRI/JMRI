...
public class CbusReporterManagerTest extends jmri.managers.AbstractReporterMgrTestBase {
    ...
    public void testvalidSystemNameFormat() {
        ...
        Assert.assertEquals("MR0",NameValidity.INVALID,l.validSystemNameFormat("MR0"));
    ...
    public void setUp() {
        ...
        jmri.InstanceManager.setDefault(jmri.ReporterManager.class,l);
    ...
    // private final static Logger log = LoggerFactory.getLogger(CbusReporterManagerTest.class);
}
