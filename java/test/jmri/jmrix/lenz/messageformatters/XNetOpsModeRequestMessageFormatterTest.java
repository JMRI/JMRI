...
public class XNetOpsModeRequestMessageFormatterTest extends AbstractMessageFormatterTest {
    ...
    @Test
    public void testFormatOpsModeRequestHighCVMessage() {
        XNetMessage msg = XNetMessage.getWriteOpsModeCVMsg(0,5,512,5);
        Assertions.assertTrue(formatter.handlesMessage(msg), "Formatter Handles Message");
        Assertions.assertEquals("Operations Mode Programming Request: Byte Mode Write: 5 to CV 512 for Decoder Address 5", formatter.formatMessage(msg), "Monitor String");
    }
    ...
    @Test
    public void testFormatOpsModeVerifyHighCVMessage() {
        XNetMessage  msg = XNetMessage.getVerifyOpsModeCVMsg(0,5,512,5);
        Assertions.assertTrue(formatter.handlesMessage(msg), "Formatter Handles Message");
        Assertions.assertEquals("Operations Mode Programming Request: Byte Mode Verify: 5 to CV 512 for Decoder Address 5",formatter.formatMessage(msg));
    }
    ...
    @Test
    public void testFormatWriteOpsBitModeHighCVMessage(){
        XNetMessage  msg = XNetMessage.getBitWriteOpsModeCVMsg(0,5,512,2,true);
        Assertions.assertTrue(formatter.handlesMessage(msg), "Formatter Handles Message");
        Assertions.assertEquals("Operations Mode Programming Request: Bit Mode Write: 1 to CV 512 bit 2 for Decoder Address 5",formatter.formatMessage(msg));
        msg = XNetMessage.getBitWriteOpsModeCVMsg(0,5,512,2,false);
        Assertions.assertTrue(formatter.handlesMessage(msg), "Formatter Handles Message");
        Assertions.assertEquals("Operations Mode Programming Request: Bit Mode Write: 0 to CV 512 bit 2 for Decoder Address 5",formatter.formatMessage(msg));
    }
    ...
    @Test
    public void testToMonitorStringVerifyOpsBitModeHighCVMsg(){
        XNetMessage  msg = XNetMessage.getBitVerifyOpsModeCVMsg(0,5,512,2,true);
        Assertions.assertTrue(formatter.handlesMessage(msg), "Formatter Handles Message");
        Assertions.assertEquals("Operations Mode Programming Request: Bit Mode Verify: 1 to CV 512 bit 2 for Decoder Address 5",formatter.formatMessage(msg));
        msg = XNetMessage.getBitVerifyOpsModeCVMsg(0,5,512,2,false);
        Assertions.assertTrue(formatter.handlesMessage(msg), "Formatter Handles Message");
        Assertions.assertEquals("Operations Mode Programming Request: Bit Mode Verify: 0 to CV 512 bit 2 for Decoder Address 5",formatter.formatMessage(msg));
    }
