 ...
 */
public class JMRIClientTest extends TestCase {

    // from here down is testing infrastructure

    public JMRIClientTest(String s) {
        super(s);
    }

    // Main entry point
    static public void main(String[] args) {
        String[] testCaseName = {JMRIClientTest.class.getName()};
    ...
    static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(JMRIClientTest.class.getName());
