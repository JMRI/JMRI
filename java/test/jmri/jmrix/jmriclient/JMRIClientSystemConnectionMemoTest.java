 ...
 *
 * Description:	    tests for the jmri.jmrix.jmriclient.JMRIClientSystemConnectionMemo class
 * @author			Bob Jacobsen
...
public class JMRIClientSystemConnectionMemoTest extends TestCase {
    ...
    static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(JMRIClientSystemConnectionMemoTest.class.getName());
