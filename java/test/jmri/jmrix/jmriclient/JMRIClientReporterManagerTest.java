 ...
 *
 * Description:	    tests for the jmri.jmrix.jmriclient.JMRIClientReporterManager class
 * @author			Bob Jacobsen
...
public class JMRIClientReporterManagerTest extends TestCase {
    ...
    static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(JMRIClientReporterManagerTest.class.getName());
