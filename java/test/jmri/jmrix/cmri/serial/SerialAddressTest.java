...
public class SerialAddressTest extends TestCase {
    ...
    public void testGetNodeFromSystemName() {
        ...
        Assert.assertEquals("node of CL14007", d, SerialTrafficController.getNodeFromSystemName("CL14007",stcs));
        Assert.assertEquals("node of CL14B7", d, SerialTrafficController.getNodeFromSystemName("CL14B7",stcs));
        Assert.assertEquals("node of CL127007", b, SerialTrafficController.getNodeFromSystemName("CL127007",stcs));
        Assert.assertEquals("node of CL127B7", b, SerialTrafficController.getNodeFromSystemName("CL127B7",stcs));
        Assert.assertEquals("node of CL17007", c, SerialTrafficController.getNodeFromSystemName("CL17007",stcs));
        Assert.assertEquals("node of CL17B7", c, SerialTrafficController.getNodeFromSystemName("CL17B7",stcs));
        Assert.assertEquals("node of CL11007", null, SerialTrafficController.getNodeFromSystemName("CL11007",stcs));
        Assert.assertEquals("node of CL11B7", null, SerialTrafficController.getNodeFromSystemName("CL11B7",stcs));
    }
    ...
    public void testValidSystemNameConfig() {
        ...
        Assert.assertTrue("valid config CL4007", SerialTrafficController.validSystemNameConfig("CL4007", 'L',stcs));
        Assert.assertTrue("valid config CL4B7", SerialTrafficController.validSystemNameConfig("CL4B7", 'L',stcs));
        Assert.assertTrue("valid config CS10007", SerialTrafficController.validSystemNameConfig("CS10007", 'S',stcs));
        Assert.assertTrue("valid config CS10B7", SerialTrafficController.validSystemNameConfig("CS10B7", 'S',stcs));
        Assert.assertTrue("valid config CL10048", SerialTrafficController.validSystemNameConfig("CL10048", 'L',stcs));
        Assert.assertTrue("valid config CL10B48", SerialTrafficController.validSystemNameConfig("CL10B48", 'L',stcs));
        Assert.assertTrue("invalid config CL10049", !SerialTrafficController.validSystemNameConfig("CL10049", 'L',stcs));
        Assert.assertTrue("invalid config CL10B49", !SerialTrafficController.validSystemNameConfig("CL10B49", 'L',stcs));
        Assert.assertTrue("valid config CS10024", SerialTrafficController.validSystemNameConfig("CS10024", 'S',stcs));
        Assert.assertTrue("valid config CS10B24", SerialTrafficController.validSystemNameConfig("CS10B24", 'S',stcs));
        Assert.assertTrue("invalid config CS10025", !SerialTrafficController.validSystemNameConfig("CS10025", 'S',stcs));
        Assert.assertTrue("invalid config CS10B25", !SerialTrafficController.validSystemNameConfig("CS10B25", 'S',stcs));
        Assert.assertTrue("valid config CT4128", SerialTrafficController.validSystemNameConfig("CT4128", 'T',stcs));
        Assert.assertTrue("valid config CT4B128", SerialTrafficController.validSystemNameConfig("CT4B128", 'T',stcs));
        Assert.assertTrue("invalid config CT4129", !SerialTrafficController.validSystemNameConfig("CT4129", 'T',stcs));
        Assert.assertTrue("invalid config CT4129", !SerialTrafficController.validSystemNameConfig("CT4B129", 'T',stcs));
        Assert.assertTrue("valid config CS4064", SerialTrafficController.validSystemNameConfig("CS4064", 'S',stcs));
        Assert.assertTrue("valid config CS4B64", SerialTrafficController.validSystemNameConfig("CS4B64", 'S',stcs));
        Assert.assertTrue("invalid config CS4065", !SerialTrafficController.validSystemNameConfig("CS4065", 'S',stcs));
        Assert.assertTrue("invalid config CS4B65", !SerialTrafficController.validSystemNameConfig("CS4B65", 'S',stcs));
        Assert.assertTrue("invalid config CL11007", !SerialTrafficController.validSystemNameConfig("CL11007", 'L',stcs));
        Assert.assertTrue("invalid config CL11B7", !SerialTrafficController.validSystemNameConfig("CL11B7", 'L',stcs));
    }
