...
public class LnCabSignalTest {
    ...
    public void testCTor() {
        LnCabSignal cs = new LnCabSignal(memo,new DccLocoAddress(1234,true));
    ...
    @Test
    public void testSignalSequenceTranspondingTag() throws jmri.JmriException {
        Assume.assumeFalse(GraphicsEnvironment.isHeadless());
        // load and display test panel file
        InstanceManager.getDefault(jmri.jmrit.display.layoutEditor.LayoutBlockManager.class).setStabilisedSensor("IS_ROUTING_DONE");
        ...
        Block b1 = bm.provideBlock("MainlineBlock");
        // set the block contents to a transponding tag for our address.
        b1.setValue(new TranspondingTag("LD1234"));
    ...
    private void checkBlock(LnCabSignal cs,String currentBlock,String nextBlock,String mastName){
        BlockManager bm = InstanceManager.getDefault(jmri.BlockManager.class);
