...
public class LlnmonTest extends TestCase {
    ...
    public void testSVProgrammingProtocolV2() {
        ...
        l = new LocoNetMessage(new int[]{0xE5, 0x10, 0x01, 0x02, 0x02, 0x10, 0x23, 0x00, 0x03, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00});
        assertEquals(" read SV 3", "SV Programming Protocol v2: Peer to Peer transfer: SRC=0x1, DSTL=0x2, DSTH=0x2, PXCT1=0x10, PXCT2=0x10\n	Data [0x23 0x0 0x3 0x0,0x0 0x0 0x0 0x0]\n", f.displayMessage(l));
