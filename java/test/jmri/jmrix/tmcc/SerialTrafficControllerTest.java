...
public class SerialTrafficControllerTest extends jmri.jmrix.AbstractMRTrafficControllerTest {
    ...
    public void testSendOK() throws Exception {
        tc = new SerialTrafficController(scm) {
        ...
        m.setElement(1, 0x21);
        m.setElement(2, 0x44);
        tc.sendSerialMessage(m, new SerialListenerScaffold());
    ...
    TmccSystemConnectionMemo scm;
    
    @After
    @Override
    public void tearDown() {
        if (tc != null) tc.terminateThreads();
