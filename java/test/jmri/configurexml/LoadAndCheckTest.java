...
/**
 * Functional checks of loading basic configuration files.
 * When done across various versions of schema,
 * this checks ability to read older files in newer versions; completeness
 * of reading code; etc.
 * <p>
 * More specific checks can be done in separate test files for 
 * specific types.
 * 
...
public class LoadAndCheckTest extends LoadAndStoreTestBase {
    ...
    static Logger log = Logger.getLogger(LoadAndCheckTest.class.getName());
}
