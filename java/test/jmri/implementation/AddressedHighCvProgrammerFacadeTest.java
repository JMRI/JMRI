...
public class AddressedHighCvProgrammerFacadeTest extends TestCase {
    ...
    public void testWriteReadDirect() throws jmri.ProgrammerException, InterruptedException {
        ...
        Programmer p = new AddressedHighCvProgrammerFacade(dp, 256, 255, 1024);
    ...
    public void testCvLimit() {
        Programmer p = new AddressedHighCvProgrammerFacade(new jmri.progdebugger.ProgDebugger(), 256, 255, 1024);
