...
public class DefaultAverageMeterTest {
    ...
    public void testState() {
        ...
        Assert.assertEquals(COUNT, expectedValues.length);
        ...
        for (int i=0; i < COUNT; i++) {
            JUnitUtil.waitFor(m::isRead);
            Assert.assertEquals(String.format("Meter has correct value for value %d", i), expectedValues[i], am.getKnownAnalogValue(), 0.00001);
        }
    }
    ...
    private class MyMeter extends DefaultMeter {
