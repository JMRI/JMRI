...
public class JsonPowerHttpServiceTest extends JsonHttpServiceTestBase {
    ...
    public void testDoGet() throws JmriException {
        ...
        try {
            ...
            result = service.doGet(JsonPowerServiceFactory.POWER, "", mapper.createObjectNode(), locale, 42);
    ...
    public void testDoPut() {
        try {
            (new JsonPowerHttpService(mapper)).doPut(JsonPowerServiceFactory.POWER, "", mapper.createObjectNode(), locale, 42);
        } catch (JsonException ex) {
    ...
    public void testDelete() {
        try {
            (new JsonPowerHttpService(mapper)).doDelete(JsonPowerServiceFactory.POWER, "", NullNode.getInstance(), locale, 42);
        } catch (JsonException ex) {
            Assert.assertEquals(HttpServletResponse.SC_METHOD_NOT_ALLOWED, ex.getCode());
            return;
        }
