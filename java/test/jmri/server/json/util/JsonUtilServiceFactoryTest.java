...
public class JsonUtilServiceFactoryTest extends JsonServiceFactoryTestBase<JsonUtilHttpService, JsonUtilSocketService> {
    ...
    public void testGetTypesV5() {
        assertThat(factory.getTypes(JSON.V5)).containsExactly(JSON.GOODBYE, JSON.HELLO, JSON.METADATA, JSON.NETWORK_SERVICE, JSON.NETWORK_SERVICES, JSON.NODE, JSON.PANEL, JSON.PANELS, JSON.RAILROAD, JSON.SYSTEM_CONNECTION, JSON.SYSTEM_CONNECTIONS, JSON.CONFIG_PROFILE, JSON.CONFIG_PROFILES, JSON.SESSION_LOGIN, JSON.SESSION_LOGOUT, JSON.VERSION);
    }
