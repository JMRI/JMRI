#! /bin/csh -f
#
# Short csh script to setup and run a JUnit test ($Revision: 1.15 $)
#
...
java -noverify \
    ...
    -cp .:java/classes:jmriplugins.jar:lib/jmriplugins.jar:jmri.jar:lib/MRJAdapter.jar:lib/RXTXcomm.jar:lib/Serialio.jar:lib/ch.ntb.usb.jar:lib/comm-rxtx.jar:lib/comm.jar:lib/xercesImpl.jar:lib/gluegen-rt.jar:lib/javacsv.jar:lib/jdom.jar:lib/jhall.jar:lib/jinput.jar:lib/joal.jar:lib/jython.jar:lib/log4j.jar:lib/servlet.jar:lib/vecmath.jar:lib/activation.jar:lib/mailapi.jar:lib/smtp.jar:lib/ExternalLinkContentViewerUI.jar:java/lib/junit.jar:java/lib/jfcunit.jar:java/lib/jakarta-regexp-1.5.jar:/System/Library/Java \
    $1 $2 $3
