...
public String displayMessage(LocoNetMessage l) {
    ...
    boolean forceHex = false;     /* force hex display line             */
	...
	**********************************************************************************************/
		...
		***********************************************************************************/
        case LnConstants.OPC_PEER_XFER:             /* page 10 of Loconet PE */
			...
			int src 	= l.getElement(3);            	// source of transfer      
			int dst_l 	= l.getElement(4);          	// ls 7 bits of destination 
			int dst_h 	= l.getElement(5);          	// ms 7 bits of destination
			int pxct1 	= l.getElement(6); 
			int d1 		= l.getElement(7);              // data byte 1 
			int d2		= l.getElement(8);              // data byte 2 
			int d3		= l.getElement(9);             	// data byte 3
			int d4		= l.getElement(10);             // data byte 4
			int pxct2	= l.getElement(11); 
			int d5		= l.getElement(12);             // data byte 5
			int d6		= l.getElement(13);             // data byte 6
			int d7		= l.getElement(14);             // data byte 7 
			int d8		= l.getElement(15);             // data byte 8 
            ...
            return "Peer to Peer transfer: SRC=0x"+Integer.toHexString(src)
                    ...
                    +"\tD1=0x"+Integer.toHexString(d1)
                    +", D2=0x"+Integer.toHexString(d2)
                    +", D3=0x"+Integer.toHexString(d3)
                    +", D4=0x"+Integer.toHexString(d4)
                    +", D5=0x"+Integer.toHexString(d5)
                    +", D6=0x"+Integer.toHexString(d6)
                    +", D7=0x"+Integer.toHexString(d7)
		...
		**************************************************************************/
        ...
        default:
            ...
            if (l.getOpCode() == 6) {
                ...
                * <reserved>                                           *
                *******************************************************/
                return "This is a six byte message and is RESERVED!\n";
            } else {
