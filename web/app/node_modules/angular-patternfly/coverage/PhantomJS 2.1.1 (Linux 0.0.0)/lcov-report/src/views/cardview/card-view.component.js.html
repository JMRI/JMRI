...
<html lang="en">
<head>
    <title>Code coverage report for src/views/cardview/card-view.component.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/views/cardview/card-view.component.js</span></h1>
    <h2>
        Statements: <span class="metric">76.92% <small>(60 / 78)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">70.49% <small>(43 / 61)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">90.91% <small>(10 / 11)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">76.92% <small>(60 / 78)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/views/cardview/</a> &#187; card-view.component.js</div>
</div>
<div class="body">
...
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (alreadySelected) {
            // already selected so deselect
<span class="cstat-no" title="statement not covered" >            ctrl.config.selectedItems = _.without(ctrl.config.selectedItems, item);</span>
          } else {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (ctrl.config.selectedItems[0] === item) {
<span class="cstat-no" title="statement not covered" >            if (!ctrl.config.dblClick) {</span>
<span class="cstat-no" title="statement not covered" >              ctrl.config.selectedItems = [];</span>
<span class="cstat-no" title="statement not covered" >              selectionChanged = true;</span>
            }
<span class="cstat-no" title="statement not covered" >            continueEvent = false;</span>
          } else {
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (selectionChanged &amp;&amp; ctrl.config.onSelect) {
<span class="cstat-no" title="statement not covered" >          ctrl.config.onSelect(item, e);</span>
        }
        <span class="missing-if-branch" title="if path not taken" >I</span>if (selectionChanged &amp;&amp; ctrl.config.onSelectionChange) {
<span class="cstat-no" title="statement not covered" >          ctrl.config.onSelectionChange(ctrl.config.selectedItems, e);</span>
        }
      }
      <span class="missing-if-branch" title="if path not taken" >I</span>if (ctrl.config.onClick) {
<span class="cstat-no" title="statement not covered" >        ctrl.config.onClick(item, e);</span>
      }
&nbsp;
      return continueEvent;
    };
&nbsp;
    ctrl.dblClick = function (e, item) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (ctrl.config.onDblClick) {
        ctrl.config.onDblClick(item, e);
      }
    };
&nbsp;
    ctrl.checkBoxChange = <span class="fstat-no" title="function not covered" >function (item) {</span>
<span class="cstat-no" title="statement not covered" >      if (ctrl.config.onCheckBoxChange) {</span>
<span class="cstat-no" title="statement not covered" >        ctrl.config.onCheckBoxChange(item);</span>
      }
    };
&nbsp;
...
&nbsp;
    function setPagination () {
      if (angular.isUndefined(ctrl.pageConfig)) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!angular.isNumber(ctrl.pageConfig.pageNumber)) {
<span class="cstat-no" title="statement not covered" >          ctrl.pageConfig.pageNumber = 1;</span>
        }
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!angular.isNumber(ctrl.pageConfig.pageSize)) {
<span class="cstat-no" title="statement not covered" >          ctrl.pageConfig.pageSize = 10;</span>
        }
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!ctrl.pageConfig.showPaginationControls) {
<span class="cstat-no" title="statement not covered" >          ctrl.pageConfig.pageSize = ctrl.pageConfig.numTotalItems;</span>
        }
      }
...
&nbsp;
    ctrl.$doCheck = function () {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!angular.equals(ctrl.items, prevItems)) {
<span class="cstat-no" title="statement not covered" >        if (ctrl.items) {</span>
<span class="cstat-no" title="statement not covered" >          ctrl.config.itemsAvailable = ctrl.items.length &gt; 0;</span>
        }
<span class="cstat-no" title="statement not covered" >        if (angular.isDefined(ctrl.pageConfig)) {</span>
<span class="cstat-no" title="statement not covered" >          ctrl.pageConfig.numTotalItems = ctrl.items.length;</span>
        }
<span class="cstat-no" title="statement not covered" >        prevItems = angular.copy(ctrl.items);</span>
      }
    };
  }
});
