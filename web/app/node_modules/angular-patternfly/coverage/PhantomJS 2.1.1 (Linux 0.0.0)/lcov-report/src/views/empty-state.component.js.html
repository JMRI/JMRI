...
<html lang="en">
<head>
    <title>Code coverage report for src/views/empty-state.component.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/views/empty-state.component.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/views/</a> &#187; empty-state.component.js</div>
</div>
<div class="body">
...
&nbsp;
    ctrl.updateConfig = function () {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (ctrl.config &amp;&amp; ctrl.config.helpLink &amp;&amp; angular.isUndefined(ctrl.config.helpLink.url)) {
        // if no url specified, set url to not redirect.  ie. just do urlAction
<span class="cstat-no" title="statement not covered" >        ctrl.config.helpLink.url = "javascript:void(0)";</span>
      }
    };
&nbsp;
...
&nbsp;
    ctrl.handleButtonAction = <span class="fstat-no" title="function not covered" >function (action) {</span>
<span class="cstat-no" title="statement not covered" >      if (action &amp;&amp; action.actionFn) {</span>
<span class="cstat-no" title="statement not covered" >        action.actionFn(action);</span>
      }
    };
  }
});
