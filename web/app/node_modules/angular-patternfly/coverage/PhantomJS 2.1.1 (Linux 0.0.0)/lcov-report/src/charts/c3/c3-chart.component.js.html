...
<html lang="en">
<head>
    <title>Code coverage report for src/charts/c3/c3-chart.component.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/charts/c3/c3-chart.component.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/charts/c3/</a> &#187; c3-chart.component.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >          chartData = ctrl.config;</span>
<span class="cstat-no" title="statement not covered" >          if (chartData) {</span>
<span class="cstat-no" title="statement not covered" >            chartData.bindto = '#' + $attrs.id;</span>
...
<span class="cstat-no" title="statement not covered" >            if (!chart || ($attrs.id.indexOf('donutPctChart') !== -1 &amp;&amp; chartData.thresholds)) {</span>
<span class="cstat-no" title="statement not covered" >              chart = c3.generate(chartData);</span>
            } else {
              //if chart is already created, then we only need to re-load data
<span class="cstat-no" title="statement not covered" >              chart.load(ctrl.config.data);</span>
            }
<span class="cstat-no" title="statement not covered" >            if (ctrl.getChartCallback) {</span>
<span class="cstat-no" title="statement not covered" >              ctrl.getChartCallback(chart);</span>
            }
<span class="cstat-no" title="statement not covered" >            prevConfig = angular.copy(ctrl.config);</span>
          }
        });
      };
&nbsp;
