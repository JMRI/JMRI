...
<html lang="en">
<head>
    <title>Code coverage report for src/autofocus/autofocus.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/autofocus/autofocus.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/autofocus/</a> &#187; autofocus.js</div>
</div>
<div class="body">
    ...
    link: function (scope, element, attrs) {
      scope.$watch(attrs.pfFocused, function (newValue) {
        $timeout(function () {
          if (newValue) {
            element[0].focus();
            <span class="missing-if-branch" title="else path not taken" >E</span>if (element[0].select) {
              element[0].select();
            }
          }
        });
