...
<html lang="en">
<head>
    <title>Code coverage report for src/notification/notification.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/notification/notification.js</span></h1>
    <h2>
        Statements: <span class="metric">85.71% <small>(54 / 63)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">41.67% <small>(10 / 24)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">75% <small>(12 / 16)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">85.71% <small>(54 / 63)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/notification/</a> &#187; notification.js</div>
</div>
<div class="body">
...
&nbsp;
  this.setDelay = <span class="fstat-no" title="function not covered" >function (delay) {</span>
<span class="cstat-no" title="statement not covered" >    this.delay = delay;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  this.setVerbose = <span class="fstat-no" title="function not covered" >function (verbose) {</span>
<span class="cstat-no" title="statement not covered" >    this.verbose = verbose;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  this.setPersist = <span class="fstat-no" title="function not covered" >function (persist) {</span>
<span class="cstat-no" title="statement not covered" >    this.persist = persist;</span>
  };
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!notifications) {
<span class="cstat-no" title="statement not covered" >      notifications.data = [];</span>
    }
&nbsp;
...
&nbsp;
      if (!notification.isPersistent) {
        ...
        $timeout(function () {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (!notification.viewing) {
...
&nbsp;
    function createNotifyMethod (mode) {
      return function (message, header, persistent, closeCallback, actionTitle, actionCallback, menuActions) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (angular.isUndefined(header)) {
          header = modes[mode].header;
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (angular.isUndefined(persistent)) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (verbose) {
...
&nbsp;
    notifications.httpError = function (message, httpResponse) {
      message += ' (' + (httpResponse.data.message || <span class="branch-1 cbranch-no" title="branch not covered" >httpResponse.data.cause </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >httpResponse.data.cause </span>|| <span class="branch-3 cbranch-no" title="branch not covered" >httpResponse.data.errorMessage)</span> + ')';
...
&nbsp;
    notifications.setViewing = <span class="fstat-no" title="function not covered" >function (notification, viewing) {</span>
<span class="cstat-no" title="statement not covered" >      notification.viewing = viewing;</span>
<span class="cstat-no" title="statement not covered" >      if (!viewing &amp;&amp; !notification.show) {</span>
<span class="cstat-no" title="statement not covered" >        notifications.remove(notification);</span>
      }
    };
&nbsp;
