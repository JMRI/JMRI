...
<html lang="en">
<head>
    <title>Code coverage report for src/datepicker/bootstrap-datepicker.component.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/datepicker/bootstrap-datepicker.component.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/datepicker/</a> &#187; bootstrap-datepicker.component.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">angular.module('patternfly.datepicker').component('pfBootstrapDatepicker', {
  bindings: {
    date: '&lt;',
    format: '@?',
    dateOptions: '&lt;?',
...
&nbsp;
    ctrl.$doCheck = function () {
      ...
      if (!angular.equals(ctrl.date, prevDate)) {
        prevDate = angular.copy(ctrl.date);
        <span class="missing-if-branch" title="else path not taken" >E</span>if (ctrl.onDateChange) {
