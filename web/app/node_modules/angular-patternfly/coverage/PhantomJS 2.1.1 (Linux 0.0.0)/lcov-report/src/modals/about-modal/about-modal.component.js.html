...
<html lang="en">
<head>
    <title>Code coverage report for src/modals/about-modal/about-modal.component.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/modals/about-modal/about-modal.component.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/modals/about-modal/</a> &#187; about-modal.component.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">angular.module('patternfly.modals')
...
<span class="cstat-no" title="statement not covered" >              ctrl.close(); </span>// dismissed
            }
          );
      };
      ctrl.$onInit = function () {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (ctrl.isOpen === undefined) {
<span class="cstat-no" title="statement not covered" >          ctrl.isOpen = false;</span>
        }
      };
&nbsp;
