...
<html lang="en">
<head>
    <title>Code coverage report for src/filters/filter-panel/filter-panel-results-component.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/filters/filter-panel/filter-panel-results-component.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/filters/filter-panel/</a> &#187; filter-panel-results-component.js</div>
</div>
<div class="body">
...
&nbsp;
    function setupConfig () {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (ctrl.config.resultsCount === undefined) {
<span class="cstat-no" title="statement not covered" >        ctrl.config.resultsCount = 0;</span>
      }
    }
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (ctrl.config.onFilterChange) {
<span class="cstat-no" title="statement not covered" >        ctrl.config.onFilterChange(ctrl.config.appliedFilters, changedFilterId, value);</span>
      }
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function clearAllFilters (evt) {</span>
<span class="cstat-no" title="statement not covered" >      evt.preventDefault();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      ctrl.config.appliedFilters = [];</span>
&nbsp;
