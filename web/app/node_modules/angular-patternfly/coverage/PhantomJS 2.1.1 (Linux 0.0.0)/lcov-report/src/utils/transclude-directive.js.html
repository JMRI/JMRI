...
<html lang="en">
<head>
    <title>Code coverage report for src/utils/transclude-directive.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/utils/transclude-directive.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/utils/</a> &#187; transclude-directive.js</div>
</div>
<div class="body">
  ...
  .module('patternfly.utils').directive('pfTransclude', function () {
    ...
    return {
      ...
      link: function ($scope, $element, $attrs, controller, $transclude) {
        ...
        var iScopeType;
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!$transclude) {
<span class="cstat-no" title="statement not covered" >          throw new Error('pfTransclude - ' +</span>
...
<span class="cstat-no" title="statement not covered" >              iChildScope.$destroy();</span>
            });
          });
          break;
        }
