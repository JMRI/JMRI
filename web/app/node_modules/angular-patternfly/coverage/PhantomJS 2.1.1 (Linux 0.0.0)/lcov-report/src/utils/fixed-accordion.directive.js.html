...
<html lang="en">
<head>
    <title>Code coverage report for src/utils/fixed-accordion.directive.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/utils/fixed-accordion.directive.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/utils/</a> &#187; fixed-accordion.directive.js</div>
</div>
<div class="body">
...
&nbsp;
      var setBodyScrollHeight = <span class="fstat-no" title="function not covered" >function (parentElement, bodyHeight) {</span>
        // Set the max-height for the fixed height components
<span class="cstat-no" title="statement not covered" >        var collapsePanels = parentElement[0].querySelectorAll('.panel-collapse');</span>
<span class="cstat-no" title="statement not covered" >        var collapsePanel;</span>
<span class="cstat-no" title="statement not covered" >        var scrollElement;</span>
<span class="cstat-no" title="statement not covered" >        var panelContents;</span>
<span class="cstat-no" title="statement not covered" >        var innerHeight;</span>
<span class="cstat-no" title="statement not covered" >        var scroller;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        angular.forEach(collapsePanels, <span class="fstat-no" title="function not covered" >function (collapseElement) {</span></span>
<span class="cstat-no" title="statement not covered" >          collapsePanel = angular.element(collapseElement);</span>
<span class="cstat-no" title="statement not covered" >          scrollElement = collapsePanel;</span>
<span class="cstat-no" title="statement not covered" >          innerHeight = 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (angular.isDefined($scope.scrollSelector)) {</span>
<span class="cstat-no" title="statement not covered" >            scroller = angular.element(collapsePanel[0].querySelector($scope.scrollSelector));</span>
<span class="cstat-no" title="statement not covered" >            if (scroller.length) {</span>
<span class="cstat-no" title="statement not covered" >              scrollElement = angular.element(scroller[0]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >              panelContents = collapsePanel.children();</span>
<span class="cstat-no" title="statement not covered" >              angular.forEach(panelContents, <span class="fstat-no" title="function not covered" >function (contentElement) {</span></span>
                // Get the height of all the non-scroll element contents
<span class="cstat-no" title="statement not covered" >                if (contentElement !== scrollElement[0]) {</span>
<span class="cstat-no" title="statement not covered" >                  innerHeight += contentElementHeight(contentElement);</span>
                }
              });
            }
          }
...
<span class="cstat-no" title="statement not covered" >          angular.element(scrollElement).css('max-height', Math.max((bodyHeight - innerHeight), 25) + 'px');</span>
<span class="cstat-no" title="statement not covered" >          angular.element(scrollElement).css('overflow-y', 'auto');</span>
        });
      };
&nbsp;
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (openPanel &amp;&amp; openPanel.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >          angular.element(openPanel).removeClass('in');</span>
        }
&nbsp;
...
&nbsp;
        // Make sure we have enough height to be able to scroll the contents if necessary
        <span class="missing-if-branch" title="if path not taken" >I</span>if (bodyHeight &lt; 25) {
<span class="cstat-no" title="statement not covered" >          bodyHeight = 25;</span>
&nbsp;
          // Allow the parent to scroll so the child elements are accessible
<span class="cstat-no" title="statement not covered" >          overflowY = 'auto';</span>
        }
&nbsp;
        // Reopen the initially opened panel
        <span class="missing-if-branch" title="if path not taken" >I</span>if (openPanel &amp;&amp; openPanel.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >          angular.element(openPanel).addClass("in");</span>
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          setBodyScrollHeight(parentElement, bodyHeight);</span>
        });
      };
&nbsp;
...
&nbsp;
      $timeout(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        setCollapseHeights();</span>
      }, 100);
&nbsp;
      // Update on window resizing
      $element.on('resize', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        debounceResize();</span>
      });
&nbsp;
