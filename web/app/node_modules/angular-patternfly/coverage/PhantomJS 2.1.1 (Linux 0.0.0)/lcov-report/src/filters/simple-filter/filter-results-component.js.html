...
<html lang="en">
<head>
    <title>Code coverage report for src/filters/simple-filter/filter-results-component.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/filters/simple-filter/filter-results-component.js</span></h1>
    <h2>
        Statements: <span class="metric">84.38% <small>(27 / 32)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/filters/simple-filter/</a> &#187; filter-results-component.js</div>
</div>
<div class="body">
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!ctrl.config.appliedFilters) {
...
&nbsp;
      ctrl.config.appliedFilters.forEach(function (filter) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (item.title !== filter.title || item.value !== filter.value) {
<span class="cstat-no" title="statement not covered" >          newFilters.push(filter);</span>
        }
      });
