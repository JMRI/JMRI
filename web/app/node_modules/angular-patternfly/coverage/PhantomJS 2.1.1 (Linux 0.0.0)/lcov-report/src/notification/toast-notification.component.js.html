...
<html lang="en">
<head>
    <title>Code coverage report for src/notification/toast-notification.component.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/notification/toast-notification.component.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/notification/</a> &#187; toast-notification.component.js</div>
</div>
<div class="body">
...
&nbsp;
    ctrl.notificationType = ctrl.notificationType || <span class="branch-1 cbranch-no" title="branch not covered" >'info';</span>
&nbsp;
...
&nbsp;
    ctrl.handleClose = function () {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (angular.isFunction(ctrl.closeCallback)) {
        ctrl.closeCallback(ctrl.data);
      }
    };
&nbsp;
    ctrl.handleAction = function () {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (angular.isFunction(ctrl.actionCallback)) {
...
&nbsp;
    ctrl.handleEnter = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      if (angular.isFunction(ctrl.updateViewing)) {</span>
<span class="cstat-no" title="statement not covered" >        ctrl.updateViewing(true, ctrl.data);</span>
      }
    };
    ctrl.handleLeave = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      if (angular.isFunction(ctrl.updateViewing)) {</span>
<span class="cstat-no" title="statement not covered" >        ctrl.updateViewing(false, ctrl.data);</span>
      }
    };
&nbsp;
