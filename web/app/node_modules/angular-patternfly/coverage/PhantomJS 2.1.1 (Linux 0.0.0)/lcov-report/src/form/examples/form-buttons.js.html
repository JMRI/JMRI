...
<html lang="en">
<head>
    <title>Code coverage report for src/form/examples/form-buttons.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/form/examples/form-buttons.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/form/examples/</a> &#187; form-buttons.js</div>
</div>
<div class="body">
