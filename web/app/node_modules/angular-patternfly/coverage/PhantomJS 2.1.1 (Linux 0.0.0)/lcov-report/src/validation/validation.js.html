...
<html lang="en">
<head>
    <title>Code coverage report for src/validation/validation.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/validation/validation.js</span></h1>
    <h2>
        Statements: <span class="metric">95.74% <small>(45 / 47)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">93.55% <small>(29 / 31)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">87.5% <small>(7 / 8)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">95.74% <small>(45 / 47)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/validation/</a> &#187; validation.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >          validate();</span>
      ...
      } else <span class="missing-if-branch" title="if path not taken" >I</span>if (!scope.inputCtrl.$valid &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >scope.inputCtrl.$dirty)</span> {
<span class="cstat-no" title="statement not covered" >        toggleErrorClass(true);</span>
      }
&nbsp;
