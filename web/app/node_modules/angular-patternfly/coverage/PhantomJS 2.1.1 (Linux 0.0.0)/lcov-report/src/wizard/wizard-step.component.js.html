...
<html lang="en">
<head>
    <title>Code coverage report for src/wizard/wizard-step.component.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/wizard/wizard-step.component.js</span></h1>
    <h2>
        Statements: <span class="metric">82.61% <small>(133 / 161)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">68.69% <small>(68 / 99)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">75% <small>(27 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">82.61% <small>(133 / 161)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/wizard/</a> &#187; wizard-step.component.js</div>
</div>
<div class="body">
...
&nbsp;
    var stepByTitle = <span class="fstat-no" title="function not covered" >function (titleToFind) {</span>
<span class="cstat-no" title="statement not covered" >      var foundStep = null;</span>
...
<span class="cstat-no" title="statement not covered" >        if (step.stepTitle === titleToFind) {</span>
<span class="cstat-no" title="statement not covered" >          foundStep = step;</span>
        }
      });
<span class="cstat-no" title="statement not covered" >      return foundStep;</span>
    };
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (angular.isUndefined(ctrl.nextEnabled)) {
        ctrl.nextEnabled = true;
      }
      <span class="missing-if-branch" title="else path not taken" >E</span>if (angular.isUndefined(ctrl.prevEnabled)) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (angular.isUndefined(ctrl.stepPriority)) {
<span class="cstat-no" title="statement not covered" >        ctrl.stepPriority = 999;</span>
      } else {
        ctrl.stepPriority = parseInt(ctrl.stepPriority);
      }
      <span class="missing-if-branch" title="else path not taken" >E</span>if (angular.isUndefined(ctrl.okToNavAway)) {
        ctrl.okToNavAway = true;
      }
      <span class="missing-if-branch" title="else path not taken" >E</span>if (angular.isUndefined(ctrl.allowClickNav)) {
...
&nbsp;
      if (ctrl.substeps &amp;&amp; !ctrl.onShow) {
        ctrl.onShow = function () {
          $timeout(function () {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!ctrl.selectedStep) {
...
&nbsp;
    ctrl.$onChanges = function (changesObj) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (changesObj.nextTooltip) {
<span class="cstat-no" title="statement not covered" >        if (_.get(ctrl.wizard, 'selectedStep') === ctrl) {</span>
<span class="cstat-no" title="statement not covered" >          ctrl.wizard.nextTooltip = changesObj.nextTooltip.currentValue;</span>
        }
      }
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (changesObj.prevTooltip) {
<span class="cstat-no" title="statement not covered" >        if (_.get(ctrl.wizard, 'selectedStep') === ctrl) {</span>
<span class="cstat-no" title="statement not covered" >          ctrl.wizard.prevTooltip = changesObj.prevTooltip.currentValue;</span>
        }
      }
    };
&nbsp;
...
&nbsp;
    ctrl.resetNav = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      ctrl.goTo(ctrl.getEnabledSteps()[0]);</span>
    };
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (ctrl.wizard.isWizardDone() || !step.okToNavAway || step === ctrl.selectedStep) {
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (firstRun || (ctrl.getStepNumber(step) &lt; ctrl.currentStepNumber() &amp;&amp; ctrl.selectedStep.prevEnabled) || ctrl.prevStepsComplete(step)) {
        unselectAll();
        ctrl.selectedStep = step;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (step) {
          step.selected = true;
...
&nbsp;
    ctrl.stepClick = <span class="fstat-no" title="function not covered" >function (step) {</span>
<span class="cstat-no" title="statement not covered" >      if (step.allowClickNav) {</span>
<span class="cstat-no" title="statement not covered" >        ctrl.goTo(step);</span>
      }
    };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return ctrl.selectedStep.stepTitle;</span>
    };
&nbsp;
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (angular.isFunction (callback)) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (callback(ctrl.selectedStep)) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (index === enabledSteps.length - 1) {
...
&nbsp;
      // Check if callback is a function
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!angular.isFunction (callback) || callback(ctrl.selectedStep)) {
