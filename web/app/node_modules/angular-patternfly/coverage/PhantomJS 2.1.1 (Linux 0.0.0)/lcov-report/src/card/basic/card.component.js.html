...
<html lang="en">
<head>
    <title>Code coverage report for src/card/basic/card.component.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/card/basic/card.component.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/card/basic/</a> &#187; card.component.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    ctrl.filterCallBackFn = function (f) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (ctrl.filter.callBackFn) {
...
&nbsp;
    ctrl.$onInit = function () {
      if (ctrl.filter &amp;&amp; !ctrl.currentFilter) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (ctrl.filter.defaultFilter) {
          ctrl.currentFilter = ctrl.filter.filters[ctrl.filter.defaultFilter];
        } else {
<span class="cstat-no" title="statement not covered" >          ctrl.currentFilter = ctrl.filter.filters[0];</span>
        }
      }
