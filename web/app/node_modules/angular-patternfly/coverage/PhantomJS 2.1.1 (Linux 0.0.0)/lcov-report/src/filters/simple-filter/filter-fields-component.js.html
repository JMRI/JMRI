...
<html lang="en">
<head>
    <title>Code coverage report for src/filters/simple-filter/filter-fields-component.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/filters/simple-filter/filter-fields-component.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/filters/simple-filter/</a> &#187; filter-fields-component.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function selectValue (filterValue, valueType) {</span>
<span class="cstat-no" title="statement not covered" >      if (angular.isDefined (filterValue)) {</span>
<span class="cstat-no" title="statement not covered" >        if (ctrl.currentField.filterType === 'complex-select') {</span>
<span class="cstat-no" title="statement not covered" >          switch (valueType) {</span>
          case 'filter-category':
<span class="cstat-no" title="statement not covered" >            ctrl.filterCategory = filterValue;</span>
<span class="cstat-no" title="statement not covered" >            ctrl.filterValue = null;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
          case 'filter-value':
<span class="cstat-no" title="statement not covered" >            ctrl.filterValue = filterValue;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
          }
<span class="cstat-no" title="statement not covered" >          if (ctrl.filterCategory &amp;&amp; ctrl.filterValue) {</span>
<span class="cstat-no" title="statement not covered" >            ctrl.addFilterFn(ctrl.currentField, {</span>
...
<span class="cstat-no" title="statement not covered" >          ctrl.addFilterFn(ctrl.currentField, filterValue);</span>
<span class="cstat-no" title="statement not covered" >          ctrl.currentValue = filterValue;</span>
        }
      }
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function onValueKeyPress (keyEvent) {</span>
<span class="cstat-no" title="statement not covered" >      if (keyEvent.which === 13 &amp;&amp; ctrl.currentValue &amp;&amp; ctrl.currentValue.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >        ctrl.addFilterFn(ctrl.currentField, ctrl.currentValue);</span>
<span class="cstat-no" title="statement not covered" >        ctrl.currentValue = undefined;</span>
<span class="cstat-no" title="statement not covered" >        keyEvent.stopPropagation();</span>
<span class="cstat-no" title="statement not covered" >        keyEvent.preventDefault();</span>
      }
    }
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (ctrl.config.fields === undefined) {
<span class="cstat-no" title="statement not covered" >        ctrl.config.fields = [];</span>
      }
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (ctrl.currentValue === undefined) {
<span class="cstat-no" title="statement not covered" >        ctrl.currentValue = null;</span>
      }
    }
  }
});
