...
<html lang="en">
<head>
    <title>Code coverage report for src/charts/heatmap/heatmap.component.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/charts/heatmap/heatmap.component.js</span></h1>
    <h2>
        Statements: <span class="metric">72.66% <small>(101 / 139)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">47.73% <small>(42 / 88)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">68.97% <small>(20 / 29)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">72.66% <small>(101 / 139)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/charts/heatmap/</a> &#187; heatmap.component.js</div>
</div>
<div class="body">
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if ((blockSize - ctrl.padding) &gt; ctrl.maxSize) {
<span class="cstat-no" title="statement not covered" >        blockSize = ctrl.padding + ctrl.maxSize;</span>
&nbsp;
        // Attempt to square off the area, check if square fits
<span class="cstat-no" title="statement not covered" >        numberOfRows = Math.ceil(Math.sqrt(ctrl.data.length));</span>
<span class="cstat-no" title="statement not covered" >        if (blockSize * numberOfRows &gt; containerWidth ||</span>
          blockSize * numberOfRows &gt; containerHeight) {
<span class="cstat-no" title="statement not covered" >          numberOfRows = (blockSize === 0) ? 0 : Math.floor(containerHeight / blockSize);</span>
        }
      } else <span class="missing-if-branch" title="if path not taken" >I</span>if ((blockSize - ctrl.padding) &lt; ctrl.minSize) {
<span class="cstat-no" title="statement not covered" >        blockSize = ctrl.padding + ctrl.minSize;</span>
&nbsp;
        // Attempt to square off the area, check if square fits
<span class="cstat-no" title="statement not covered" >        numberOfRows = Math.ceil(Math.sqrt(ctrl.data.length));</span>
<span class="cstat-no" title="statement not covered" >        if (blockSize * numberOfRows &gt; containerWidth ||</span>
...
<span class="cstat-no" title="statement not covered" >          numberOfRows = (blockSize === 0) ? 0 : Math.floor(containerHeight / blockSize);</span>
        ...
        numberOfRows = (blockSize === 0) ? <span class="branch-0 cbranch-no" title="branch not covered" >0 </span>: Math.floor(containerHeight / blockSize);
      }
    };
&nbsp;
    var determineBlockSize = function () {
      ...
      var n = ctrl.data ? ctrl.data.length : <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
      var px = Math.ceil(Math.sqrt(n * x / y));
      var py = Math.ceil(Math.sqrt(n * y / x));
      var sx, sy;
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (Math.floor(px * y / x) * px &lt; n) {
<span class="cstat-no" title="statement not covered" >        sx = y / Math.ceil(px * y / x);</span>
      } else {
        sx = x / px;
      }
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (Math.floor(py * x / y) * py &lt; n) {
<span class="cstat-no" title="statement not covered" >        sy = x / Math.ceil(x * py / y);</span>
      } else {
        sy = y / py;
      }
...
&nbsp;
    var redraw = function () {
      ...
      var highlightBlock = <span class="fstat-no" title="function not covered" >function (block, active) {</span>
<span class="cstat-no" title="statement not covered" >        block.style('fill-opacity', active ? 1 : 0.4);</span>
      };
      var highlightBlockColor = <span class="fstat-no" title="function not covered" >function (block, fillColor) {</span>
        // Get fill color from given block
<span class="cstat-no" title="statement not covered" >        var blockColor = color(block.map(<span class="fstat-no" title="function not covered" >function (d) {</span></span>
<span class="cstat-no" title="statement not covered" >          return d[0].__data__.value;</span>
        }));
        // If given color matches, apply highlight
<span class="cstat-no" title="statement not covered" >        if (blockColor === fillColor) {</span>
<span class="cstat-no" title="statement not covered" >          block.style('fill-opacity', 1);</span>
        }
      };
&nbsp;
      ...
      blocks.attr('x', function (d, i) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (ctrl.rangeOnHover &amp;&amp; fillSize &lt;= ctrl.rangeHoverSize) {
<span class="cstat-no" title="statement not covered" >          return '"' + rangeTooltip(d.value) + '"';</span>
        }
        return "'" + d.tooltip + "'";
...
&nbsp;
      //Adding events
      blocks.on('mouseover', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        var fillColor;</span>
<span class="cstat-no" title="statement not covered" >        blocks.call(highlightBlock, false);</span>
<span class="cstat-no" title="statement not covered" >        if (ctrl.rangeOnHover &amp;&amp; fillSize &lt;= ctrl.rangeHoverSize) {</span>
          // Get fill color for current block
<span class="cstat-no" title="statement not covered" >          fillColor = color(d3.select(this).map(<span class="fstat-no" title="function not covered" >function (d) {</span></span>
<span class="cstat-no" title="statement not covered" >            return d[0].__data__.value;</span>
          }));
          // Highlight all blocks matching fill color
<span class="cstat-no" title="statement not covered" >          blocks[0].forEach(<span class="fstat-no" title="function not covered" >function (block) {</span></span>
<span class="cstat-no" title="statement not covered" >            highlightBlockColor(d3.select(block), fillColor);</span>
          });
        } else {
<span class="cstat-no" title="statement not covered" >          d3.select(this).call(highlightBlock, true);</span>
        }
      });
      blocks.on('click', <span class="fstat-no" title="function not covered" >function (d) {</span>
<span class="cstat-no" title="statement not covered" >        if (ctrl.clickAction) {</span>
<span class="cstat-no" title="statement not covered" >          ctrl.clickAction(d);</span>
        }
      });
&nbsp;
...
&nbsp;
      svg.on('mouseleave', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        blocks.call(highlightBlock, true);</span>
      });
    };
&nbsp;
    var updateDisplay = function () {
      setStyles();
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (ctrl.chartDataAvailable !== false &amp;&amp; ctrl.data) {
...
&nbsp;
    var debounceResize = _.debounce(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      updateDisplay();</span>
    }, 250, 500);
&nbsp;
    var updateConfig = function () {
      //Allow overriding of defaults
      <span class="missing-if-branch" title="else path not taken" >E</span>if (ctrl.maxBlockSize === undefined || <span class="branch-1 cbranch-no" title="branch not covered" >isNaN(ctrl.maxBlockSize))</span> {
        ctrl.maxSize = 64;
      } else {
<span class="cstat-no" title="statement not covered" >        ctrl.maxSize = parseInt(ctrl.maxBlockSize);</span>
<span class="cstat-no" title="statement not covered" >        if (ctrl.maxSize &lt; 5) {</span>
<span class="cstat-no" title="statement not covered" >          ctrl.maxSize = 5;</span>
        } else <span class="cstat-no" title="statement not covered" >if (ctrl.maxSize &gt; 50) {</span>
<span class="cstat-no" title="statement not covered" >          ctrl.maxSize = 50;</span>
        }
      }
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (ctrl.minBlockSize === undefined || <span class="branch-1 cbranch-no" title="branch not covered" >isNaN(ctrl.minBlockSize))</span> {
        ctrl.minSize = 2;
      } else {
<span class="cstat-no" title="statement not covered" >        ctrl.minSize = parseInt(ctrl.minBlockSize);</span>
      }
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (ctrl.blockPadding === undefined || <span class="branch-1 cbranch-no" title="branch not covered" >isNaN(ctrl.blockPadding))</span> {
        ctrl.padding = 2;
      } else {
<span class="cstat-no" title="statement not covered" >        ctrl.padding = parseInt(ctrl.blockPadding);</span>
      }
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (ctrl.rangeHoverSize === undefined || <span class="branch-1 cbranch-no" title="branch not covered" >isNaN(ctrl.rangeHoverSize))</span> {
        ctrl.rangeHoverSize = 15;
      } else {
<span class="cstat-no" title="statement not covered" >        ctrl.rangeHoverSize = parseInt(ctrl.rangeHoverSize);</span>
      }
&nbsp;
      ctrl.rangeOnHover = (ctrl.rangeOnHover === undefined || <span class="branch-1 cbranch-no" title="branch not covered" >ctrl.rangeOnHover)</span> ? true : <span class="branch-1 cbranch-no" title="branch not covered" >false;</span>
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!ctrl.rangeTooltips) {
...
&nbsp;
    ctrl.$onChanges = function (changesObj) {
      if (changesObj.chartDataAvailable &amp;&amp; !changesObj.chartDataAvailable.isFirstChange()) {
        setStyles();
      } else <span class="missing-if-branch" title="if path not taken" >I</span>if (!changesObj.data) {
<span class="cstat-no" title="statement not covered" >        updateConfig();</span>
<span class="cstat-no" title="statement not covered" >        updateDisplay();</span>
      }
    };
&nbsp;
