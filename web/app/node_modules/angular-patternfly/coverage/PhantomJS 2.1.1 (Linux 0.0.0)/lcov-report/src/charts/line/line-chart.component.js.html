...
<html lang="en">
<head>
    <title>Code coverage report for src/charts/line/line-chart.component.js</title>
    <meta charset="utf-8">
...
<div class="header low">
    <h1>Code coverage report for <span class="entity">src/charts/line/line-chart.component.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/charts/line/</a> &#187; line-chart.component.js</div>
</div>
<div class="body">
...
angular.module('patternfly.charts').component('pfLineChart', {
  ...
  controller: <span class="fstat-no" title="function not covered" >function (pfUtils) {</span>
    'use strict';
<span class="cstat-no" title="statement not covered" >    var ctrl = this, prevChartData;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    ctrl.updateAll = <span class="fstat-no" title="function not covered" >function () {</span></span>
      // Need to deep watch changes in chart data
<span class="cstat-no" title="statement not covered" >      prevChartData = angular.copy(ctrl.chartData);</span>
&nbsp;
      // Create an ID for the chart based on the chartId in the config if given
<span class="cstat-no" title="statement not covered" >      if (ctrl.lineChartId === undefined) {</span>
<span class="cstat-no" title="statement not covered" >        ctrl.lineChartId = 'lineChart';</span>
<span class="cstat-no" title="statement not covered" >        if (ctrl.config.chartId) {</span>
<span class="cstat-no" title="statement not covered" >          ctrl.lineChartId = ctrl.config.chartId + ctrl.lineChartId;</span>
        }
      }
&nbsp;
      /*
       ...
       */
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (ctrl.showXAxis === undefined) {</span>
<span class="cstat-no" title="statement not covered" >        ctrl.showXAxis = (ctrl.config.showAxis !== undefined) &amp;&amp; ctrl.config.showAxis;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (ctrl.showYAxis === undefined) {</span>
<span class="cstat-no" title="statement not covered" >        ctrl.showYAxis = (ctrl.config.showAxis !== undefined) &amp;&amp; ctrl.config.showAxis;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      ctrl.defaultConfig = patternfly.c3ChartDefaults().getDefaultLineConfig();</span>
<span class="cstat-no" title="statement not covered" >      ctrl.defaultConfig.axis = {</span>
        x: {
          show: ctrl.showXAxis === true,
          type: 'timeseries',
          tick: {
            format: <span class="fstat-no" title="function not covered" >function () {</span>
...
&nbsp;
       ...
       */
<span class="cstat-no" title="statement not covered" >      if (ctrl.setAreaChart === undefined) {</span>
<span class="cstat-no" title="statement not covered" >        ctrl.setAreaChart = (ctrl.config.setAreaChart !== undefined) &amp;&amp; ctrl.config.setAreaChart;</span>
      }
&nbsp;
      // Convert the given data to C3 chart format
<span class="cstat-no" title="statement not covered" >      ctrl.config.data = ctrl.getLineData(ctrl.chartData);</span>
&nbsp;
      // Override defaults with callers specifications
<span class="cstat-no" title="statement not covered" >      ctrl.defaultConfig = pfUtils.merge(ctrl.defaultConfig, ctrl.config);</span>
&nbsp;
      // Will trigger c3 chart generation
<span class="cstat-no" title="statement not covered" >      ctrl.chartConfig = pfUtils.merge(ctrl.defaultConfig, ctrl.config);</span>
    };
&nbsp;
    /*
     * Convert the config data to C3 Data
     */
<span class="cstat-no" title="statement not covered" >    ctrl.getLineData = <span class="fstat-no" title="function not covered" >function (chartData) {</span></span>
<span class="cstat-no" title="statement not covered" >      var lineData = {</span>
        type: ctrl.setAreaChart ? "area" : "line"
      };
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (chartData &amp;&amp; chartData.dataAvailable !== false &amp;&amp; chartData.xData) {</span>
<span class="cstat-no" title="statement not covered" >        lineData.x = chartData.xData[0];</span>
        // Convert the chartData dictionary into a C3 columns data arrays
<span class="cstat-no" title="statement not covered" >        lineData.columns = Object.keys(chartData).map(<span class="fstat-no" title="function not covered" >function (key) {</span></span>
<span class="cstat-no" title="statement not covered" >          return chartData[key];</span>
        });
      }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    ctrl.$onChanges = <span class="fstat-no" title="function not covered" >function (changesObj) {</span></span>
<span class="cstat-no" title="statement not covered" >      ctrl.updateAll();</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    ctrl.$doCheck = <span class="fstat-no" title="function not covered" >function () {</span></span>
      // do a deep compare on chartData
<span class="cstat-no" title="statement not covered" >      if (!angular.equals(ctrl.chartData, prevChartData)) {</span>
<span class="cstat-no" title="statement not covered" >        ctrl.updateAll();</span>
      }
    };
  }
