...
<html lang="en">
<head>
    <title>Code coverage report for src/card/info-status/info-status-card.component.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/card/info-status/info-status-card.component.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/card/info-status/</a> &#187; info-status-card.component.js</div>
</div>
<div class="body">
...
angular.module( 'patternfly.card' ).component('pfInfoStatusCard', {
  ...
  controller: function ($sce) {
    ...
    ctrl.$onInit = function () {
      ...
      ctrl.trustAsHtml = <span class="fstat-no" title="function not covered" >function (html) {</span>
<span class="cstat-no" title="statement not covered" >        return $sce.trustAsHtml(html);</span>
      };
&nbsp;
