...
<html lang="en">
<head>
    <title>Code coverage report for src/notification/toast-notification-list.component.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/notification/toast-notification-list.component.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/notification/</a> &#187; toast-notification-list.component.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    ctrl.handleViewingChange = <span class="fstat-no" title="function not covered" >function (isViewing, notification) {</span>
<span class="cstat-no" title="statement not covered" >      if (angular.isFunction(ctrl.updateViewing)) {</span>
<span class="cstat-no" title="statement not covered" >        ctrl.updateViewing(isViewing, notification);</span>
      }
    };
  }
});
