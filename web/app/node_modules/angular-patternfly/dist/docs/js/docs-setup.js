NG_DOCS={
  ...
  "pages": [
    ...
    {
      "section": "api",
      "id": "patternfly.navigation.directive:pfApplicationLauncher",
    ...
    },
    {
      ...
      "keywords": "$emit $on $parent $rootscope $scope $timeout $uibmodal ac additional amet angular animation api back-callback backcallback backdrop backtitle bar based basic blank-slate-pf blank-slate-pf-icon blank-slate-pf-main-action blank-slate-pf-secondary-action boolean btn btn-default btn-lg btn-primary button buttons call called cancel canceldeploymentwizard canceled canceltitle changed class clicked close closewizard command complete configuration consistently container content contentheight controller creates css current currentstep data default defaults define deploy deploycomplete deployinprogress deployment deploymentcomplete deploymentcontroller deployproviderready deployready deps description descriptive desired detail-page details details-extra details-general detailsgeneralcomplete detailsgeneralcontroller detailsreviewcontroller directive dismiss display displayed dolor dynamically eget embedded embedinpage example example-wizard-sidebar example-wizard-step externally extra false final find finish finishedwizard footer form form-horizontal function general glyphicon glyphicon-ok-circle group hand header height hide hidebackbutton hideheader hideindicators hides hidesidebar html indicate indicates indicators individual initializewizard instance ipsum isdefined isundefined js left left-hand length lg loading loading-secondary-information loadingsecondaryinformation loadingwizardtitle logical lorem modal modalinstance module moves navigation nested new-description new-ipsum new-lorem new-name next-callback next-enabled next-title nextbuttontitle nextcallback nexttitle ng-change ng-click ng-controller ng-if ng-include ng-model notify nunc ok-to-nav-away on-cancel on-finish on-show oncancel onfinish onshow open openwizardmodel operation optional pageshown panel parameters patternfly pf-form-group pf-label pf-wizard pf-wizard-review-page pf-wizard-step pf-wizard-substep pf-wizardstep pf-wizardsteps pf-wizardsubstep porta portions prev-enabled progress property provided ready reason removes rendering required result return returns review review-progress review-second-template review-summary review-template reviewtemplate script second secondary secondaryloadinformation set setting show-review show-review-details side sidebar sidebar-class sidebarclass sit size sociosqu spinner spinner-lg startdeploy static step step-class step-id step-priority step-title stepclass stepid steps strict structure substeps successful summary summarycontroller supplied suspendisse switch tab templateurl text time title true type updatename updates ut var vivamus wisi wizard wizard-container wizard-data wizard-done wizard-pf-complete wizard-pf-contents wizard-pf-process wizard-pf-review-item wizard-pf-review-item-label wizard-pf-review-item-value wizard-pf-success-icon wizard-ready wizardcontroller wizarddata wizarddone wizarddonelistener wizardmodalcontroller wizardready wizards wz-disabled"
    },
    {
      "section": "api",
