...
$(document).ready(function() {
	...
	if ($panelName == undefined) {
		...
		$(document).attr('title', 'JMRI Panel: ' + $panelName);
		//add a link to the panel xml
		//insert after second (zero-indexed) element
		$("ul#footer-menu li:eq(1)").after("<li><a href='/panel/" + $panelName + "?format=xml' target=_new>Panel XML</a></li>");
