...
#
setenv CLASSPATH .:java/classes:jmriplugins.jar:lib/jmriplugins.jar:jmri.jar:lib/log4j.jar:lib/jhall.jar:lib/crimson.jar:lib/jdom.jar:lib/jython-standalone-2.7.0.jar:lib/javacsv.jar:lib/jakarta-regexp-1.5.jar:lib/vecmath.jar \
