#! /bin/csh -f
#
# Short csh script to start DecoderPro in java ($Revision: 1.12 $)
#
...
java -noverify -Djava.security.policy=lib/security.policy -Djava.rmi.server.codebase=file:java/classes/ -Dsun.java2d.noddraw \
     -cp .:classes:jmriplugins.jar:lib/jmriplugins.jar:jmri.jar:lib/log4j.jar:lib/collections.jar:lib/jh.jar:lib/crimson.jar:lib/jdom-jdk11.jar:lib/jython.jar:lib/MRJAdapter.jar \
