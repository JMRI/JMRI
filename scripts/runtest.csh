#! /bin/csh -f
#
# Short csh script to setup and run a JUnit test ($Revision: 1.1 $)
#
...
java -noverify -Djava.security.policy=lib/security.policy -Djava.rmi.server.codebase=file:java/classes/ -Dsun.java2d.noddraw \
     -cp .:java/classes:jmriplugins.jar:java/lib/junit.jar:lib/jmriplugins.jar:jmri.jar:lib/log4j.jar:lib/collections.jar:lib/jh.jar:lib/crimson.jar:lib/jdom-jdk11.jar:lib/jython.jar \
     $1
