#! /bin/csh -f
#
#  short csh script to start JMRIdemo in java ($Revision: 1.6 $)
#
...
java -noverify -Djava.security.policy=lib/security.policy -cp .:jmri.jar:lib/log4j.jar:lib/collections.jar:lib/crimson.jar:lib/jdom-jdk11.jar apps.JmriDemo.JMRIdemo
