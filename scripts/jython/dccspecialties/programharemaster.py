...
class setStartup(jmri.jmrit.automat.AbstractAutomaton) :      
  ...
  def handle(self):
    ...
    programmers.getOpsModeProgrammer(True, 9983).writeCV(63, 42, None)	
    ...
    programmers.getOpsModeProgrammer(True, 9983).writeCV(63, 0, None)	
    self.waitMsec(750)
    ...
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(50, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 2 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(51, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 3 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(52, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 4 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(53, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 5 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(54, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 6 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(55, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 7 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(56, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 8 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(57, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 9 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(58, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 10 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(59, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 11 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(60, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 12 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(61, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 13 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(62, 1, None)	
    # self.waitMsec(750)
    ...
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(73, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 15 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(74, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 16 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(75, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 17 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(76, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 18 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(77, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 19 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(78, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 20 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(79, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 21 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(80, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 22 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(81, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 23 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(82, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 24 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(83, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 25 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(84, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 26 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(85, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 27 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(86, 1, None)	
    # self.waitMsec(750)

    # Next Four Lines - Setup Route 28 - Address & Switch Position
    # turnouts.provideTurnout("1234").setState(CLOSED)				
    # self.waitMsec(750)
    # programmers.getOpsModeProgrammer(True, 9983).writeCV(87, 1, None)	
    # self.waitMsec(750)
