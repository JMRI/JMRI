...
//        private String[] pollStatus = {"ERROR","IDLE","POLLING","TIMEOUT","SLOW POLL"};
    ...
    public void initNodeConfigWindow() {
        ...
        //  Hide the menu item until MRCS is ready to release the cpMega
        ...
        cardConfigTable.setPreferredScrollableViewportSize(new java.awt.Dimension(150, 130));
        ...
        addressColumn.setMinWidth(30); // 70
        addressColumn.setMaxWidth(60); // 80
        ...
        osnodeConfigTable.setPreferredScrollableViewportSize(new java.awt.Dimension(160, 95)); //160
        ...
        cpnodeConfigTable.setPreferredScrollableViewportSize(new java.awt.Dimension(240, 130));
