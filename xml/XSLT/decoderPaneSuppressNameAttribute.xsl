...
<!-- xsltproc decoderPaneSuppressNameAttribute.xsl 0NMRA.xml | diff - 0NMRA.xml   -->
...
<!--  decoderPaneAddNameElement.xsl                                         -->
<!--  decoderPaneSuppressNameAttribute.xsl                                  -->
<!--  xmllint -format                                                       -->
...
<!--specific template match for pane element with name attribute -->
    <xsl:template match="pane[@name]" priority="5">
      <xsl:copy>
