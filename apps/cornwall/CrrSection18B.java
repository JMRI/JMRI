...
public class CrrSection18B extends CrrSection {
    ...
    void defineIO() {
        ...
        inputs = new NamedBean[]{ tu[18], tu[20], tu[21], tu[22], tu[23],
     ...
     */
    void setOutput() {
        boolean tu18  = ( tu[20].getKnownState() == Sensor.ACTIVE);
        ...
        if ( !tu23 || bo27 )
            ...
            value = RED;
        else if ( tu20 && tu21 && bo25 )
            value = RED;
        else if ( tu20 && !tu21 && !tu22 )
            value = RED;
        else if ( tu20 && !tu21 && tu22 && bo26)
            value = RED;
