 ...
 * <p>
 * Invoked from higher-level tests, this does not display the modal
 * dialogs that stop execution until clicked/closed.  When invoked
 * via its own main() start point, this does show the modal dialogs.
 *<p>
