...
public class SerialAddressTest extends TestCase {
	...
	public void testValidateSystemNameFormat() {
            ...
            JUnitAppender.assertErrorMessage("illegal character in number field of system name: CL");

            Assert.assertTrue("invalid format - CLB2", !SerialAddress.validSystemNameFormat("CLB2",'L') );
            JUnitAppender.assertErrorMessage("no node address before 'B' in system name: CLB2");
            ...
            JUnitAppender.assertErrorMessage("illegal character in header field of system name: CY2005");

            Assert.assertTrue("invalid format - CY2B5", !SerialAddress.validSystemNameFormat("CY2B5",'L') );
            JUnitAppender.assertErrorMessage("illegal character in header field of system name: CY2B5");
            ...
            JUnitAppender.assertErrorMessage("bit number not in range 1 - 999 in system name: CL22000");

            Assert.assertTrue("invalid format - CL22B0", !SerialAddress.validSystemNameFormat("CL22B0",'L') );
            JUnitAppender.assertErrorMessage("bit number field out of range in system name: CL22B0");
            ...
            JUnitAppender.assertErrorMessage("bit number field out of range in system name: CL2B2049");
            ...
            JUnitAppender.assertErrorMessage("number field out of range in system name: CL128000");
            ...
            JUnitAppender.assertErrorMessage("node address field out of range in system name: CL128B7");

            Assert.assertTrue("invalid format - CL2oo5", !SerialAddress.validSystemNameFormat("CL2oo5",'L') );
            JUnitAppender.assertErrorMessage("illegal character in number field of system name: CL2oo5");
 
            Assert.assertTrue("invalid format - CL2aB5", !SerialAddress.validSystemNameFormat("CL2aB5",'L') );
            JUnitAppender.assertErrorMessage("illegal character in node address field of system name: CL2aB5");

            Assert.assertTrue("invalid format - CL2B5x", !SerialAddress.validSystemNameFormat("CL2B5x",'L') );
            JUnitAppender.assertErrorMessage("illegal character in bit number field of system name: CL2B5x");
	}
	...
	public void testGetNodeAddressFromSystemName() {
            ...
            JUnitAppender.assertErrorMessage("no node address before 'B' in system name: CLB7");
