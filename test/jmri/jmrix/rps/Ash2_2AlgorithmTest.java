 ...
 */
public class Ash2_2AlgorithmTest extends TestCase {
	...
	public void testCalc5() {
	    ...
	    Point3d s5 = new Point3d(0.0f,  0.0f, 9.0f);
	    Point3d s[] = new Point3d[]{s1,s2,s3,s4,s5};
	    
	    Calculator c = new Ash2_2Algorithm(s, vs);
	...
	public Ash2_2AlgorithmTest(String s) {
            super(s);
	}
