...
//		b2.setLoad("E");
	...
	public void testLocal(){
		...
		loc1trk6.setTrainDirections(Track.WEST + Track.EAST);		// Only local moves allowed
		...
		loc1trk1.setMoves(3);		// no yard to yard moves
		loc1trk2.setMoves(4);		// no yard to yard moves
