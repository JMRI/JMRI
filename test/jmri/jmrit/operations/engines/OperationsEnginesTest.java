...
//		Assert.assertEquals("Consist Initial Weight", 0.0, c1.getWeight(), 0.0);
		...
		c1.addEngine(e1);
		Assert.assertEquals("Consist Engine 1 Length", 70+4, c1.getLength());
//		Assert.assertEquals("Consist Engine 1 Weight", 5000.0, c1.getWeight(), 0.0);

		c1.addEngine(e2);
		Assert.assertEquals("Consist Engine 2 Length", 70+4+80+4, c1.getLength());
//		Assert.assertEquals("Consist Engine 2 Weight", 11000.0, c1.getWeight(), 0.0);

		c1.addEngine(e3);
		Assert.assertEquals("Consist Engine 3 Length", 70+4+80+4+90+4, c1.getLength());
//		Assert.assertEquals("Consist Engine 3 Weight", 18000.0, c1.getWeight(), 0.0);
		...
		c1.deleteEngine(e2);
		Assert.assertEquals("Kernel Engine Delete 2 Length", 70+4+90+4, c1.getLength());
//		Assert.assertEquals("Kernel Engine Delete 2 Weight", 12000.0, c1.getWeight(), 0.0);

		c1.deleteEngine(e1);
		Assert.assertEquals("Kernel Engine Delete 1 Length", 90+4, c1.getLength());
...
//		Assert.assertEquals("Kernel Engine Delete 3 Weight", 0.0, c1.getWeight(), 0.0);
	...
	public void testEngineConsist() {
		...
		Assert.assertEquals("Consist old length before", 70+4+80+4+90+4, cold.getLength());
		...
		Assert.assertEquals("Consist old length after", 80+4+90+4, cold.getLength());
		Assert.assertEquals("Consist new length after", 70+4, cnew.getLength());
		...
		Assert.assertEquals("Consist old length after3", 80+4, cold.getLength());
		Assert.assertEquals("Consist new length after3", 70+4+90+4, cnew.getLength());
